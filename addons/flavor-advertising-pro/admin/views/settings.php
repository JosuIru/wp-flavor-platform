...
if (isset($_POST['flavor_advertising_settings']) && check_admin_referer('flavor_advertising_settings_action', 'flavor_advertising_settings_nonce')) {
    ...
    if ($suma_porcentajes !== 100) {
        echo '<div class="notice notice-error"><p>' . esc_html__('Error: Los porcentajes de distribución deben sumar exactamente 100%.', 'flavor-chat-ia') . '</p></div>';
    } else {
        // Privacidad
...
<div class="wrap">
    <h1><?php echo esc_html__('Configuración del Sistema de Publicidad', 'flavor-chat-ia'); ?></h1>
    ...
    <form method="post" action="">
        ...
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Configuración de Monetización', 'flavor-chat-ia'); ?></h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="cpm_por_defecto"><?php esc_html_e('CPM por Defecto (€)', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Coste por mil impresiones. Este será el precio base para anuncios CPM.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="cpc_por_defecto"><?php esc_html_e('CPC por Defecto (€)', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Coste por click. Este será el precio base para anuncios CPC.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="umbral_minimo_pago"><?php esc_html_e('Umbral Mínimo para Solicitar Pago (€)', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Monto mínimo acumulado necesario para poder solicitar un pago.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Ética y Transparencia -->
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Ética y Transparencia', 'flavor-chat-ia'); ?></h2>

            <table class="form-table">
                <tr>
                    <th scope="row"><?php esc_html_e('Etiquetado de Anuncios', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="mostrar_etiqueta_anuncio" value="1" <?php checked($mostrar_etiqueta_anuncio, 1); ?>>
                            <?php esc_html_e('Mostrar siempre la etiqueta "Anuncio" en todos los anuncios', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Recomendado para cumplir con estándares de transparencia. Los usuarios sabrán claramente qué contenido es publicitario.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Verificación de Anunciantes', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="solo_anunciantes_verificados" value="1" <?php checked($solo_anunciantes_verificados, 1); ?>>
                            <?php esc_html_e('Permitir solo anunciantes verificados', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Los anunciantes deberán pasar un proceso de verificación antes de publicar anuncios. Aumenta la confianza pero puede limitar el inventario.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Categorías Sensibles', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="excluir_categorias_sensibles" value="1" <?php checked($excluir_categorias_sensibles, 1); ?>>
                            <?php esc_html_e('Excluir automáticamente categorías sensibles', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('No permitir anuncios de categorías consideradas sensibles (alcohol, apuestas, etc.).', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="categorias_prohibidas"><?php esc_html_e('Categorías Prohibidas', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Una categoría por línea. Los anuncios de estas categorías no se mostrarán en tu sitio.', 'flavor-chat-ia'); ?>
                            <br>
                            <strong><?php esc_html_e('Ejemplos:', 'flavor-chat-ia'); ?></strong> alcohol, apuestas, tabaco, armas, contenido_adulto, farmaceuticos_sin_receta
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Red Global -->
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Configuración de Red Global', 'flavor-chat-ia'); ?></h2>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="api_key_red"><?php esc_html_e('API Key de Red', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        <input type="text" id="api_key_red" name="api_key_red" class="regular-text" value="<?php echo esc_attr($api_key_red); ?>">
                        <p class="description">
                            <?php esc_html_e('Clave API para autenticación con la red global de anuncios.', 'flavor-chat-ia'); ?>
                            <a href="https://network.flavor-advertising.example" target="_blank"><?php esc_html_e('Obtener API Key', 'flavor-chat-ia'); ?></a>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="url_servidor_central"><?php esc_html_e('URL del Servidor Central', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('URL del servidor central de la red global de anuncios.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Modo Sandbox', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="modo_sandbox" value="1" <?php checked($modo_sandbox, 1); ?>>
                            <?php esc_html_e('Activar modo de prueba (sandbox)', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('En modo sandbox, las transacciones no son reales y se pueden realizar pruebas sin afectar datos de producción.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <!-- Distribución de Ingresos -->
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Distribución de Ingresos', 'flavor-chat-ia'); ?></h2>
            <p class="description" style="margin-bottom: 20px;">
                <?php esc_html_e('Configura cómo se distribuyen los ingresos por publicidad. Los porcentajes deben sumar exactamente 100%.', 'flavor-chat-ia'); ?>
            </p>

            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="porcentaje_sitio_mostrador"><?php esc_html_e('% para el Sitio que Muestra el Anuncio', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <p class="description">
                            <?php esc_html_e('Porcentaje de ingresos que recibe el sitio donde se muestra el anuncio. Valor por defecto: 70%', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="porcentaje_plataforma_red"><?php esc_html_e('% para la Plataforma/Red', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <span style="margin-left: 5px; font-size: 18px;">%</span>
                        <p class="description">
                            <?php esc_html_e('Porcentaje que la plataforma/red toma por gestión y mantenimiento. Valor por defecto: 30%', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="porcentaje_proyectos_comunitarios"><?php esc_html_e('% para Proyectos Comunitarios (Opcional)', 'flavor-chat-ia'); ?></label>
                    </th>
                    <td>
                        ...
                        <span style="margin-left: 5px; font-size: 18px;">%</span>
                        <p class="description">
                            <?php esc_html_e('Porcentaje opcional destinado a proyectos comunitarios, sociales o de código abierto. Valor por defecto: 0%', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <div id="revenue-distribution-preview" style="margin-top: 20px; padding: 15px; background: #f0f6fc; border-left: 4px solid #2271b1;">
                <strong><?php esc_html_e('Vista Previa:', 'flavor-chat-ia'); ?></strong>
        ...
        <!-- Privacidad -->
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Configuración de Privacidad', 'flavor-chat-ia'); ?></h2>

            <table class="form-table">
                <tr>
                    <th scope="row"><?php esc_html_e('Cumplimiento GDPR', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="cumplir_gdpr" value="1" <?php checked($cumplir_gdpr, 1); ?>>
                            <?php esc_html_e('Cumplir con el Reglamento General de Protección de Datos (GDPR)', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Activar protecciones y controles necesarios para cumplir con GDPR. Recomendado para sitios con usuarios en la Unión Europea.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Consentimiento de Tracking', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="no_tracking_sin_consentimiento" value="1" <?php checked($no_tracking_sin_consentimiento, 1); ?>>
                            <?php esc_html_e('No trackear usuarios sin su consentimiento explícito', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Los datos de impresiones y clicks solo se registrarán si el usuario ha dado su consentimiento. Cumple con leyes de privacidad pero puede afectar a las estadísticas.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Anonimización de IPs', 'flavor-chat-ia'); ?></th>
                    <td>
                        <label>
                            <input type="checkbox" name="anonimizar_ips" value="1" <?php checked($anonimizar_ips, 1); ?>>
                            <?php esc_html_e('Anonimizar direcciones IP en el tracking', 'flavor-chat-ia'); ?>
                        </label>
                        <p class="description">
                            <?php esc_html_e('Las IPs se almacenarán de forma anonimizada (ejemplo: 192.168.1.XXX) para proteger la privacidad de los usuarios.', 'flavor-chat-ia'); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <p class="submit">
            <button type="submit" name="flavor_advertising_settings" class="button button-primary button-large">
                <?php esc_html_e('Guardar Toda la Configuración', 'flavor-chat-ia'); ?>
            </button>
...
jQuery(document).ready(function($) {
    ...
    function updateRevenuePreview() {
        ...
        var preview_text = '<?php esc_html_e('Por cada €100 de ingresos:', 'flavor-chat-ia'); ?> ';
        preview_text += '<strong>€' + porcentaje_sitio + '</strong> <?php esc_html_e('para el sitio', 'flavor-chat-ia'); ?>, ';
        preview_text += '<strong>€' + porcentaje_plataforma + '</strong> <?php esc_html_e('para la plataforma', 'flavor-chat-ia'); ?>';

        if (porcentaje_comunidad > 0) {
            preview_text += ', <strong>€' + porcentaje_comunidad + '</strong> <?php esc_html_e('para proyectos comunitarios', 'flavor-chat-ia'); ?>';
        }

        preview_text += '. <strong><?php esc_html_e('Total:', 'flavor-chat-ia'); ?> ' + total + '%</strong>';

        if (total !== 100) {
            preview_text += ' <span style="color: #d63638; font-weight: bold;">⚠️ <?php esc_html_e('Error: Debe sumar 100%', 'flavor-chat-ia'); ?></span>';
    ...
    $('form').on('submit', function(e) {
        ...
        if (total !== 100) {
            e.preventDefault();
            alert('<?php esc_html_e('Error: Los porcentajes de distribución de ingresos deben sumar exactamente 100%. Actualmente suman:', 'flavor-chat-ia'); ?> ' + total + '%');
            $('html, body').animate({
