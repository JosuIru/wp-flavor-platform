        ...
        <div class="flavor-propiedades-grid">
            <?php foreach ($propiedades as $prop): ?>
                <article class="flavor-propiedad-card">
                    ...
                    <a href="#propiedad" class="flavor-propiedad-link"></a>
                </article>
            <?php endforeach; ?>
        </div>

        <div class="flavor-ver-todas">
            <a href="#todas" class="flavor-btn-outline">
    ...
    <div class="flavor-container">
        <div class="flavor-cta-wrapper">
            ...
            <div class="flavor-cta-actions">
                <a href="#valoracion" class="flavor-btn-white"><?php esc_html_e('Valoración Gratuita', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></a>
