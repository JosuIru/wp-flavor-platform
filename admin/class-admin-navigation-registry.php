...
class Flavor_Admin_Navigation_Registry {
    ...
    private function build_registry() {
        ...
        $pages = [
            ...
            'flavor-landing-editor' => $this->page('configuration', 'pages', __('Editor Visual', 'flavor-chat-ia'), __('Páginas y Landings', 'flavor-chat-ia'), 40, [], ['menu_visibility' => 'hidden', 'navigation_role' => 'auxiliary']),
