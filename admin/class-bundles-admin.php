...
class Flavor_Bundles_Admin {
    ...
    public function render_page() {
        ...
        $bundles = [
            [
                'title' => __('Comunidad Base', 'flavor-chat-ia'),
                'description' => __('Asociaciones, colectivos y comunidades pequeñas con foco en pertenencia, eventos y conversación.', 'flavor-chat-ia'),
                'modules' => ['comunidades', 'socios', 'eventos', 'red-social', 'chat-grupos', 'foros'],
            ],
            [
                'title' => __('Economía Comunitaria', 'flavor-chat-ia'),
                'description' => __('Intercambio local, grupos de consumo, marketplace y coordinación operativa.', 'flavor-chat-ia'),
                'modules' => ['grupos-consumo', 'marketplace', 'banco-tiempo', 'socios', 'chat-grupos', 'facturas'],
            ],
            [
                'title' => __('Gobernanza', 'flavor-chat-ia'),
                'description' => __('Toma de decisiones, documentación y procesos de participación.', 'flavor-chat-ia'),
                'modules' => ['participacion', 'transparencia', 'encuestas', 'eventos', 'foros', 'documentacion-legal'],
            ],
            [
                'title' => __('Apps y Red', 'flavor-chat-ia'),
                'description' => __('Configuración móvil, deep links, navegación y red federada de nodos.', 'flavor-chat-ia'),
        ...
        <div class="wrap flavor-bundles-admin">
            ...
            if (class_exists('Flavor_Admin_Page_Chrome')) {
                Flavor_Admin_Page_Chrome::render_breadcrumbs('ecosystem', 'flavor-bundles', __('Bundles', 'flavor-chat-ia'));
                Flavor_Admin_Page_Chrome::render_compact_nav($ecosystem_links);
            }
            ?>

            <h1><?php esc_html_e('Bundles del Ecosistema', 'flavor-chat-ia'); ?></h1>

            <div class="notice notice-info flavor-admin-callout">
                <p><?php esc_html_e('Esta pantalla organiza combinaciones recomendadas de módulos para despliegues reales. Sirve como capa de producto entre el catálogo técnico y la activación funcional.', 'flavor-chat-ia'); ?></p>
            </div>
