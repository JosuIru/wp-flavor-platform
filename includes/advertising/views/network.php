...
if (isset($_POST['flavor_network_connect']) && check_admin_referer('flavor_network_connect_action', 'flavor_network_connect_nonce')) {
    ...
    echo '<div class="notice notice-success"><p>' . esc_html__('Conectado a la red global exitosamente.', 'flavor-chat-ia') . '</p></div>';
}
...
if (isset($_POST['flavor_network_settings']) && check_admin_referer('flavor_network_settings_action', 'flavor_network_settings_nonce')) {
    ...
    echo '<div class="notice notice-success"><p>' . esc_html__('Configuración de red actualizada correctamente.', 'flavor-chat-ia') . '</p></div>';
}
...
if (isset($_POST['flavor_network_disconnect']) && check_admin_referer('flavor_network_disconnect_action', 'flavor_network_disconnect_nonce')) {
    ...
    echo '<div class="notice notice-success"><p>' . esc_html__('Desconectado de la red global.', 'flavor-chat-ia') . '</p></div>';
}
...
<div class="wrap">
    <h1><?php echo esc_html__('Red Global de Anuncios', 'flavor-chat-ia'); ?></h1>

    <!-- Explicación de la red -->
    <div class="card" style="margin: 20px 0; padding: 20px; background: #f0f6fc; border-left: 4px solid #2271b1;">
        <h2 style="margin-top: 0;"><?php esc_html_e('¿Qué es la Red Global de Anuncios?', 'flavor-chat-ia'); ?></h2>
        <p><?php esc_html_e('La Red Global de Anuncios conecta múltiples sitios de comunidades para compartir publicidad ética y transparente. Los anunciantes pueden llegar a una audiencia más amplia, mientras que los sitios generan ingresos adicionales mostrando anuncios relevantes de la red.', 'flavor-chat-ia'); ?></p>
        <ul style="margin-left: 20px;">
            <li><strong><?php esc_html_e('Visibilidad ampliada:', 'flavor-chat-ia'); ?></strong> <?php esc_html_e('Tus anuncios pueden mostrarse en todos los sitios de la red.', 'flavor-chat-ia'); ?></li>
            <li><strong><?php esc_html_e('Ingresos compartidos:', 'flavor-chat-ia'); ?></strong> <?php esc_html_e('Gana dinero mostrando anuncios de otros sitios de la red.', 'flavor-chat-ia'); ?></li>
            <li><strong><?php esc_html_e('Publicidad ética:', 'flavor-chat-ia'); ?></strong> <?php esc_html_e('Todos los anuncios cumplen con estándares de transparencia y responsabilidad.', 'flavor-chat-ia'); ?></li>
            <li><strong><?php esc_html_e('Control total:', 'flavor-chat-ia'); ?></strong> <?php esc_html_e('Tú decides qué anuncios mostrar y qué porcentaje compartir.', 'flavor-chat-ia'); ?></li>
        </ul>
    </div>
    ...
    <?php if ($esta_conectado) : ?>
        ...
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2 style="color: #00a32a;"><?php esc_html_e('✓ Conectado a la Red Global', 'flavor-chat-ia'); ?></h2>

            <table class="form-table">
                <tr>
                    <th scope="row"><?php esc_html_e('ID de Sitio:', 'flavor-chat-ia'); ?></th>
                    <td><code><?php echo esc_html($id_sitio_red); ?></code></td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('Nombre del Sitio:', 'flavor-chat-ia'); ?></th>
                    <td><strong><?php echo esc_html($nombre_sitio_red); ?></strong></td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('URL:', 'flavor-chat-ia'); ?></th>
                    <td><?php echo esc_html($url_sitio_red); ?></td>
                </tr>
                <tr>
                    <th scope="row"><?php esc_html_e('API Key:', 'flavor-chat-ia'); ?></th>
            ...
            <form method="post" action="">
                ...
                <p>
                    <button type="submit" name="flavor_network_disconnect" class="button button-secondary" onclick="return confirm('<?php esc_attr_e('¿Estás seguro de que deseas desconectarte de la red? Perderás acceso a anuncios compartidos.', 'flavor-chat-ia'); ?>')">
                        <?php esc_html_e('Desconectar de la Red', 'flavor-chat-ia'); ?>
                    </button>
                </p>
            </form>
        </div>
        ...
        <div class="flavor-stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin: 20px 0;">
            <div class="card" style="padding: 20px; text-align: center;">
                <h3 style="margin: 0 0 10px 0; color: #666; font-size: 14px; text-transform: uppercase;">
                    <?php esc_html_e('Sitios en la Red', 'flavor-chat-ia'); ?>
                </h3>
            ...
            <div class="card" style="padding: 20px; text-align: center;">
                <h3 style="margin: 0 0 10px 0; color: #666; font-size: 14px; text-transform: uppercase;">
                    <?php esc_html_e('Anuncios Compartidos', 'flavor-chat-ia'); ?>
                </h3>
                <p style="margin: 0; font-size: 32px; font-weight: bold; color: #2271b1;">
            ...
            <div class="card" style="padding: 20px; text-align: center;">
                <h3 style="margin: 0 0 10px 0; color: #666; font-size: 14px; text-transform: uppercase;">
                    <?php esc_html_e('Ingresos de Red', 'flavor-chat-ia'); ?>
                </h3>
        ...
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Configuración de Participación', 'flavor-chat-ia'); ?></h2>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        <th scope="row"><?php esc_html_e('Anuncios Globales', 'flavor-chat-ia'); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="permitir_anuncios_globales" value="1" <?php checked($permitir_anuncios_globales, 1); ?>>
                                <?php esc_html_e('Permitir mostrar anuncios de otros sitios de la red en mi sitio', 'flavor-chat-ia'); ?>
                            </label>
                            <p class="description"><?php esc_html_e('Activa esta opción para generar ingresos mostrando anuncios de la red global.', 'flavor-chat-ia'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><?php esc_html_e('Compartir Anuncios', 'flavor-chat-ia'); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="compartir_anuncios_red" value="1" <?php checked($compartir_anuncios_red, 1); ?>>
                                <?php esc_html_e('Compartir mis anuncios con otros sitios de la red', 'flavor-chat-ia'); ?>
                            </label>
                            <p class="description"><?php esc_html_e('Permite que tus anuncios se muestren en otros sitios de la red para mayor alcance.', 'flavor-chat-ia'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><?php esc_html_e('Comisión de Red', 'flavor-chat-ia'); ?></th>
                        <td>
                            ...
                            <p class="description">
                                <?php esc_html_e('Porcentaje de comisión que la red toma de los ingresos por anuncios compartidos. El resto se distribuye entre el sitio que muestra el anuncio y el sitio que lo publicó.', 'flavor-chat-ia'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Sitios en la Red', 'flavor-chat-ia'); ?></h2>

            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Nombre del Sitio', 'flavor-chat-ia'); ?></th>
                        <th><?php esc_html_e('URL', 'flavor-chat-ia'); ?></th>
                        <th><?php esc_html_e('Anuncios Compartidos', 'flavor-chat-ia'); ?></th>
                        <th><?php esc_html_e('Ingresos Generados', 'flavor-chat-ia'); ?></th>
                    </tr>
                </thead>
                <tbody>
    ...
    <?php else : ?>
        ...
        <div class="card" style="margin: 20px 0; padding: 20px; border-left: 4px solid #d63638;">
            <h2 style="color: #d63638;"><?php esc_html_e('No estás conectado a la Red Global', 'flavor-chat-ia'); ?></h2>
            <p><?php esc_html_e('Para unirte a la red global de anuncios y comenzar a compartir publicidad con otras comunidades, completa el siguiente formulario:', 'flavor-chat-ia'); ?></p>
            ...
            <form method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php esc_html_e('Solicita tu API Key en el portal de la red global.', 'flavor-chat-ia'); ?>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="nombre_sitio_red"><?php esc_html_e('Nombre del Sitio *', 'flavor-chat-ia'); ?></label>
                        </th>
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Nombre con el que tu sitio aparecerá en la red.', 'flavor-chat-ia'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="url_sitio_red"><?php esc_html_e('URL del Sitio *', 'flavor-chat-ia'); ?></label>
                        </th>
                        <td>
                            <input type="url" id="url_sitio_red" name="url_sitio_red" class="regular-text" value="<?php echo esc_url(home_url()); ?>" required>
                            <p class="description"><?php esc_html_e('URL principal de tu sitio.', 'flavor-chat-ia'); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                <p class="submit">
                    <button type="submit" name="flavor_network_connect" class="button button-primary button-large">
                        <?php esc_html_e('Conectar a la Red Global', 'flavor-chat-ia'); ?>
                    </button>
                </p>
            </form>
        </div>
        ...
        <div class="card" style="margin: 20px 0; padding: 20px;">
            <h2><?php esc_html_e('Beneficios de Unirse a la Red', 'flavor-chat-ia'); ?></h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                <div>
                    <h3 style="color: #2271b1;">💰 <?php esc_html_e('Ingresos Adicionales', 'flavor-chat-ia'); ?></h3>
                    <p><?php esc_html_e('Genera ingresos mostrando anuncios relevantes de otros sitios de la red en tu comunidad.', 'flavor-chat-ia'); ?></p>
                </div>
                <div>
                    <h3 style="color: #2271b1;">📈 <?php esc_html_e('Mayor Alcance', 'flavor-chat-ia'); ?></h3>
                    <p><?php esc_html_e('Amplifica el alcance de tus anuncios mostrándolos en múltiples sitios de la red.', 'flavor-chat-ia'); ?></p>
                </div>
                <div>
                    <h3 style="color: #2271b1;">🤝 <?php esc_html_e('Comunidad Colaborativa', 'flavor-chat-ia'); ?></h3>
                    <p><?php esc_html_e('Forma parte de una red de comunidades que comparten valores de transparencia y ética.', 'flavor-chat-ia'); ?></p>
                </div>
                <div>
                    <h3 style="color: #2271b1;">✅ <?php esc_html_e('Control Total', 'flavor-chat-ia'); ?></h3>
                    <p><?php esc_html_e('Mantén el control sobre qué anuncios se muestran y cómo se distribuyen los ingresos.', 'flavor-chat-ia'); ?></p>
                </div>
            </div>
        </div>
    <?php endif; ?>
