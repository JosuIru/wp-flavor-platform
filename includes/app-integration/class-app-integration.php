...
class Flavor_App_Integration {
    ...
    public function get_available_modules($request) {
        ...
        if ($this->plugin_detector->is_calendario_active()) {
            $modules[] = [
                ...
                'description' => __('Sistema de reservas y tickets', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        if ($this->plugin_detector->is_basabere_active()) {
            $modules[] = [
                'id' => 'campamentos',
                'name' => __('Campamentos', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'description' => __('Gestión de campamentos e inscripciones', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    private function get_known_app_modules_catalog() {
        return [
            ...
            'campamentos' => [
                'name' => __('Campamentos', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'description' => __('Campamentos, inscripciones y gestión administrativa', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icon' => 'terrain',
                'color' => '#4CAF50',
                'api_namespace' => 'camps/v1',
            ],
    ...
    private function get_layout_data() {
        ...
        return [
            'available' => true,
            'version' => '1.0',
            'message' => __('config', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'menu' => [
