...
class Flavor_Module_Access_Control {
    ...
    private function generar_mensaje_acceso_denegado($module_slug, $visibilidad) {
        ...
        switch ($visibilidad) {
            case self::VISIBILIDAD_SOLO_MIEMBROS:
                ...
                $mensaje = __('Este contenido solo esta disponible para socios y miembros registrados de nuestra comunidad.', 'flavor-chat-ia');
                $cta_texto = __('Hazte socio', 'flavor-chat-ia');
    ...
    public static function get_visibility_types() {
        return [
            ...
            self::VISIBILIDAD_SOLO_MIEMBROS => __('Solo miembros - Usuarios registrados y socios', 'flavor-chat-ia'),
