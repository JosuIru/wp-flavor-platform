...
class Flavor_Module_Navigation {
    ...
    private function get_module_nav_items($module_id, $override = '') {
        ...
        $default_items = [
            ...
            'grupos-consumo' => [
                ['slug' => 'listado', 'label' => __('Todos los Grupos', 'flavor-chat-ia'), 'url' => home_url('/grupos-consumo/'), 'icon' => '🌱'],
                ['slug' => 'mi-grupo', 'label' => __('Mi Grupo', 'flavor-chat-ia'), 'url' => home_url('/grupos-consumo/mi-grupo/'), 'icon' => '⭐'],
                ['slug' => 'pedidos', 'label' => __('Pedidos', 'flavor-chat-ia'), 'url' => home_url('/grupos-consumo/pedidos/'), 'icon' => '🛒'],
            ],
            'incidencias' => [
