...
function flavor_get_theme_presets() {
    ...
    $presets_salud = [
        'salud-vital' => [
            ...
            'ideal_for' => __('Clínicas, centros médicos, spas, wellness, farmacias', 'flavor-chat-ia'),
    ...
    $presets_educacion = [
        'academia-moderna' => [
            ...
            'category' => 'educacion',
            'category_label' => __('Educación', 'flavor-chat-ia'),
            'ideal_for' => __('Escuelas, universidades, plataformas e-learning, academias', 'flavor-chat-ia'),
    ...
    $presets_deportes = [
        'fitness-energy' => [
            ...
            'category' => 'deportes',
            'category_label' => __('Deportes y Fitness', 'flavor-chat-ia'),
            'ideal_for' => __('Gimnasios, entrenadores personales, clubs deportivos, crossfit', 'flavor-chat-ia'),
    ...
    $presets_cultura = [
        'galeria-arte' => [
            ...
            'ideal_for' => __('Museos, galerías de arte, teatros, centros culturales', 'flavor-chat-ia'),
    ...
    $presets_tecnologia = [
        'tech-startup' => [
            ...
            'category' => 'tecnologia',
            'category_label' => __('Tecnología', 'flavor-chat-ia'),
            'ideal_for' => __('Startups, apps SaaS, empresas de software, agencias digitales', 'flavor-chat-ia'),
    ...
    $presets_alimentacion = [
        'organic-fresh' => [
            ...
            'category_label' => __('Alimentación', 'flavor-chat-ia'),
            'ideal_for' => __('Tiendas eco, mercados orgánicos, granjas, huertos urbanos', 'flavor-chat-ia'),
    ...
    $presets_inmobiliaria = [
        'real-estate-pro' => [
            ...
            'ideal_for' => __('Inmobiliarias, agencias, arquitectos, constructoras, interiorismo', 'flavor-chat-ia'),
    ...
    $presets_legal = [
        'corporate-trust' => [
            ...
            'ideal_for' => __('Bufetes de abogados, consultoras, asesores financieros, bancos', 'flavor-chat-ia'),
    ...
    $presets_hosteleria = [
        'gastro-deluxe' => [
            ...
            'category' => 'hosteleria',
            'category_label' => __('Hostelería', 'flavor-chat-ia'),
            'ideal_for' => __('Restaurantes gourmet, hoteles boutique, bodegas, catering', 'flavor-chat-ia'),
    ...
    $presets_infantil = [
        'kids-fun' => [
            ...
            'ideal_for' => __('Guarderías, ludotecas, jugueterías, actividades para niños', 'flavor-chat-ia'),
...
function flavor_get_theme_categories() {
    $categorias = [
        'all' => __('Todos los temas', 'flavor-chat-ia'),
        'general' => __('General', 'flavor-chat-ia'),
        'salud' => __('Salud y Bienestar', 'flavor-chat-ia'),
        'educacion' => __('Educación', 'flavor-chat-ia'),
        'deportes' => __('Deportes y Fitness', 'flavor-chat-ia'),
        'cultura' => __('Cultura y Arte', 'flavor-chat-ia'),
        'tecnologia' => __('Tecnología', 'flavor-chat-ia'),
        'alimentacion' => __('Alimentación', 'flavor-chat-ia'),
        'inmobiliaria' => __('Inmobiliaria', 'flavor-chat-ia'),
        'legal' => __('Legal y Finanzas', 'flavor-chat-ia'),
        'hosteleria' => __('Hostelería', 'flavor-chat-ia'),
