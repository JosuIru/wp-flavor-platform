    ...
    public function validate_message($message, $session_id, $ip, $extra_data = []) {
        ...
        if (!$rate_check['valid']) {
            ...
            if ($rate_check['block']) {
                ...
                return [
                    'valid' => false,
                    'error' => 'Demasiados mensajes. Por favor, espera unos minutos.',
        ...
        if (!$repeat_check['valid']) {
            ...
            if ($repeat_check['block']) {
                return [
                    'valid' => false,
                    'error' => 'Por favor, no envíes el mismo mensaje repetidamente.',
        ...
        if ($this->config['enable_content_filter']) {
            ...
            if ($content_check['block']) {
                ...
                return [
                    'valid' => false,
                    'error' => 'Tu mensaje contiene contenido inapropiado.',
        ...
        if ($spam_score >= $this->config['spam_score_threshold']) {
            ...
            return [
                'valid' => false,
                'error' => 'Tu mensaje ha sido marcado como spam.',
