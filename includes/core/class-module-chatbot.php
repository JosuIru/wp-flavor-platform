...
class Flavor_Module_Chatbot {
    ...
    private function init_module_contexts() {
        $this->module_contexts = [
            ...
            'general' => [
                'nombre' => __('Flavor Platform', 'flavor-chat-ia'),
                'descripcion' => __('Plataforma integral para comunidades y organizaciones', 'flavor-chat-ia'),
...
Responde de forma amable y práctica. Si el usuario pregunta por un módulo específico, guíale hacia él. Si necesitas más información, pregunta.",
                'quick_actions' => [
                    'ver_modulos' => ['label' => __('Ver módulos', 'flavor-chat-ia'), 'icon' => 'grid'],
                    'configuracion' => ['label' => __('Configuración', 'flavor-chat-ia'), 'icon' => 'settings'],
                    'ayuda' => ['label' => __('Ayuda', 'flavor-chat-ia'), 'icon' => 'help'],
                    'documentacion' => ['label' => __('Documentación', 'flavor-chat-ia'), 'icon' => 'book'],
                ],
                'faqs' => [
                    __('¿Qué módulos tiene Flavor Platform?', 'flavor-chat-ia'),
                    __('¿Cómo activo un nuevo módulo?', 'flavor-chat-ia'),
                    __('¿Cómo configuro mi organización?', 'flavor-chat-ia'),
                    __('¿Cómo personalizo el diseño?', 'flavor-chat-ia'),
                ],
            ],

            // Contexto LANDING - Experto en Flavor Platform para clientes potenciales
            'landing' => [
                'nombre' => __('Experto Flavor Platform', 'flavor-chat-ia'),
                'descripcion' => __('Asistente especializado en resolver dudas sobre la plataforma, módulos y funcionalidades', 'flavor-chat-ia'),
...
Responde en el mismo idioma que use el usuario.",
                'quick_actions' => [
                    'ver_modulos' => ['label' => __('Ver todos los módulos', 'flavor-chat-ia'), 'icon' => 'grid'],
                    'ver_precios' => ['label' => __('Ver precios', 'flavor-chat-ia'), 'icon' => 'money'],
                    'solicitar_demo' => ['label' => __('Solicitar demo', 'flavor-chat-ia'), 'icon' => 'play'],
                    'contactar' => ['label' => __('Contactar', 'flavor-chat-ia'), 'icon' => 'email'],
                ],
                'faqs' => [
                    __('¿Qué es la red federada de nodos?', 'flavor-chat-ia'),
                    __('¿Tengo que usar todos los módulos?', 'flavor-chat-ia'),
                    __('¿Cómo funciona el módulo de Grupos de Consumo?', 'flavor-chat-ia'),
                    __('¿El Banco de Tiempo usa dinero real?', 'flavor-chat-ia'),
                    __('¿Los datos de mi comunidad están seguros?', 'flavor-chat-ia'),
                    __('¿Qué diferencia hay entre la versión gratuita y Pro?', 'flavor-chat-ia'),
                    __('¿Puedo crear una app móvil?', 'flavor-chat-ia'),
                    __('¿Funciona con WooCommerce?', 'flavor-chat-ia'),
                ],
            ],

            'socios' => [
                'nombre' => __('Gestión de Miembros', 'flavor-chat-ia'),
                'descripcion' => __('Gestión de socios, membresías, cuotas y comunicaciones', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'nuevo_socio' => ['label' => __('Alta de socio', 'flavor-chat-ia'), 'icon' => 'plus'],
                    'buscar_socio' => ['label' => __('Buscar socio', 'flavor-chat-ia'), 'icon' => 'search'],
                    'cuotas_pendientes' => ['label' => __('Ver cuotas pendientes', 'flavor-chat-ia'), 'icon' => 'money'],
                    'enviar_comunicacion' => ['label' => __('Enviar comunicación', 'flavor-chat-ia'), 'icon' => 'email'],
                ],
                'faqs' => [
                    __('¿Cómo doy de alta un nuevo socio?', 'flavor-chat-ia'),
                    __('¿Cómo configuro los tipos de cuota?', 'flavor-chat-ia'),
                    __('¿Cómo envío emails a todos los socios?', 'flavor-chat-ia'),
                    __('¿Cómo genero carnets digitales?', 'flavor-chat-ia'),
                ],
            ],
            'eventos' => [
                'nombre' => __('Eventos', 'flavor-chat-ia'),
                'descripcion' => __('Organización de eventos, inscripciones y calendarios', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'crear_evento' => ['label' => __('Crear evento', 'flavor-chat-ia'), 'icon' => 'calendar'],
                    'ver_inscripciones' => ['label' => __('Ver inscripciones', 'flavor-chat-ia'), 'icon' => 'list'],
                    'enviar_recordatorio' => ['label' => __('Enviar recordatorio', 'flavor-chat-ia'), 'icon' => 'bell'],
                    'exportar_asistentes' => ['label' => __('Exportar asistentes', 'flavor-chat-ia'), 'icon' => 'download'],
                ],
                'faqs' => [
                    __('¿Cómo creo un evento recurrente?', 'flavor-chat-ia'),
                    __('¿Cómo gestiono la lista de espera?', 'flavor-chat-ia'),
                    __('¿Cómo envío recordatorios automáticos?', 'flavor-chat-ia'),
                    __('¿Cómo exporto la lista de asistentes?', 'flavor-chat-ia'),
                ],
            ],
            'reservas' => [
                'nombre' => __('Reservas', 'flavor-chat-ia'),
                'descripcion' => __('Sistema de reserva de espacios y recursos', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'nueva_reserva' => ['label' => __('Nueva reserva', 'flavor-chat-ia'), 'icon' => 'calendar-check'],
                    'ver_disponibilidad' => ['label' => __('Ver disponibilidad', 'flavor-chat-ia'), 'icon' => 'clock'],
                    'confirmar_reservas' => ['label' => __('Confirmar pendientes', 'flavor-chat-ia'), 'icon' => 'check'],
                    'configurar_recurso' => ['label' => __('Configurar recurso', 'flavor-chat-ia'), 'icon' => 'settings'],
                ],
                'faqs' => [
                    __('¿Cómo configuro un nuevo espacio reservable?', 'flavor-chat-ia'),
                    __('¿Cómo establezco horarios y precios?', 'flavor-chat-ia'),
                    __('¿Cómo gestiono las cancelaciones?', 'flavor-chat-ia'),
                    __('¿Cómo veo el calendario de ocupación?', 'flavor-chat-ia'),
                ],
            ],
            'grupos_consumo' => [
                'nombre' => __('Grupos de Consumo', 'flavor-chat-ia'),
                'descripcion' => __('Gestión de grupos de consumo, productores y pedidos', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'nuevo_ciclo' => ['label' => __('Abrir ciclo', 'flavor-chat-ia'), 'icon' => 'refresh'],
                    'ver_pedidos' => ['label' => __('Ver pedidos', 'flavor-chat-ia'), 'icon' => 'list'],
                    'gestionar_productos' => ['label' => __('Productos', 'flavor-chat-ia'), 'icon' => 'box'],
                    'calcular_reparto' => ['label' => __('Calcular reparto', 'flavor-chat-ia'), 'icon' => 'calculator'],
                ],
                'faqs' => [
                    __('¿Cómo abro un nuevo ciclo de pedidos?', 'flavor-chat-ia'),
                    __('¿Cómo añado un nuevo productor?', 'flavor-chat-ia'),
                    __('¿Cómo calculo el reparto de pedidos?', 'flavor-chat-ia'),
                    __('¿Cómo gestiono los pagos?', 'flavor-chat-ia'),
                ],
            ],
            'incidencias' => [
                'nombre' => __('Incidencias', 'flavor-chat-ia'),
                'descripcion' => __('Sistema de tickets y gestión de incidencias', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'nueva_incidencia' => ['label' => __('Nueva incidencia', 'flavor-chat-ia'), 'icon' => 'plus'],
                    'pendientes' => ['label' => __('Ver pendientes', 'flavor-chat-ia'), 'icon' => 'clock'],
                    'urgentes' => ['label' => __('Ver urgentes', 'flavor-chat-ia'), 'icon' => 'alert'],
                    'estadisticas' => ['label' => __('Estadísticas', 'flavor-chat-ia'), 'icon' => 'chart'],
                ],
                'faqs' => [
                    __('¿Cómo priorizo las incidencias?', 'flavor-chat-ia'),
                    __('¿Cómo asigno incidencias a gestores?', 'flavor-chat-ia'),
                    __('¿Cómo configuro notificaciones automáticas?', 'flavor-chat-ia'),
                    __('¿Cómo genero reportes de incidencias?', 'flavor-chat-ia'),
                ],
            ],
            'biblioteca' => [
                'nombre' => __('Biblioteca', 'flavor-chat-ia'),
                'descripcion' => __('Gestión de biblioteca, préstamos y catálogo', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'nuevo_prestamo' => ['label' => __('Nuevo préstamo', 'flavor-chat-ia'), 'icon' => 'book'],
                    'devoluciones' => ['label' => __('Devoluciones', 'flavor-chat-ia'), 'icon' => 'return'],
                    'buscar_libro' => ['label' => __('Buscar libro', 'flavor-chat-ia'), 'icon' => 'search'],
                    'morosos' => ['label' => __('Ver morosos', 'flavor-chat-ia'), 'icon' => 'alert'],
                ],
                'faqs' => [
                    __('¿Cómo registro un nuevo libro?', 'flavor-chat-ia'),
                    __('¿Cómo gestiono los préstamos vencidos?', 'flavor-chat-ia'),
                    __('¿Cómo configuro los plazos de préstamo?', 'flavor-chat-ia'),
                    __('¿Cómo importo el catálogo?', 'flavor-chat-ia'),
                ],
            ],
            'cursos' => [
                'nombre' => __('Cursos y Formación', 'flavor-chat-ia'),
                'descripcion' => __('Plataforma de cursos online y presenciales', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'crear_curso' => ['label' => __('Crear curso', 'flavor-chat-ia'), 'icon' => 'plus'],
                    'matriculas' => ['label' => __('Matrículas', 'flavor-chat-ia'), 'icon' => 'users'],
                    'contenidos' => ['label' => __('Contenidos', 'flavor-chat-ia'), 'icon' => 'file'],
                    'certificados' => ['label' => __('Certificados', 'flavor-chat-ia'), 'icon' => 'award'],
                ],
                'faqs' => [
                    __('¿Cómo creo un nuevo curso?', 'flavor-chat-ia'),
                    __('¿Cómo añado lecciones y contenidos?', 'flavor-chat-ia'),
                    __('¿Cómo configuro evaluaciones?', 'flavor-chat-ia'),
                    __('¿Cómo genero certificados?', 'flavor-chat-ia'),
                ],
            ],
            'transparencia' => [
                'nombre' => __('Transparencia', 'flavor-chat-ia'),
                'descripcion' => __('Portal de transparencia y rendición de cuentas', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'publicar_acta' => ['label' => __('Publicar acta', 'flavor-chat-ia'), 'icon' => 'file'],
                    'actualizar_presupuesto' => ['label' => __('Presupuesto', 'flavor-chat-ia'), 'icon' => 'money'],
                    'subir_contrato' => ['label' => __('Subir contrato', 'flavor-chat-ia'), 'icon' => 'upload'],
                    'estadisticas' => ['label' => __('Estadísticas', 'flavor-chat-ia'), 'icon' => 'chart'],
                ],
                'faqs' => [
                    __('¿Cómo publico un acta de reunión?', 'flavor-chat-ia'),
                    __('¿Cómo actualizo el presupuesto?', 'flavor-chat-ia'),
                    __('¿Qué documentos debo publicar?', 'flavor-chat-ia'),
                    __('¿Cómo configuro la visibilidad?', 'flavor-chat-ia'),
                ],
            ],
            'banco_tiempo' => [
                'nombre' => __('Banco de Tiempo', 'flavor-chat-ia'),
                'descripcion' => __('Intercambio de servicios entre miembros de la comunidad', 'flavor-chat-ia'),
                ...
                'quick_actions' => [
                    'ofrecer_servicio' => ['label' => __('Ofrecer servicio', 'flavor-chat-ia'), 'icon' => 'plus'],
                    'buscar_servicio' => ['label' => __('Buscar servicio', 'flavor-chat-ia'), 'icon' => 'search'],
                    'mis_intercambios' => ['label' => __('Mis intercambios', 'flavor-chat-ia'), 'icon' => 'update'],
                    'mi_saldo' => ['label' => __('Mi saldo', 'flavor-chat-ia'), 'icon' => 'clock'],
                ],
                'faqs' => [
                    __('¿Cómo ofrezco un servicio?', 'flavor-chat-ia'),
                    __('¿Cómo solicito un servicio?', 'flavor-chat-ia'),
                    __('¿Cómo funciona el sistema de horas?', 'flavor-chat-ia'),
                    __('¿Cómo contacto con otro miembro?', 'flavor-chat-ia'),
                ],
            ],
        ];
    }
    ...
    public function ajax_get_help() {
        ...
        if (!isset($this->module_contexts[$module])) {
            wp_send_json_error(['error' => __('Módulo no encontrado', 'flavor-chat-ia')]);
        }
    ...
    public function chat($module, $message, $history = []) {
        ...
        if (!$module_context) {
            return [
                'response' => __('No tengo información específica sobre este módulo.', 'flavor-chat-ia'),
                'type' => 'error',
            ];
        }
    ...
    private function get_fallback_response($module, $message) {
        ...
        $response = sprintf(
            __('Para ayuda con %s, estas son las acciones más comunes:', 'flavor-chat-ia'),
        ...
        $response .= "\n\n" . __('Para asistencia más detallada, contacta con el administrador.', 'flavor-chat-ia');
    ...
    public function execute_quick_action($module, $action) {
        ...
        if (!$context || !isset($context['quick_actions'][$action])) {
            return [
                'success' => false,
                'message' => __('Acción no encontrada', 'flavor-chat-ia'),
            ];
        }
        ...
        return [
            ...
            'type' => 'instruction',
            'message' => sprintf(
                __('Para "%s", ve al menú de %s en el panel de administración.', 'flavor-chat-ia'),
