...
class Flavor_Advertising_Frontend_Controller {
    ...
    public function shortcode_listado($atts) {
        ...
        echo '<p>' . __('Módulo Publicidad - Listado', 'flavor-chat-ia') . '</p>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function registrar_tabs($tabs) {
        $tabs['advertising'] = [
            'titulo' => __('Publicidad', 'flavor-chat-ia'),
    ...
    public function render_tab_principal() {
        ...
        echo '<h3>' . esc_html__('Publicidad', 'flavor-chat-ia') . '</h3>';
        echo '<p>' . esc_html__('Contenido del tab de Publicidad.', 'flavor-chat-ia') . '</p>';
        echo '</div>';
    }
}
