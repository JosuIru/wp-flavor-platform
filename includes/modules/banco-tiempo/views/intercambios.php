...
<div class="wrap">
    <h1 class="wp-heading-inline">
        ...
        <?php echo esc_html__('Gestión de Intercambios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </h1>
    ...
    <div class="intercambios-stats" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin: 20px 0;">
        <div class="stat-box" style="background: #fff; padding: 16px; border-left: 4px solid #dba617; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div class="stat-label" style="color: #646970;"><?php echo esc_html__('Pendientes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="stat-box" style="background: #fff; padding: 16px; border-left: 4px solid #2271b1; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div class="stat-label" style="color: #646970;"><?php echo esc_html__('Aceptados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="stat-box" style="background: #fff; padding: 16px; border-left: 4px solid #00a32a; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div class="stat-label" style="color: #646970;"><?php echo esc_html__('Completados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="stat-box" style="background: #fff; padding: 16px; border-left: 4px solid #d63638; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div class="stat-label" style="color: #646970;"><?php echo esc_html__('Cancelados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
    </div>
        ...
        <div class="alignleft actions">
            <form method="get" style="display: inline-flex; gap: 8px; align-items: center; flex-wrap: wrap;">
                ...
                <select name="estado">
                    ...
                    <option value="aceptado" <?php selected($filtro_estado, 'aceptado'); ?>><?php echo esc_html__('Aceptado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    ...
                    <option value="cancelado" <?php selected($filtro_estado, 'cancelado'); ?>><?php echo esc_html__('Cancelado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                </select>

                <input type="date" name="fecha_desde" value="<?php echo esc_attr($filtro_fecha_desde); ?>"
                       placeholder="<?php echo esc_attr__('Desde', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">

                <input type="date" name="fecha_hasta" value="<?php echo esc_attr($filtro_fecha_hasta); ?>"
                       placeholder="<?php echo esc_attr__('Hasta', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
    ...
    <table class="wp-list-table widefat fixed striped">
        <thead>
            <tr>
                ...
                <th><?php echo esc_html__('Servicio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                <th><?php echo esc_html__('Solicitante', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                <th><?php echo esc_html__('Proveedor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                <th><?php echo esc_html__('Horas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
            ...
            <?php if (!empty($intercambios)): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <em><?php echo esc_html__('Usuario desconocido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></em>
                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if ($receptor): ?>
                        ...
                        <?php if ($intercambio->estado === 'pendiente'): ?>
                            <form method="post" style="display: inline;">
                                ...
                                <button type="submit" class="button button-small button-primary"
                                        onclick="return window.confirm('<?php echo esc_js(__('¿Aprobar este intercambio?', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>');">
            ...
            <?php else: ?>
                <tr>
                    <td colspan="8" style="text-align: center; padding: 40px; color: #646970;">
                        ...
                        <p><?php echo esc_html__('No se encontraron intercambios.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    </td>
                </tr>
            <?php endif; ?>
        </tbody>
...
<div id="modal-detalle-intercambio" style="display:none;">
    <div class="modal-overlay" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.7); z-index: 100000;">
        <div class="modal-content" style="position: relative; max-width: 700px; margin: 50px auto; background: #fff; padding: 20px; border-radius: 4px;">
            <h2><?php echo esc_html__('Detalles del Intercambio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
