    ...
    public function render_tab_resumen() {
        ...
        <div class="flavor-panel flavor-biodiversidad-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-admin-site-alt3"></span> <?php esc_html_e('Biodiversidad Local', 'flavor-chat-ia'); ?></h2>
            </div>
            ...
            <div class="flavor-panel-kpis">
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Especies Catalogadas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Mis Avistamientos', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                ...
                <div class="flavor-kpi-card flavor-kpi-warning">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Especies Amenazadas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
            </div>
                    ...
                    <table class="flavor-table">
                        <thead>
                            <tr>
                                ...
                                <th><?php esc_html_e('Especie', 'flavor-chat-ia'); ?></th>
                        ...
                        <tbody>
                            <?php foreach ($avistamientos as $avistamiento): ?>
                                <tr>
                                    ...
                                    <td>
                                        <strong><?php echo esc_html($avistamiento->nombre_comun ?: __('Sin identificar', 'flavor-chat-ia')); ?></strong>
