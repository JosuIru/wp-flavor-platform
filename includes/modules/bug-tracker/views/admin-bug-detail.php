...
<div class="bug-detail-container">
    <p>
        <a href="<?php echo esc_url(admin_url('admin.php?page=flavor-bug-tracker')); ?>" class="button">
            ← <?php esc_html_e('Volver a la lista', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </a>
    </p>
    ...
    <div class="bug-detail-header">
        ...
        <div class="bug-detail-meta">
            <div class="meta-item">
                <strong><?php esc_html_e('Código:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
            ...
            <div class="meta-item">
                <strong><?php esc_html_e('Tipo:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                <?php echo esc_html(str_replace('_', ' ', ucfirst($bug_detalle->tipo))); ?>
            </div>

            <div class="meta-item">
                <strong><?php esc_html_e('Ocurrencias:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
        ...
        <div class="bug-detail-actions">
            <?php if ($bug_detalle->estado !== 'resuelto') : ?>
                <form method="post" style="display: inline;">
                    ...
                    <button type="submit" class="button button-primary">
                        ✓ <?php esc_html_e('Marcar como Resuelto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </button>
                </form>
            <?php endif; ?>
            ...
            <?php if ($bug_detalle->estado === 'resuelto' || $bug_detalle->estado === 'ignorado') : ?>
                <form method="post" style="display: inline;">
                    ...
                    <button type="submit" class="button">
                        ↺ <?php esc_html_e('Reabrir', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </button>
                </form>
            <?php endif; ?>
        </div>
        ...
        <div class="bug-detail-section">
            ...
            <div class="context-grid">
                <div class="context-item">
                    <div class="label"><?php esc_html_e('Archivo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    <div class="value"><code><?php echo esc_html($bug_detalle->archivo); ?></code></div>
                </div>
                <div class="context-item">
                    <div class="label"><?php esc_html_e('Línea', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    <div class="value"><?php echo esc_html($bug_detalle->linea); ?></div>
                </div>
                <?php if ($bug_detalle->modulo_id) : ?>
                    <div class="context-item">
                        <div class="label"><?php esc_html_e('Módulo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    ...
    <?php if ($bug_detalle->mensaje) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Mensaje de Error', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    <?php if ($bug_detalle->stack_trace) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Stack Trace', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    <?php if (!empty($bug_detalle->contexto_request)) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Contexto de Request', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <div class="context-grid">
    ...
    <?php if (!empty($bug_detalle->contexto_servidor)) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Contexto del Servidor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <div class="context-grid">
    ...
    <?php if (!empty($bug_detalle->contexto_usuario)) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Usuario Afectado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <div class="context-grid">
    ...
    <!-- Timestamps -->
    <div class="bug-detail-section">
        <h3><?php esc_html_e('Historial de Tiempo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <div class="context-grid">
            <div class="context-item">
                <div class="label"><?php esc_html_e('Primera Ocurrencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                <div class="value"><?php echo esc_html($bug_detalle->primera_ocurrencia); ?></div>
            </div>
            <div class="context-item">
                <div class="label"><?php esc_html_e('Última Ocurrencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                <div class="value"><?php echo esc_html($bug_detalle->ultima_ocurrencia); ?></div>
            </div>
            <?php if ($bug_detalle->resuelto_at) : ?>
                <div class="context-item">
                    <div class="label"><?php esc_html_e('Resuelto el', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    <div class="value"><?php echo esc_html($bug_detalle->resuelto_at); ?></div>
                </div>
            <?php endif; ?>
            <?php if ($bug_detalle->resuelto_por) : ?>
                <div class="context-item">
                    <div class="label"><?php esc_html_e('Resuelto por', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    <div class="value">
                        <?php
                        $usuario_resolvio = get_user_by('ID', $bug_detalle->resuelto_por);
                        echo $usuario_resolvio ? esc_html($usuario_resolvio->display_name) : esc_html__('Usuario desconocido', FLAVOR_PLATFORM_TEXT_DOMAIN);
                        ?>
                    </div>
                </div>
            <?php endif; ?>
    ...
    <div class="bug-detail-section notes-section">
        <h3><?php esc_html_e('Notas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        ...
        <form method="post">
            ...
            <textarea name="nota" placeholder="<?php esc_attr_e('Agregar una nota...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></textarea>

            <p style="margin-top: 10px;">
                <button type="submit" class="button"><?php esc_html_e('Agregar Nota', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            </p>
        </form>
    ...
    <?php if (!empty($bug_detalle->contexto_extra)) : ?>
        <div class="bug-detail-section">
            <h3><?php esc_html_e('Información Adicional', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    <div class="bug-detail-section">
        <h3><?php esc_html_e('Información Técnica', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <div class="context-grid">
            <div class="context-item">
                <div class="label"><?php esc_html_e('ID', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                <div class="value"><?php echo esc_html($bug_detalle->id); ?></div>
            </div>
            <div class="context-item">
                <div class="label"><?php esc_html_e('Hash Fingerprint', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
