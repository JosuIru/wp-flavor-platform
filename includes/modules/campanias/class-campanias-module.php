...
class Flavor_Platform_Campanias_Module extends Flavor_Platform_Module_Base {
    ...
    private function render_view($view_file) {
        ...
        if (!file_exists($path)) {
            ...
            return '<p class="flavor-info">' . esc_html__('No se pudo cargar la vista solicitada.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
    ...
    public static function get_renderer_config(): array {
        return [
            'module'   => 'campanias',
            'title'    => __('Campañas Ciudadanas', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'subtitle' => __('Coordina acciones colectivas y movilización social', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'icon'     => '📣',
            ...
            'fields' => [
                ...
                'objetivo'    => ['type' => 'textarea', 'label' => __('Objetivo', FLAVOR_PLATFORM_TEXT_DOMAIN)],
                'fecha_inicio'=> ['type' => 'date', 'label' => __('Fecha inicio', FLAVOR_PLATFORM_TEXT_DOMAIN)],
                'fecha_fin'   => ['type' => 'date', 'label' => __('Fecha fin', FLAVOR_PLATFORM_TEXT_DOMAIN)],
                'meta_firmas' => ['type' => 'number', 'label' => __('Meta de firmas', FLAVOR_PLATFORM_TEXT_DOMAIN)],
            ...
            'stats' => [
                ...
                [
                    'key'   => 'total_firmas',
                    'label' => __('Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'icon'  => '✍️',
                    'color' => 'blue',
                ...
                [
                    'key'   => 'total_acciones',
                    'label' => __('Acciones', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'icon'  => '📅',
                    'color' => 'purple',
            ...
            'tabs' => [
                ...
                'mis-campanias' => [
                    'label'   => __('Mis campañas', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'icon'    => '👤',
                    'content' => 'shortcode:campanias_mis_campanias',
                ],
                'firmar' => [
                    'label'   => __('Firmar', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'icon'    => '✍️',
            ...
            'dashboard' => [
                'widgets' => [
                    'mis_campanias'  => ['type' => 'list', 'title' => __('Mis campañas', FLAVOR_PLATFORM_TEXT_DOMAIN)],
                    'firmas_recientes' => ['type' => 'activity', 'title' => __('Últimas firmas', FLAVOR_PLATFORM_TEXT_DOMAIN)],
                ],
                'actions' => [
                    'nueva_campania' => [
                        'label' => __('Nueva campaña', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        'icon'  => '➕',
    ...
    protected function get_admin_config() {
        return [
            'id' => 'campanias',
            'label' => __('Campanias', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            'paginas' => [
                ...
                [
                    ...
                    'titulo' => __('Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function get_admin_estadisticas() {
        ...
        return [
            [
                ...
                'label' => __('Total campanias', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'color' => 'blue',
            ...
            [
                ...
                'label' => __('Campanias activas', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'color' => 'green',
            ...
            [
                'icon' => 'dashicons-edit',
                'valor' => $total_firmas,
                'label' => __('Total firmas', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'color' => 'purple',
            ...
            [
                ...
                'label' => __('Campanias exitosas', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'color' => 'gold',
            ],
        ];
    }
    ...
    public function render_admin_widget() {
        ...
        <div class="flavor-admin-widget-campanias">
            <?php if (empty($campanias_recientes)): ?>
                <p class="flavor-empty-state"><?php _e('No hay campanias registradas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <?php else: ?>
    ...
    public function render_admin_dashboard() {
        ...
        $acciones = $is_dashboard_viewer
            ...
            : [
                [
                    'label' => __('Nueva Campania', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'url' => admin_url('admin.php?page=campanias-listado&accion=nueva'),
                    'class' => 'button-primary',
                ],
            ];
        $this->render_page_header(__('Dashboard de Campanias', FLAVOR_PLATFORM_TEXT_DOMAIN), $acciones);
        ?>
        <div class="wrap flavor-admin-dashboard">
            <?php if ($is_dashboard_viewer) : ?>
                <div class="notice notice-info"><p><?php esc_html_e('Vista resumida para gestor de grupos. La edición de campañas, firmas y acciones sigue reservada a administración.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p></div>
            <?php endif; ?>
            <?php if (method_exists($this, 'render_admin_module_hub')) : ?>
                <?php $this->render_admin_module_hub([
                    'description' => __('Acceso visible al dashboard, listado, firmas, configuración y al bloque principal de métricas.', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <div id="campanias-stats" class="flavor-stats-grid campanias-admin-dashboard__stats">
                <div class="flavor-stat-card campanias-admin-dashboard__stat-card campanias-admin-dashboard__stat-card--blue">
                    ...
                    <div class="stat-label campanias-admin-dashboard__stat-label"><?php _e('Total Campanias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                ...
                <div class="flavor-stat-card campanias-admin-dashboard__stat-card campanias-admin-dashboard__stat-card--green">
                    ...
                    <div class="stat-label campanias-admin-dashboard__stat-label"><?php _e('Campanias Activas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                ...
                <div class="flavor-stat-card campanias-admin-dashboard__stat-card campanias-admin-dashboard__stat-card--purple">
                    ...
                    <div class="stat-label campanias-admin-dashboard__stat-label"><?php _e('Total Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    <div class="stat-extra campanias-admin-dashboard__stat-extra">
                        +<?php echo $firmas_hoy; ?> <?php _e('hoy', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> /
                        +<?php echo $firmas_semana; ?> <?php _e('esta semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </div>
                </div>
                ...
                <div class="flavor-stat-card campanias-admin-dashboard__stat-card campanias-admin-dashboard__stat-card--gold">
                    ...
                    <div class="stat-label campanias-admin-dashboard__stat-label"><?php _e('Campanias Exitosas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
            </div>

            <?php if ($is_dashboard_viewer) : ?>
                <p><?php esc_html_e('El resto de accesos administrativos del dashboard se ocultan en modo gestor para evitar flujos de edición o moderación fuera de alcance.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
                <?php
                return;
            endif; ?>
            ...
            <div class="flavor-dashboard-columns campanias-admin-dashboard__columns">
                ...
                <div class="flavor-main-column">
                    ...
                    <div class="flavor-card campanias-admin-dashboard__card campanias-admin-dashboard__card--mb">
                        <h3 class="campanias-admin-dashboard__card-title">
                            ...
                            <?php _e('Campanias con mas firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </h3>
                        <?php if (empty($top_campanias)): ?>
                            <p class="flavor-empty"><?php _e('No hay campanias con objetivo de firmas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <?php else: ?>
                            <table class="widefat striped campanias-admin-dashboard__table-clean">
                                <thead>
                                    <tr>
                                        <th><?php _e('Campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    ...
                    <div class="flavor-card campanias-admin-dashboard__card campanias-admin-dashboard__card--mb">
                        <h3 class="campanias-admin-dashboard__card-title">
                            ...
                            <?php _e('Tendencia de firmas (ultimos 7 dias)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </h3>
                        <?php if (empty($tendencia_firmas)): ?>
                            <p class="flavor-empty"><?php _e('No hay datos de firmas en los ultimos 7 dias.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <?php else: ?>
                    ...
                    <div class="flavor-card campanias-admin-dashboard__card">
                        <h3 class="campanias-admin-dashboard__card-title">
                            ...
                            <?php _e('Proximas acciones programadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </h3>
                        <?php if (empty($proximas_acciones)): ?>
                            <p class="flavor-empty"><?php _e('No hay acciones programadas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <?php else: ?>
                ...
                <div class="flavor-sidebar-column">
                    ...
                    <div class="flavor-card campanias-admin-dashboard__card campanias-admin-dashboard__card--mb">
                        ...
                        <ul class="campanias-admin-dashboard__status-list">
                            <li class="campanias-admin-dashboard__status-item">
                                <span><span class="dashicons dashicons-clock campanias-admin-dashboard__icon-muted"></span> <?php _e('Planificadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                <strong><?php echo $campanias_planificadas; ?></strong>
                            </li>
                            <li class="campanias-admin-dashboard__status-item">
                                <span><span class="dashicons dashicons-yes campanias-admin-dashboard__icon-green"></span> <?php _e('Activas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                            ...
                            <li class="campanias-admin-dashboard__status-item campanias-admin-dashboard__status-item--last">
                                <span><span class="dashicons dashicons-flag campanias-admin-dashboard__icon-blue"></span> <?php _e('Completadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    ...
                    <div class="flavor-card campanias-admin-dashboard__card">
                        <h3 class="campanias-admin-dashboard__card-title">
                            <span class="dashicons dashicons-edit"></span>
                            <?php _e('Firmas recientes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </h3>
                        <?php if (empty($firmas_recientes)): ?>
                            <p class="flavor-empty"><?php _e('No hay firmas registradas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <?php else: ?>
                                ...
                                <?php foreach ($firmas_recientes as $firma): ?>
                                    <li class="campanias-admin-dashboard__signatures-item">
                                        ...
                                        <div class="campanias-admin-dashboard__signatures-time">
                                            <?php echo human_time_diff(strtotime($firma->created_at), current_time('timestamp')); ?> <?php _e('ago', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        ...
                        <p class="campanias-admin-dashboard__signatures-link">
                            <a href="<?php echo esc_url(admin_url('admin.php?page=campanias-firmas')); ?>" class="button">
                                <?php _e('Ver todas las firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </a>
                        </p>
                    </div>
                </div>
    ...
    public function render_admin_listado() {
        ...
        if (isset($_POST['guardar_campania']) && check_admin_referer('campanias_guardar', 'campanias_nonce')) {
            ...
            if ($campania_id > 0) {
                ...
                $mensaje = __('Campania actualizada correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN);
            } else {
                $datos['creador_id'] = get_current_user_id();
                $wpdb->insert($tabla_campanias, $datos);
                $campania_id = $wpdb->insert_id;
                $mensaje = __('Campania creada correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN);
            }
        ...
        if ($accion === 'eliminar' && $campania_id > 0 && check_admin_referer('eliminar_campania_' . $campania_id)) {
            ...
            echo '<div class="notice notice-success is-dismissible"><p>' . __('Campania eliminada correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p></div>';
            $accion = '';
            $campania_id = 0;
        }
        ...
        if ($accion === 'nueva' || $accion === 'editar') {
            ...
            $this->render_page_header(
                $campania ? __('Editar Campania', FLAVOR_PLATFORM_TEXT_DOMAIN) : __('Nueva Campania', FLAVOR_PLATFORM_TEXT_DOMAIN),
                [
                    [
                        'label' => __('Volver al listado', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <form method="post" class="flavor-admin-form" style="background: #fff; padding: 20px; max-width: 800px;">
                ...
                <table class="form-table">
                    <tr>
                        <th><label for="titulo"><?php _e('Titulo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label></th>
                        <td><input type="text" name="titulo" id="titulo" class="regular-text" required value="<?php echo esc_attr($campania->titulo ?? ''); ?>"></td>
                    </tr>
                    <tr>
                        <th><label for="descripcion"><?php _e('Descripcion', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                        <td>
                            <?php
                            wp_editor(
                    ...
                    <tr>
                        <th><label for="tipo"><?php _e('Tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                        <td>
                    ...
                    <tr>
                        <th><label for="estado"><?php _e('Estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                        <td>
                            <select name="estado" id="estado">
                                <option value="planificada" <?php selected($campania->estado ?? '', 'planificada'); ?>><?php _e('Planificada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="activa" <?php selected($campania->estado ?? '', 'activa'); ?>><?php _e('Activa', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="pausada" <?php selected($campania->estado ?? '', 'pausada'); ?>><?php _e('Pausada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="completada" <?php selected($campania->estado ?? '', 'completada'); ?>><?php _e('Completada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="cancelada" <?php selected($campania->estado ?? '', 'cancelada'); ?>><?php _e('Cancelada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="objetivo_descripcion"><?php _e('Objetivo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                    ...
                    <tr>
                        <th><label for="visibilidad"><?php _e('Visibilidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                        <td>
                            <select name="visibilidad" id="visibilidad">
                                <option value="publica" <?php selected($campania->visibilidad ?? '', 'publica'); ?>><?php _e('Publica', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="miembros" <?php selected($campania->visibilidad ?? '', 'miembros'); ?>><?php _e('Solo miembros', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                                <option value="privada" <?php selected($campania->visibilidad ?? '', 'privada'); ?>><?php _e('Privada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <th><label for="destacada"><?php _e('Destacada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label></th>
                        <td>
                            <label>
                                <input type="checkbox" name="destacada" id="destacada" value="1" <?php checked($campania->destacada ?? 0, 1); ?>>
                                <?php _e('Mostrar como destacada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                </table>
                ...
                <p class="submit">
                    <button type="submit" name="guardar_campania" class="button button-primary">
                        <?php echo $campania ? __('Actualizar Campania', FLAVOR_PLATFORM_TEXT_DOMAIN) : __('Crear Campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </button>
                </p>
            </form>
            <?php
        ...
        $this->render_page_header(
            __('Listado de Campanias', FLAVOR_PLATFORM_TEXT_DOMAIN),
            [
                [
                    'label' => __('Nueva Campania', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    'url' => admin_url('admin.php?page=campanias-listado&accion=nueva'),
        ...
        <div class="wrap">
            ...
            <form method="get" class="flavor-filters campanias-admin-list__filters">
                ...
                <select name="estado">
                    ...
                    <option value="planificada" <?php selected($filtro_estado, 'planificada'); ?>><?php _e('Planificada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="activa" <?php selected($filtro_estado, 'activa'); ?>><?php _e('Activa', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="pausada" <?php selected($filtro_estado, 'pausada'); ?>><?php _e('Pausada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="completada" <?php selected($filtro_estado, 'completada'); ?>><?php _e('Completada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="cancelada" <?php selected($filtro_estado, 'cancelada'); ?>><?php _e('Cancelada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                </select>
            ...
            <?php if (empty($campanias)): ?>
                <div class="notice notice-info">
                    <p><?php _e('No se encontraron campanias.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php else: ?>
                <table class="wp-list-table widefat fixed striped">
                    <thead>
                        <tr>
                            <th class="campanias-admin-list__col-title"><?php _e('Titulo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Fecha inicio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Creador', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="campanias-admin-list__col-actions"><?php _e('Acciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($campania->destacada): ?>
                                        <span class="dashicons dashicons-star-filled campanias-admin-list__icon-star" title="<?php _e('Destacada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=campanias-listado&accion=eliminar&id=' . $campania->id), 'eliminar_campania_' . $campania->id)); ?>"
                                       ...
                                       onclick="return confirm('<?php _e('Seguro que quieres eliminar esta campania?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');">
                            ...
                            <span class="pagination-links">
                                ...
                                if ($pagina_actual > 1): ?>
                                    <a class="prev-page button" href="<?php echo esc_url(add_query_arg('paged', $pagina_actual - 1, $base_url)); ?>">
                                        <span class="screen-reader-text"><?php _e('Anterior', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                        <span aria-hidden="true">&lsaquo;</span>
                                    </a>
                                <?php endif; ?>

                                <span class="paging-input">
                                    <?php echo $pagina_actual; ?> <?php _e('de', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <?php echo $total_paginas; ?>
                                </span>

                                <?php if ($pagina_actual < $total_paginas): ?>
                                    <a class="next-page button" href="<?php echo esc_url(add_query_arg('paged', $pagina_actual + 1, $base_url)); ?>">
                                        <span class="screen-reader-text"><?php _e('Siguiente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
    ...
    public function render_admin_firmas() {
        ...
        if (isset($_GET['accion']) && $_GET['accion'] === 'eliminar' && isset($_GET['id'])) {
            ...
            if (check_admin_referer('eliminar_firma_' . $firma_id)) {
                ...
                echo '<div class="notice notice-success is-dismissible"><p>' . __('Firma eliminada correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p></div>';
            }
        }
        ...
        if (isset($_GET['accion']) && $_GET['accion'] === 'verificar' && isset($_GET['id'])) {
            ...
            if (check_admin_referer('verificar_firma_' . $firma_id)) {
                ...
                echo '<div class="notice notice-success is-dismissible"><p>' . __('Firma verificada correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p></div>';
            }
        }
        ...
        $this->render_page_header(
            __('Historico de Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN),
            [
                [
                    'label' => __('Exportar CSV', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        <div class="wrap">
            ...
            <div class="flavor-stats-inline campanias-admin-firmas__stats-inline">
                <div>
                    ...
                    <span class="campanias-admin-firmas__stats-label"><?php _e('Total firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div>
                    <strong><?php echo (int) $wpdb->get_var("SELECT COUNT(*) FROM $tabla_firmas WHERE verificada = 1"); ?></strong>
                    <span class="campanias-admin-firmas__stats-label"><?php _e('Verificadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div>
                    ...
                    <span class="campanias-admin-firmas__stats-label"><?php _e('Hoy', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            ...
            <form method="get" class="flavor-filters campanias-admin-firmas__filters">
                ...
                <select name="campania_id">
                    <option value=""><?php _e('Todas las campanias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                ...
                <select name="verificada">
                    <option value=""><?php _e('Todas las firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="1" <?php selected($filtro_verificada, '1'); ?>><?php _e('Verificadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="0" <?php selected($filtro_verificada, '0'); ?>><?php _e('No verificadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                </select>

                <input type="search" name="s" value="<?php echo esc_attr($busqueda); ?>" placeholder="<?php _e('Buscar por nombre, email...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            ...
            <?php if (empty($firmas)): ?>
                <div class="notice notice-info">
                    <p><?php _e('No se encontraron firmas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php else: ?>
                <table class="wp-list-table widefat fixed striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php _e('Localidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php _e('Fecha', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="campanias-admin-firmas__col-actions"><?php _e('Acciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($firma->user_id): ?>
                                        <span class="dashicons dashicons-admin-users campanias-admin-firmas__icon-user" title="<?php _e('Usuario registrado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <?php if ($firma->verificada): ?>
                                        ...
                                        <?php _e('Verificada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php if (!$firma->verificada): ?>
                                        <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=campanias-firmas&accion=verificar&id=' . $firma->id), 'verificar_firma_' . $firma->id)); ?>"
                                           class="button button-small" title="<?php _e('Verificar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                    ...
                                    <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=campanias-firmas&accion=eliminar&id=' . $firma->id), 'eliminar_firma_' . $firma->id)); ?>"
                                       class="button button-small button-link-delete"
                                       onclick="return confirm('<?php _e('Seguro que quieres eliminar esta firma?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');"
                                       title="<?php _e('Eliminar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                ...
                <?php if ($total_paginas > 1): ?>
                    <div class="tablenav bottom">
                        <div class="tablenav-pages">
                            <span class="displaying-num"><?php printf(__('%d firmas', FLAVOR_PLATFORM_TEXT_DOMAIN), $total_items); ?></span>
                            <span class="pagination-links">
                                <?php
    ...
    public function render_admin_config() {
        ...
        $this->render_page_header(__('Configuracion de Campanias', FLAVOR_PLATFORM_TEXT_DOMAIN));
        ?>
        <div class="wrap">
            <form method="post" class="flavor-admin-form" style="background: #fff; padding: 20px; max-width: 800px;">
                <?php wp_nonce_field('campanias_config', 'campanias_config_nonce'); ?>

                <h2><?php _e('Configuracion General', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <table class="form-table">
                    <tr>
                        <th><?php _e('Aprobacion de campanias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="requiere_aprobacion" value="1" <?php checked($config['requiere_aprobacion'], true); ?>>
                                <?php _e('Las nuevas campanias requieren aprobacion de un administrador', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Campanias por usuario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <input type="number" name="max_campanias_por_usuario" min="1" max="100" value="<?php echo intval($config['max_campanias_por_usuario']); ?>">
                            <p class="description"><?php _e('Numero maximo de campanias que un usuario puede crear', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Tipos de campania permitidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <?php foreach ($this->get_tipos_campania() as $valor => $etiqueta): ?>
                    ...
                    <tr>
                        <th><?php _e('Mostrar mapa de acciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="mostrar_mapa_acciones" value="1" <?php checked($config['mostrar_mapa_acciones'], true); ?>>
                                <?php _e('Mostrar mapa interactivo con las acciones programadas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                </table>

                <h2><?php _e('Configuracion de Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <table class="form-table">
                    <tr>
                        <th><?php _e('Firmas anonimas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="permitir_firmas_anonimas" value="1" <?php checked($config['permitir_firmas_anonimas'], true); ?>>
                                <?php _e('Permitir firmar sin estar registrado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Verificacion de email', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="verificar_email_firmas" value="1" <?php checked($config['verificar_email_firmas'], true); ?>>
                                <?php _e('Requerir verificacion de email para validar firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Mostrar firmantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="mostrar_firmantes_publicos" value="1" <?php checked($config['mostrar_firmantes_publicos'] ?? false, true); ?>>
                                <?php _e('Mostrar lista de firmantes publicamente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Limite por IP', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <input type="number" name="limite_firmas_por_ip" min="0" max="100" value="<?php echo intval($config['limite_firmas_por_ip'] ?? 0); ?>">
                            <p class="description"><?php _e('Numero maximo de firmas permitidas por IP (0 = sin limite)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Mensaje post-firma', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <textarea name="texto_firma_exitosa" rows="3" class="large-text"><?php echo esc_textarea($config['texto_firma_exitosa'] ?? __('Gracias por firmar. Tu apoyo es muy importante para esta causa.', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></textarea>
                            <p class="description"><?php _e('Mensaje que se muestra tras firmar exitosamente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                <table class="form-table">
                    <tr>
                        <th><?php _e('Notificar nuevas campanias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="notificar_nuevas_campanias" value="1" <?php checked($config['notificar_nuevas_campanias'], true); ?>>
                                <?php _e('Enviar notificacion cuando se crea una nueva campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php _e('Email para notificaciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <td>
                            ...
                            <p class="description"><?php _e('Email donde se enviaran las notificaciones de administracion', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        </td>
                    </tr>
                </table>

                <h2><?php _e('Shortcodes disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <div style="background: #f6f7f7; padding: 15px; border-radius: 4px;">
                    <p><code>[campanias_listar]</code> - <?php _e('Muestra el listado de campanias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_detalle id="X"]</code> - <?php _e('Muestra el detalle de una campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_crear]</code> - <?php _e('Formulario para crear campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_mis_campanias]</code> - <?php _e('Campanias del usuario actual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_firmar id="X"]</code> - <?php _e('Formulario para firmar una campania', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_mapa]</code> - <?php _e('Mapa de acciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p><code>[campanias_calendario]</code> - <?php _e('Calendario de acciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
