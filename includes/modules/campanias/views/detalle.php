        ...
        <div class="flavor-campania-meta">
            <?php if ($campania->creador): ?>
                <span>
                    ...
                    <?php
                    printf(
                        esc_html__('Organiza: %s', 'flavor-platform'),
    ...
    <div class="flavor-campania-body">
        ...
        <?php if ($campania->objetivo_descripcion): ?>
            <div style="margin-top: 2rem; padding: 1.5rem; background: #fef2f2; border-radius: 8px;">
                <h3 style="margin: 0 0 0.5rem; color: #991b1b;"><?php esc_html_e('Objetivo', 'flavor-platform'); ?></h3>
        ...
        <?php if ($campania->tipo === 'recogida_firmas'): ?>
            <div style="margin-top: 2rem;">
                <h3><?php esc_html_e('Firmas recogidas', 'flavor-platform'); ?></h3>
                <div class="flavor-firmas-progress">
                    ...
                    <div class="flavor-firmas-count" style="font-size: 1rem;">
                        <span class="flavor-firmas-actual" style="font-size: 1.5rem;">
                            <?php
                            printf(
                                esc_html__('%s firmas', 'flavor-platform'),
                        ...
                        <?php if ($campania->objetivo_firmas > 0): ?>
                            <span class="flavor-firmas-objetivo" data-objetivo="<?php echo esc_attr($campania->objetivo_firmas); ?>">
                                <?php
                                printf(
                                    esc_html__('Objetivo: %s', 'flavor-platform'),
                ...
                <div class="flavor-firma-form" style="margin-top: 2rem;">
                    <h3><?php esc_html_e('Firma esta campaña', 'flavor-platform'); ?></h3>
                    <form method="post" class="flavor-firma-detalle-form" novalidate aria-label="<?php echo esc_attr__('Formulario para firmar campaña desde el detalle', 'flavor-platform'); ?>">
                        ...
                        <div class="flavor-form-group">
                            <label for="firma_nombre"><?php esc_html_e('Nombre completo', 'flavor-platform'); ?> *</label>
                        ...
                        <div class="flavor-form-group">
                            <label for="firma_email"><?php esc_html_e('Email', 'flavor-platform'); ?> *</label>
                        ...
                        <div class="flavor-form-group">
                            <label for="firma_localidad"><?php esc_html_e('Localidad', 'flavor-platform'); ?></label>
                            <input type="text" id="firma_localidad" name="localidad">
                        </div>

                        <div class="flavor-form-group">
                            <label for="firma_comentario"><?php esc_html_e('Comentario (opcional)', 'flavor-platform'); ?></label>
                        ...
                        <button type="submit" class="flavor-btn flavor-btn-primary flavor-btn-block">
                            ...
                            <?php esc_html_e('Firmar campaña', 'flavor-platform'); ?>
                        </button>
        ...
        <?php if (!empty($campania->acciones)): ?>
            <div class="flavor-campania-acciones-lista">
                <h3><?php esc_html_e('Próximas acciones', 'flavor-platform'); ?></h3>
        ...
        <?php if (!empty($campania->participantes)): ?>
            <div style="margin-top: 2rem;">
                <h3>
                    <?php
                    printf(
                        esc_html__('%s participantes', 'flavor-platform'),
        ...
        <div style="margin-top: 2rem; display: flex; gap: 1rem; flex-wrap: wrap;">
            <?php if (is_user_logged_in()): ?>
                <?php if ($es_participante): ?>
                    <span class="flavor-estado flavor-estado-activa">
                        <?php
                        printf(
                            esc_html__('Participas como %s', 'flavor-platform'),
            ...
            <?php else: ?>
                <p>
                    ...
                    printf(
                        wp_kses(
                            __('%1$sInicia sesión%2$s para participar en esta campaña.', 'flavor-platform'),
                            ['a' => ['href' => []]]
                        ),
        ...
        <?php if (!empty($campania->actualizaciones)): ?>
            <div style="margin-top: 2rem;">
                <h3><?php esc_html_e('Actualizaciones', 'flavor-platform'); ?></h3>
        ...
        try {
            ...
            if (!json.success) {
                if (statusEl) {
                    statusEl.textContent = (json.data && json.data.error)
                        ? json.data.error
                        : '<?php echo esc_js(__('No se pudo registrar la firma.', 'flavor-platform')); ?>';
                }
                return;
            }
            ...
            if (statusEl) {
                statusEl.textContent = (json.data && json.data.mensaje)
                    ? json.data.mensaje
                    : '<?php echo esc_js(__('Firma registrada.', 'flavor-platform')); ?>';
            }
            form.reset();
        } catch (error) {
            if (statusEl) {
