...
<div class="wrap flavor-campanias-estadisticas">
    <h1 class="wp-heading-inline">
        ...
        <?php esc_html_e('Estadísticas de Campañas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </h1>
    ...
    <div class="dm-filter-bar">
        <form method="get" class="dm-date-filter">
            ...
            <div class="dm-filter-group">
                <label><?php esc_html_e('Desde', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                <input type="date" name="fecha_inicio" value="<?php echo esc_attr($fecha_inicio); ?>">
            </div>
            <div class="dm-filter-group">
                <label><?php esc_html_e('Hasta', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
    ...
    <div class="dm-stats-grid">
        <div class="dm-stat-card">
            ...
            <div class="dm-stat-content">
                ...
                <span class="dm-stat-label"><?php esc_html_e('Total Campañas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        ...
        <div class="dm-stat-card">
            ...
            <div class="dm-stat-content">
                ...
                <span class="dm-stat-label"><?php esc_html_e('Campañas Activas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        ...
        <div class="dm-stat-card">
            ...
            <div class="dm-stat-content">
                ...
                <span class="dm-stat-label"><?php esc_html_e('Total Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        ...
        <div class="dm-stat-card">
            ...
            <div class="dm-stat-content">
                ...
                <span class="dm-stat-label"><?php esc_html_e('Firmas en Período', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="dm-stats-row">
        ...
        <div class="dm-card dm-card--chart">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-chart-area"></span> <?php esc_html_e('Evolución de Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
        ...
        <div class="dm-card">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-star-filled"></span> <?php esc_html_e('Campañas Más Populares', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            <div class="dm-card__body">
                                ...
                                <div class="dm-popular-info">
                                    ...
                                    <span class="dm-popular-meta">
                                        ...
                                        $progreso = $campania->meta_firmas > 0
                                            ...
                                            : 0;
                                        printf(
                                            esc_html__('%s firmas de %s (%d%%)', FLAVOR_PLATFORM_TEXT_DOMAIN),
                ...
                <?php else: ?>
                    <p class="dm-empty"><?php esc_html_e('No hay campañas registradas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3><span class="dashicons dashicons-category"></span> <?php esc_html_e('Estadísticas por Categoría', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        </div>
        <div class="dm-card__body">
                ...
                <table class="widefat striped dm-table">
                    <thead>
                        <tr>
                            ...
                            <th class="num"><?php esc_html_e('Campañas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="num"><?php esc_html_e('Total Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="num"><?php esc_html_e('Promedio Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <?php else: ?>
                <p class="dm-empty"><?php esc_html_e('No hay datos de categorías disponibles.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3><span class="dashicons dashicons-money-alt"></span> <?php esc_html_e('Donaciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        </div>
        <div class="dm-card__body">
            <div class="dm-donation-stats">
                <div class="dm-donation-stat">
                    ...
                    <span class="dm-donation-label"><?php esc_html_e('Total Recaudado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="dm-donation-stat">
                    <span class="dm-donation-value"><?php echo number_format_i18n($donaciones_periodo, 2); ?> &euro;</span>
                    <span class="dm-donation-label"><?php esc_html_e('En el Período', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    if (ctx && typeof Chart !== 'undefined') {
        new Chart(ctx.getContext('2d'), {
            ...
            data: {
                ...
                datasets: [{
                    label: '<?php esc_html_e('Firmas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>',
