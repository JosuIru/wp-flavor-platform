...
<div class="flavor-estados-container" data-flavor-estados>
    <div class="flavor-estados-header">
        <h3><?php esc_html_e('Estados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <button class="btn-crear-estado" type="button" title="<?php esc_attr_e('Crear estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
    ...
    <div class="estados-lista-horizontal">
        ...
        <div class="estado-item mi-estado" data-user-id="<?php echo esc_attr($user_id); ?>">
            ...
            <span class="estado-nombre"><?php esc_html_e('Tu estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
    ...
    <div class="estados-acciones">
        <button class="btn-crear-estado-grande" type="button">
            ...
            <?php esc_html_e('Crear estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
    </div>
    <?php endif; ?>
</div>
