...
<div class="estados-widget">
    ...
    <div class="mis-estados-resumen">
        <div class="estados-count">
            ...
            <span class="label"><?php esc_html_e('estados activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="estados-vistas">
            ...
            <span><?php echo number_format_i18n($total_vistas); ?> <?php esc_html_e('vistas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
    </div>
    <?php else: ?>
    <div class="sin-estados">
        <span class="dashicons dashicons-format-status"></span>
        <p><?php esc_html_e('No tienes estados activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        <button class="btn-crear-estado btn-small"><?php esc_html_e('Crear estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
    </div>
    <?php endif; ?>

    <?php if (!empty($contactos)): ?>
    <div class="contactos-estados">
        <h4><?php esc_html_e('Estados de contactos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        ...
        <a href="<?php echo esc_url(home_url('/estados/')); ?>" class="ver-todos">
            <?php printf(esc_html__('Ver todos (%d)', FLAVOR_PLATFORM_TEXT_DOMAIN), count($contactos)); ?>
        </a>
        <?php endif; ?>
    </div>
    <?php endif; ?>
