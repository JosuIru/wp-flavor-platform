...
class Flavor_Platform_Grupos_Frontend_Controller {
...
$frontend_controller_class = 'Flavor_Platform_Grupos_Frontend_Controller';
if (!class_exists('Flavor_Chat_Grupos_Frontend_Controller', false)) {
    class_alias('Flavor_Platform_Grupos_Frontend_Controller', 'Flavor_Chat_Grupos_Frontend_Controller');
}
