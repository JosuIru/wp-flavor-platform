...
<div class="cc-listado">
    <header class="cc-listado__header">
        <h2><?php esc_html_e('Círculos de Cuidados', 'flavor-chat-ia'); ?></h2>
        <p><?php esc_html_e('Redes de apoyo mutuo para cuidarnos entre todas', 'flavor-chat-ia'); ?></p>
    </header>
        ...
        <article class="cc-circulo-card" style="--cc-color: <?php echo esc_attr($tipo_data['color']); ?>">
            ...
            <footer class="cc-circulo-card__footer">
                <span class="cc-circulo-card__miembros">
                    ...
                    <?php printf(
                        esc_html__('%d/%d miembros', 'flavor-chat-ia'),
                        count($miembros),
                        $max_miembros
                    ); ?>
                </span>
                ...
                <span class="cc-badge-miembro"><?php esc_html_e('Eres miembro', 'flavor-chat-ia'); ?></span>
                <?php endif; ?>
            </footer>
        </article>
    ...
    <div class="cc-empty-state">
        ...
        <p><?php esc_html_e('No hay círculos de cuidados aún. ¡Crea el primero!', 'flavor-chat-ia'); ?></p>
    </div>
    <?php endif; ?>
</div>
