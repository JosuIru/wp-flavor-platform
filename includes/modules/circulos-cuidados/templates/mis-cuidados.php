...
<div class="cc-mis-cuidados">
    <h2><?php esc_html_e('Mis Cuidados', 'flavor-chat-ia'); ?></h2>

    <!-- Estadísticas -->
    <div class="cc-stats-grid">
        <div class="cc-stat-card">
            <div class="cc-stat-card__valor"><?php echo esc_html($stats['circulos']); ?></div>
            <div class="cc-stat-card__label"><?php esc_html_e('Círculos', 'flavor-chat-ia'); ?></div>
        </div>
        <div class="cc-stat-card cc-stat-card--horas">
            ...
            <div class="cc-stat-card__label"><?php esc_html_e('Horas donadas', 'flavor-chat-ia'); ?></div>
        </div>
        <div class="cc-stat-card cc-stat-card--ayudas">
            <div class="cc-stat-card__valor"><?php echo esc_html($stats['necesidades_ayudadas']); ?></div>
            <div class="cc-stat-card__label"><?php esc_html_e('Ayudas dadas', 'flavor-chat-ia'); ?></div>
        </div>
    </div>

    <!-- Mis círculos -->
    <section class="cc-seccion">
        <h3 class="cc-seccion__titulo"><?php esc_html_e('Mis Círculos', 'flavor-chat-ia'); ?></h3>
            ...
            <article class="cc-circulo-card" style="--cc-color: <?php echo esc_attr($tipo_data['color']); ?>">
                ...
                <footer class="cc-circulo-card__footer">
                    <span class="cc-circulo-card__miembros">
                        ...
                        <?php echo count($miembros); ?> <?php esc_html_e('miembros', 'flavor-chat-ia'); ?>
                    </span>
                    <span class="cc-badge-miembro"><?php esc_html_e('Miembro', 'flavor-chat-ia'); ?></span>
                </footer>
            </article>
            <?php endforeach; ?>
        </div>
        <?php else : ?>
        <p class="cc-empty-text"><?php esc_html_e('No participas en ningún círculo aún.', 'flavor-chat-ia'); ?></p>
        <?php endif; ?>
    </section>
    ...
    <section class="cc-seccion">
        ...
        <div class="cc-necesidades-lista">
            ...
            <div class="cc-necesidad-card cc-necesidad-card--<?php echo esc_attr($urgencia); ?>">
                ...
                <div class="cc-necesidad-card__meta">
                    ...
                    <span>
                        <span class="dashicons dashicons-groups"></span>
                        <?php printf(esc_html__('%d ofertas', 'flavor-chat-ia'), count($ayudantes)); ?>
                    </span>
        ...
        <?php else : ?>
        <p class="cc-empty-text"><?php esc_html_e('No tienes necesidades activas.', 'flavor-chat-ia'); ?></p>
        <?php endif; ?>
    </section>

    <!-- Historial de ayuda dada -->
    <section class="cc-seccion">
        <h3 class="cc-seccion__titulo"><?php esc_html_e('Ayuda que he dado', 'flavor-chat-ia'); ?></h3>
        ...
        <?php else : ?>
        <p class="cc-empty-text"><?php esc_html_e('Aún no has registrado horas de cuidado.', 'flavor-chat-ia'); ?></p>
        <?php endif; ?>
    </section>
</div>
...
<div class="cc-modal" id="cc-modal-crear-necesidad">
    <div class="cc-modal__contenido">
        <div class="cc-modal__header">
            <h3 class="cc-modal__titulo"><?php esc_html_e('Solicitar ayuda', 'flavor-chat-ia'); ?></h3>
        ...
        <form class="cc-form-crear-necesidad">
            <div class="cc-modal__body">
                ...
                <div class="cc-form-grupo">
                    <label for="cc-circulo"><?php esc_html_e('Círculo', 'flavor-chat-ia'); ?></label>
                ...
                <div class="cc-form-grupo">
                    <label for="cc-titulo"><?php esc_html_e('Título', 'flavor-chat-ia'); ?></label>
                    <input type="text" name="titulo" id="cc-titulo" required
                           placeholder="<?php esc_attr_e('Ej: Necesito compañía para mi madre', 'flavor-chat-ia'); ?>">
                </div>

                <div class="cc-form-grupo">
                    <label for="cc-descripcion"><?php esc_html_e('Descripción', 'flavor-chat-ia'); ?></label>
                    <textarea name="descripcion" id="cc-descripcion" rows="3"
                              placeholder="<?php esc_attr_e('Describe qué necesitas...', 'flavor-chat-ia'); ?>"></textarea>
                </div>

                <div class="cc-form-grupo">
                    <label for="cc-tipo-ayuda"><?php esc_html_e('Tipo de ayuda', 'flavor-chat-ia'); ?></label>
                    <select name="tipo_ayuda" id="cc-tipo-ayuda">
                        <option value="acompanamiento"><?php esc_html_e('Acompañamiento', 'flavor-chat-ia'); ?></option>
                        <option value="recados"><?php esc_html_e('Recados/Compras', 'flavor-chat-ia'); ?></option>
                        <option value="transporte"><?php esc_html_e('Transporte', 'flavor-chat-ia'); ?></option>
                        <option value="cuidado"><?php esc_html_e('Cuidado directo', 'flavor-chat-ia'); ?></option>
                        <option value="apoyo_emocional"><?php esc_html_e('Apoyo emocional', 'flavor-chat-ia'); ?></option>
                        <option value="otro"><?php esc_html_e('Otro', 'flavor-chat-ia'); ?></option>
                    </select>
                </div>

                <div class="cc-form-grupo">
                    <label for="cc-urgencia"><?php esc_html_e('Urgencia', 'flavor-chat-ia'); ?></label>
                    <select name="urgencia" id="cc-urgencia">
                        <option value="baja"><?php esc_html_e('Baja - Puede esperar', 'flavor-chat-ia'); ?></option>
                        <option value="normal" selected><?php esc_html_e('Normal', 'flavor-chat-ia'); ?></option>
                        <option value="alta"><?php esc_html_e('Alta - Próximos días', 'flavor-chat-ia'); ?></option>
                        <option value="urgente"><?php esc_html_e('Urgente - Hoy/Mañana', 'flavor-chat-ia'); ?></option>
                    </select>
                </div>

                <div class="cc-form-grupo">
                    <label for="cc-fecha"><?php esc_html_e('Fecha necesaria', 'flavor-chat-ia'); ?></label>
                    <input type="datetime-local" name="fecha" id="cc-fecha">
                </div>

                <div class="cc-form-grupo">
                    <label for="cc-horas-est"><?php esc_html_e('Horas estimadas', 'flavor-chat-ia'); ?></label>
            ...
            <div class="cc-modal__footer">
                ...
                <button type="submit" class="cc-btn cc-btn--primary">
                    <?php esc_html_e('Publicar necesidad', 'flavor-chat-ia'); ?>
                </button>
            </div>
        </form>
    </div>
