...
<div class="cc-necesidades">
    <header class="cc-listado__header">
        <h2><?php esc_html_e('Necesidades de Cuidado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        <p><?php esc_html_e('Personas de tu comunidad que necesitan ayuda', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </header>
    ...
    <div class="cc-filtros" style="margin-bottom: 2rem;">
        ...
        <form class="cc-filtros__form" method="get">
            <select name="urgencia" onchange="this.form.submit()">
                <option value=""><?php esc_html_e('Todas las urgencias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                ...
                <option value="alta" <?php selected($urgencia_filtro, 'alta'); ?>>
                    <?php esc_html_e('Alta', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </option>
                ...
                <option value="baja" <?php selected($urgencia_filtro, 'baja'); ?>>
                    <?php esc_html_e('Baja', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </option>
            </select>
        </form>
    </div>
    ...
    <div class="cc-necesidades-lista">
        <?php while ($necesidades->have_posts()) : $necesidades->the_post();
            ...
            $autor_nombre = $anonimo ? __('Anónimo', FLAVOR_PLATFORM_TEXT_DOMAIN) : get_the_author();
        ?>
        <article class="cc-necesidad-card cc-necesidad-card--<?php echo esc_attr($urgencia); ?>">
            ...
            <div class="cc-necesidad-card__meta">
                ...
                <span>
                    ...
                    <?php printf(
                        esc_html__('%s horas (%s ofrecidas)', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        $horas_necesarias,
                        $horas_ofrecidas
                    ); ?>
                </span>
            ...
            <div class="cc-necesidad-card__progreso">
                ...
                <span class="cc-progreso-texto">
                    <?php printf(
                        esc_html__('%d%% cubierto', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <footer class="cc-necesidad-card__footer">
                <span class="cc-necesidad-card__ayudantes">
                    ...
                    <?php printf(
                        esc_html(_n('%d persona ayudando', '%d personas ayudando', count($ayudantes), FLAVOR_PLATFORM_TEXT_DOMAIN)),
                        count($ayudantes)
                    ); ?>
                    <?php endif; ?>
                </span>
                ...
                <a href="<?php echo esc_url(wp_login_url(flavor_current_request_url())); ?>" class="cc-btn-ayudar">
                    <span class="dashicons dashicons-heart"></span>
                    <?php esc_html_e('Inicia sesión para ayudar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
                <?php elseif ($ya_ofrecio) : ?>
                <span class="cc-badge-miembro">
                    <span class="dashicons dashicons-yes"></span>
                    <?php esc_html_e('Ya has ofrecido ayuda', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
                <?php elseif ($estado === 'cubierta') : ?>
                <span class="cc-badge-cubierta">
                    <span class="dashicons dashicons-yes-alt"></span>
                    <?php esc_html_e('Necesidad cubierta', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
                <?php elseif (get_current_user_id() == get_the_author_meta('ID')) : ?>
                <span class="cc-badge-mia">
                    <?php esc_html_e('Tu solicitud', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
                <?php elseif ($puede_ayudar) : ?>
                <button class="cc-btn-ayudar" data-necesidad="<?php echo esc_attr(get_the_ID()); ?>">
                    <span class="dashicons dashicons-heart"></span>
                    <?php esc_html_e('Quiero ayudar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </button>
                <?php else : ?>
                <span class="cc-info-unirse">
                    <?php esc_html_e('Únete al círculo para ayudar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
                <?php endif; ?>
            </footer>
        </article>
    ...
    <div class="cc-empty-state">
        ...
        <p><?php esc_html_e('¡Genial! No hay necesidades de cuidado pendientes.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </div>
    <?php endif; ?>
</div>
