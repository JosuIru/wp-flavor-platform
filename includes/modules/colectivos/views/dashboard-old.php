...
<div class="wrap dm-dashboard">
    ...
    <div class="dm-header">
        ...
        <div class="dm-header__actions">
            <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('colectivos', 'crear')); ?>" class="dm-btn dm-btn--primary">
    ...
    <div class="dm-card">
        ...
        <div class="dm-action-grid">
            ...
            <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('colectivos', 'crear')); ?>" class="dm-action-card dm-action-card--success">
            ...
            <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('colectivos', '')); ?>" class="dm-action-card" target="_blank">
