...
// Tipos disponibles
$tipos_disponibles = [
    'comunitario' => __('Comunitario', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'vecinal' => __('Vecinal', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'escolar' => __('Escolar', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'municipal' => __('Municipal', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'privado' => __('Privado', FLAVOR_PLATFORM_TEXT_DOMAIN),
];

// Fases labels
$fases_labels = [
    'recepcion' => __('Recepción', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'activo' => __('Activo', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'maduracion' => __('Maduración', FLAVOR_PLATFORM_TEXT_DOMAIN),
    'listo' => __('Compost listo', FLAVOR_PLATFORM_TEXT_DOMAIN),
...
<div class="compostaje-mapa-wrapper">
    <div class="mapa-header">
        <h2><?php esc_html_e('Puntos de Compostaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        <p><?php esc_html_e('Encuentra el punto de compostaje más cercano a ti', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </div>

    <!-- Filtros -->
    <div class="mapa-filtros">
        <div class="filtro-grupo">
            <label><?php esc_html_e('Filtrar por tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
    ...
    <div class="puntos-lista">
        <h3><?php esc_html_e('Puntos disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <span class="contador">(<?php echo count($puntos_json); ?>)</span></h3>
                ...
                <?php foreach ($puntos_json as $punto): ?>
                    <div class="punto-card" data-id="<?php echo esc_attr($punto['id']); ?>" data-tipo="<?php echo esc_attr($punto['tipo']); ?>">
                        ...
                        <div class="punto-llenado">
                            <span class="llenado-label"><?php esc_html_e('Nivel de llenado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        ...
                        <div class="punto-acciones">
                            ...
                            <?php if (is_user_logged_in()): ?>
                                <a href="<?php echo esc_url(add_query_arg(['vista' => 'registrar', 'punto_id' => $punto['id']], get_permalink())); ?>" class="btn btn-sm btn-primary">
                                    <?php esc_html_e('Aportar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <div class="puntos-empty">
                <span class="dashicons dashicons-location-alt"></span>
                <h4><?php esc_html_e('No hay puntos disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
                <p><?php esc_html_e('Aún no hay puntos de compostaje registrados en esta zona.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
