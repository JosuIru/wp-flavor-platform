...
<div class="wrap flavor-comunidades-dashboard">
    ...
    <div class="comunidades-quick-access" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px; margin: 20px 0;">
        ...
        <a href="<?php echo admin_url('admin.php?page=comunidades-configuracion'); ?>" class="comunidades-quick-link" style="display: flex; align-items: center; gap: 12px; padding: 15px 20px; background: #fff; border: 1px solid #c3c4c7; border-radius: 4px; text-decoration: none; color: #1d2327; transition: all 0.2s;">
