...
<div class="wrap">
    ...
    <nav class="flavor-breadcrumbs" style="margin-bottom: 15px; font-size: 13px;">
        ...
        <span style="color: #1d2327;"><?php _e('Publicaciones', 'flavor-chat-ia'); ?></span>
    </nav>

    <h1 class="wp-heading-inline">
        <span class="dashicons dashicons-format-chat"></span>
        <?php _e('Publicaciones de Comunidades', 'flavor-chat-ia'); ?>
    </h1>
    ...
    <div style="display: flex; gap: 15px; margin: 20px 0; flex-wrap: wrap;">
        <div style="background: #fff; padding: 15px 20px; border-left: 4px solid #2271b1; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div style="color: #646970; font-size: 13px;"><?php _e('Total publicaciones', 'flavor-chat-ia'); ?></div>
        </div>
        ...
        <div style="background: #fff; padding: 15px 20px; border-left: 4px solid #dba617; box-shadow: 0 1px 1px rgba(0,0,0,.04);">
            ...
            <div style="color: #646970; font-size: 13px;"><?php _e('Pendientes de moderación', 'flavor-chat-ia'); ?></div>
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
    ...
    <div class="tablenav top">
        <form method="get" action="">
            ...
            <div class="alignleft actions" style="display: flex; gap: 8px; flex-wrap: wrap;">
                ...
                <input type="search" name="s" value="<?php echo esc_attr($buscar); ?>" placeholder="<?php esc_attr_e('Buscar en contenido...', 'flavor-chat-ia'); ?>">

                <button type="submit" class="button"><?php _e('Filtrar', 'flavor-chat-ia'); ?></button>

                <?php if ($comunidad_filtro || $estado_filtro || $buscar): ?>
                <a href="<?php echo admin_url('admin.php?page=comunidades-publicaciones'); ?>" class="button"><?php _e('Limpiar', 'flavor-chat-ia'); ?></a>
                <?php endif; ?>
            </div>
        </form>
    ...
    <table class="wp-list-table widefat fixed striped">
        <thead>
            <tr>
                <th scope="col" style="width: 60px;"><?php _e('ID', 'flavor-chat-ia'); ?></th>
                <th scope="col"><?php _e('Contenido', 'flavor-chat-ia'); ?></th>
                <th scope="col" style="width: 180px;"><?php _e('Comunidad', 'flavor-chat-ia'); ?></th>
                <th scope="col" style="width: 150px;"><?php _e('Autor', 'flavor-chat-ia'); ?></th>
                <th scope="col" style="width: 90px;"><?php _e('Estado', 'flavor-chat-ia'); ?></th>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="6" style="text-align: center; padding: 40px;">
                    ...
                    <p style="color: #646970;"><?php _e('No se encontraron publicaciones.', 'flavor-chat-ia'); ?></p>
                </td>
            </tr>
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small style="color: #646970;">
                            ...
                            <?php _e('Con imagen', 'flavor-chat-ia'); ?>
                        </small>
                        <?php endif; ?>
                    </td>
                    <td>
                        <a href="<?php echo admin_url('admin.php?page=comunidades-editar&id=' . $pub->comunidad_id); ?>">
                            <?php echo esc_html($pub->comunidad_nombre ?: __('Comunidad eliminada', 'flavor-chat-ia')); ?>
                        </a>
                    </td>
                    <td>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <?php echo get_avatar($pub->user_id, 24); ?>
                            <span><?php echo esc_html($pub->display_name ?: __('Usuario eliminado', 'flavor-chat-ia')); ?></span>
                        </div>
                    </td>
                    <td>
