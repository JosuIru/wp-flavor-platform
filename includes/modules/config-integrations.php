...
function flavor_register_integration_config() {
    ...
    $providers = [
        ...
        'podcast' => [
            'id'         => 'podcast',
            'label'      => __('Episodios de Podcast', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        'biblioteca' => [
            'id'         => 'biblioteca',
            'label'      => __('Recursos de Biblioteca', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'icon'       => 'dashicons-book',
        ...
        'videos' => [
            'id'         => 'videos',
            'label'      => __('Videos', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        'radio' => [
            'id'         => 'radio',
            'label'      => __('Programas de Radio', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        'foros' => [
            'id'         => 'foros',
            'label'      => __('Temas de Foro', FLAVOR_PLATFORM_TEXT_DOMAIN),
