...
<div class="flavor-cf-proyecto" data-proyecto-id="<?php echo esc_attr($proyecto->id); ?>">
        ...
        <div class="flavor-cf-proyecto__info">
            ...
            <div class="flavor-cf-proyecto__creador">
                ...
                <?php if ($proyecto->verificado): ?>
                    <span class="flavor-cf-verificado" title="<?php esc_attr_e('Proyecto verificado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">✓</span>
                <?php endif; ?>
            </div>
    ...
    <div class="flavor-cf-proyecto__contenido">
        ...
        <main class="flavor-cf-proyecto__main">
            ...
            <!-- Descripción -->
            <section class="flavor-cf-seccion">
                <h2><?php esc_html_e('Sobre el proyecto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            ...
            <section class="flavor-cf-seccion">
                <h2><?php esc_html_e('Desglose del presupuesto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <div class="flavor-cf-presupuesto">
                    ...
                    <div class="flavor-cf-presupuesto__total">
                        <span><?php esc_html_e('Total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <section class="flavor-cf-seccion">
                <h2><?php esc_html_e('Distribución de los fondos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <div class="flavor-cf-distribucion">
                    <div class="flavor-cf-distribucion__item">
                        ...
                        <span class="flavor-cf-distribucion__label">
                            <?php echo $proyecto->porcentaje_creador; ?>% <?php esc_html_e('Creador', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </span>
                    </div>
                    ...
                    <div class="flavor-cf-distribucion__item">
                        ...
                        <span class="flavor-cf-distribucion__label">
                            <?php echo $proyecto->porcentaje_espacio; ?>% <?php esc_html_e('Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </span>
                    </div>
                    <?php endif; ?>
                    <div class="flavor-cf-distribucion__item">
                        ...
                        <span class="flavor-cf-distribucion__label">
                            <?php echo $proyecto->porcentaje_comunidad; ?>% <?php esc_html_e('Fondo comunitario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </span>
                    </div>
                    <div class="flavor-cf-distribucion__item">
                        ...
                        <span class="flavor-cf-distribucion__label">
                            <?php echo $proyecto->porcentaje_plataforma + $proyecto->porcentaje_emergencia; ?>% <?php esc_html_e('Infraestructura + Fondo emergencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </span>
                    </div>
                </div>
            </section>
        ...
        <aside class="flavor-cf-proyecto__sidebar">
            ...
            <div class="flavor-cf-card flavor-cf-card--progreso">
                ...
                <div class="flavor-cf-recaudado">
                    <div class="flavor-cf-recaudado__principal">
                        ...
                        <span class="flavor-cf-recaudado__objetivo">
                            <?php printf(esc_html__('de %s€', FLAVOR_PLATFORM_TEXT_DOMAIN), number_format_i18n($proyecto->objetivo_eur, 0)); ?>
                        </span>
                    </div>
                ...
                <div class="flavor-cf-stats">
                    <div class="flavor-cf-stat">
                        ...
                        <span class="flavor-cf-stat__label"><?php esc_html_e('mecenas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    ...
                    <div class="flavor-cf-stat">
                        ...
                        <span class="flavor-cf-stat__label"><?php esc_html_e('días restantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if ($proyecto->estado === 'activo' && !$proyecto->finalizado): ?>
                    <a href="#aportar" class="flavor-cf-btn flavor-cf-btn--primary flavor-cf-btn--block flavor-cf-btn--lg">
                        ...
                        <?php esc_html_e('Apoyar este proyecto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                <?php elseif ($proyecto->estado === 'exitoso'): ?>
                    <div class="flavor-cf-mensaje flavor-cf-mensaje--exito">
                        <span class="dashicons dashicons-yes-alt"></span>
                        <?php esc_html_e('¡Proyecto financiado con éxito!', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="flavor-cf-card">
                <h3><?php esc_html_e('Formas de aportar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            ...
            <div class="flavor-cf-card flavor-cf-card--tiers" id="aportar">
                <h3><?php esc_html_e('Elige tu recompensa', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>

                <?php if ($proyecto->permite_aportacion_libre): ?>
                <div class="flavor-cf-tier flavor-cf-tier--libre">
                    <div class="flavor-cf-tier__header">
                        <span class="flavor-cf-tier__nombre"><?php esc_html_e('Aportación libre', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <p class="flavor-cf-tier__descripcion"><?php esc_html_e('Aporta la cantidad que desees sin recompensa específica.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <form class="flavor-cf-form-libre">
                        ...
                        <button type="submit" class="flavor-cf-btn flavor-cf-btn--secondary"><?php esc_html_e('Aportar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
                    </form>
                </div>
                <?php endif; ?>
                ...
                <div class="flavor-cf-tier <?php echo !$tier->disponible ? 'flavor-cf-tier--agotado' : ''; ?> <?php echo $tier->destacado ? 'flavor-cf-tier--destacado' : ''; ?>">
                    <?php if ($tier->destacado): ?>
                        <span class="flavor-cf-tier__badge-destacado"><?php esc_html_e('Popular', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    <?php endif; ?>
                    ...
                    <div class="flavor-cf-tier__footer">
                        <?php if ($tier->cantidad_limitada): ?>
                            <span class="flavor-cf-tier__stock">
                                <?php
                                if ($tier->disponible) {
                                    printf(esc_html__('%d de %d disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN), $tier->restantes, $tier->cantidad_limitada);
                                } else {
                                    esc_html_e('Agotado', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                }
                                ?>
                            </span>
                        <?php endif; ?>
                        <span class="flavor-cf-tier__mecenas">
                            <?php printf(esc_html__('%d mecenas', FLAVOR_PLATFORM_TEXT_DOMAIN), $tier->cantidad_vendida); ?>
                        </span>
                    </div>
            ...
            <!-- Compartir -->
            <div class="flavor-cf-card">
                <h3><?php esc_html_e('Comparte este proyecto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
