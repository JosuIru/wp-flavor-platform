...
<div class="mis-cursos-wrapper">
    ...
    <?php if (empty($cursos)): ?>
        <div class="cursos-vacio">
            ...
            <p><?php _e('Aún no te has inscrito en ningún curso.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    ...
    <?php else: ?>
        <div class="mis-cursos-tabs" style="margin-bottom: 1.5rem;">
            <button class="tab-btn active" data-filter="todos"><?php _e('Todos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button class="tab-btn" data-filter="activa"><?php _e('En progreso', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button class="tab-btn" data-filter="completada"><?php _e('Completados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
        </div>
            ...
            <?php foreach ($cursos as $curso): ?>
                <div class="mi-curso-card" data-estado="<?php echo esc_attr($curso['estado_inscripcion']); ?>">
                    <div class="mi-curso-imagen">
                        ...
                        <div class="mi-curso-progreso-overlay">
                            ...
                            <div class="progreso-texto">
                                <?php printf(__('%d%% completado', FLAVOR_PLATFORM_TEXT_DOMAIN), $curso['progreso']); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mi-curso-contenido">
                        ...
                        <p class="mi-curso-instructor"><?php printf(__('Por %s', FLAVOR_PLATFORM_TEXT_DOMAIN), esc_html($curso['instructor'])); ?></p>
                        ...
                        <div class="mi-curso-acciones">
                            <?php if ($curso['estado_inscripcion'] === 'completada'): ?>
                                <a href="<?php echo esc_url(add_query_arg(['page' => 'aula', 'curso_id' => $curso['id']], get_permalink())); ?>" class="btn-continuar-curso">
                                    <?php _e('Revisar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </a>
