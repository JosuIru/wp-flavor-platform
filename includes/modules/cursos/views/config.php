...
<div class="wrap flavor-cursos-config">
    <h1 class="wp-heading-inline">
        ...
        <?php esc_html_e('Configuración de Cursos', 'flavor-chat-ia'); ?>
    </h1>
    ...
    <form method="post" class="dm-config-form">
        ...
        <div class="dm-config-grid">
            <div class="dm-card">
                ...
                <div class="dm-card__body">
                    <div class="dm-form-group">
                        <label for="nombre_academia"><?php esc_html_e('Nombre de la Academia', 'flavor-chat-ia'); ?></label>
            ...
            <div class="dm-card">
                <div class="dm-card__header">
                    <h3><span class="dashicons dashicons-groups"></span> <?php esc_html_e('Inscripciones', 'flavor-chat-ia'); ?></h3>
                </div>
                <div class="dm-card__body">
                    <div class="dm-checkbox-group">
                        <label class="dm-checkbox">
                            ...
                            <span><?php esc_html_e('Permitir inscripción pública', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="requiere_aprobacion" value="1" <?php checked($configuracion['requiere_aprobacion']); ?>>
                            <span><?php esc_html_e('Requerir aprobación del instructor', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="mostrar_instructores" value="1" <?php checked($configuracion['mostrar_instructores']); ?>>
                            <span><?php esc_html_e('Mostrar perfil de instructores', 'flavor-chat-ia'); ?></span>
                        </label>
                    </div>
                    <div class="dm-form-group" style="margin-top: 15px;">
                        <label for="duracion_acceso_dias"><?php esc_html_e('Duración del acceso (días)', 'flavor-chat-ia'); ?></label>
                        ...
                        <p class="description"><?php esc_html_e('0 = acceso ilimitado', 'flavor-chat-ia'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="dm-card">
                <div class="dm-card__header">
                    <h3><span class="dashicons dashicons-awards"></span> <?php esc_html_e('Certificados y Exámenes', 'flavor-chat-ia'); ?></h3>
                </div>
                <div class="dm-card__body">
                    <div class="dm-checkbox-group">
                        <label class="dm-checkbox">
                            <input type="checkbox" name="enviar_certificados" value="1" <?php checked($configuracion['enviar_certificados']); ?>>
                            <span><?php esc_html_e('Emitir certificados al completar', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="habilitar_examenes" value="1" <?php checked($configuracion['habilitar_examenes']); ?>>
                            <span><?php esc_html_e('Habilitar exámenes', 'flavor-chat-ia'); ?></span>
                        </label>
                    </div>
                    <div class="dm-form-row" style="margin-top: 15px;">
                        <div class="dm-form-group">
                            <label for="puntuacion_minima_aprobar"><?php esc_html_e('Puntuación mínima (%)', 'flavor-chat-ia'); ?></label>
                        ...
                        <div class="dm-form-group">
                            <label for="intentos_examen"><?php esc_html_e('Intentos permitidos', 'flavor-chat-ia'); ?></label>
                    ...
                    <div class="dm-form-group">
                        <label for="formato_certificado"><?php esc_html_e('Formato de Certificado', 'flavor-chat-ia'); ?></label>
            ...
            <div class="dm-card">
                <div class="dm-card__header">
                    <h3><span class="dashicons dashicons-admin-settings"></span> <?php esc_html_e('Opciones del Curso', 'flavor-chat-ia'); ?></h3>
                </div>
                <div class="dm-card__body">
                    <div class="dm-checkbox-group">
                        <label class="dm-checkbox">
                            <input type="checkbox" name="mostrar_progreso" value="1" <?php checked($configuracion['mostrar_progreso']); ?>>
                            <span><?php esc_html_e('Mostrar barra de progreso', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="permitir_comentarios" value="1" <?php checked($configuracion['permitir_comentarios']); ?>>
                            <span><?php esc_html_e('Permitir comentarios en lecciones', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="habilitar_foro_curso" value="1" <?php checked($configuracion['habilitar_foro_curso']); ?>>
                            <span><?php esc_html_e('Habilitar foro por curso', 'flavor-chat-ia'); ?></span>
                        </label>
                    </div>
                    <div class="dm-form-group" style="margin-top: 15px;">
                        <label for="video_provider"><?php esc_html_e('Proveedor de Video', 'flavor-chat-ia'); ?></label>
                ...
                <div class="dm-card__body">
                    <div class="dm-checkbox-group">
                        <label class="dm-checkbox">
                            ...
                            <span><?php esc_html_e('Notificar al inscribirse', 'flavor-chat-ia'); ?></span>
                        </label>
                        <label class="dm-checkbox">
                            <input type="checkbox" name="notificar_completado" value="1" <?php checked($configuracion['notificar_completado']); ?>>
                            <span><?php esc_html_e('Notificar al completar curso', 'flavor-chat-ia'); ?></span>
                        </label>
                    </div>
                </div>
            </div>
