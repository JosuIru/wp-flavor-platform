...
<div class="wrap">
    <h1 class="wp-heading-inline"><?php echo esc_html__('Gestión de Instructores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h1>
    ...
    <div class="flavor-stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Total Instructores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
        ...
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Cursos Creados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
        ...
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Alumnos Totales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="flavor-card">
        <div class="flavor-card-header">
            <h2><?php echo esc_html__('Listado de Instructores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        </div>
            ...
            <table class="wp-list-table widefat striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 100px;"><?php echo esc_html__('Cursos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Alumnos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Valoración', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th style="width: 120px;"><?php echo esc_html__('Ingresos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="button button-small btn-cursos-instructor" data-id="<?php echo $instructor->ID; ?>">
                                        <?php echo esc_html__('Cursos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="9" class="flavor-no-data">
                                <?php echo esc_html__('No hay instructores registrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
    ...
    <div class="flavor-dashboard-row">
        <div class="flavor-dashboard-col-6">
            <div class="flavor-card">
                <div class="flavor-card-header">
                    <h2><?php echo esc_html__('Top 5 Instructores por Valoración', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                </div>
                <div class="flavor-card-body">
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php echo esc_html__('Instructor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                <th><?php echo esc_html__('Valoración', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                <th><?php echo esc_html__('Cursos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
        ...
        <div class="flavor-dashboard-col-6">
            <div class="flavor-card">
                <div class="flavor-card-header">
                    <h2><?php echo esc_html__('Top 5 Instructores por Alumnos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                </div>
                <div class="flavor-card-body">
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php echo esc_html__('Instructor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                <th><?php echo esc_html__('Alumnos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                <th><?php echo esc_html__('Cursos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            </tr>
                        </thead>
                        <tbody>
...
<div id="modal-instructor" class="flavor-modal" style="display: none;">
    <div class="flavor-modal-content">
        <div class="flavor-modal-header">
            <h2><?php echo esc_html__('Perfil del Instructor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
