...
<div class="wrap">
    <h1 class="wp-heading-inline"><?php echo esc_html__('Gestión de Instructores', 'flavor-platform'); ?></h1>
    ...
    <div class="flavor-stats-grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Total Instructores', 'flavor-platform'); ?></div>
            </div>
        </div>
        ...
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Cursos Creados', 'flavor-platform'); ?></div>
            </div>
        </div>
        ...
        <div class="flavor-stat-card">
            ...
            <div class="flavor-stat-content">
                ...
                <div class="flavor-stat-label"><?php echo esc_html__('Alumnos Totales', 'flavor-platform'); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="flavor-card">
        <div class="flavor-card-header">
            <h2><?php echo esc_html__('Listado de Instructores', 'flavor-platform'); ?></h2>
        </div>
            ...
            <table class="wp-list-table widefat striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 100px;"><?php echo esc_html__('Cursos', 'flavor-platform'); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Activos', 'flavor-platform'); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Alumnos', 'flavor-platform'); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Valoración', 'flavor-platform'); ?></th>
                        <th style="width: 120px;"><?php echo esc_html__('Ingresos', 'flavor-platform'); ?></th>
                        <th style="width: 100px;"><?php echo esc_html__('Desde', 'flavor-platform'); ?></th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="button button-small btn-ver-instructor" data-id="<?php echo $instructor->ID; ?>">
                                        <?php echo esc_html__('Ver Perfil', 'flavor-platform'); ?>
                                    </button>
                                    <button class="button button-small btn-cursos-instructor" data-id="<?php echo $instructor->ID; ?>">
                                        <?php echo esc_html__('Cursos', 'flavor-platform'); ?>
                                    </button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="9" class="flavor-no-data">
                                <?php echo esc_html__('No hay instructores registrados', 'flavor-platform'); ?>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
    ...
    <div class="flavor-dashboard-row">
        <div class="flavor-dashboard-col-6">
            <div class="flavor-card">
                <div class="flavor-card-header">
                    <h2><?php echo esc_html__('Top 5 Instructores por Valoración', 'flavor-platform'); ?></h2>
                </div>
                <div class="flavor-card-body">
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php echo esc_html__('Instructor', 'flavor-platform'); ?></th>
                                <th><?php echo esc_html__('Valoración', 'flavor-platform'); ?></th>
                                <th><?php echo esc_html__('Cursos', 'flavor-platform'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
        ...
        <div class="flavor-dashboard-col-6">
            <div class="flavor-card">
                <div class="flavor-card-header">
                    <h2><?php echo esc_html__('Top 5 Instructores por Alumnos', 'flavor-platform'); ?></h2>
                </div>
                <div class="flavor-card-body">
                    <table class="widefat">
                        <thead>
                            <tr>
                                <th><?php echo esc_html__('Instructor', 'flavor-platform'); ?></th>
                                <th><?php echo esc_html__('Alumnos', 'flavor-platform'); ?></th>
                                <th><?php echo esc_html__('Cursos', 'flavor-platform'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
...
<div id="modal-instructor" class="flavor-modal" style="display: none;">
    <div class="flavor-modal-content">
        <div class="flavor-modal-header">
            <h2><?php echo esc_html__('Perfil del Instructor', 'flavor-platform'); ?></h2>
