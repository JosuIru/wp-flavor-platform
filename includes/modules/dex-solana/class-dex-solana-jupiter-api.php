...
class Flavor_Dex_Solana_Jupiter_API {
    ...
    public function obtener_cotizacion($mint_entrada, $mint_salida, $cantidad_base_units, $slippage_bps = 50) {
        ...
        if (is_wp_error($respuesta_http)) {
            ...
            return array(
                'success' => false,
                'error' => __('', FLAVOR_PLATFORM_TEXT_DOMAIN) . $mensaje_error,
            );
        }
        ...
        if (200 !== $codigo_respuesta) {
            ...
            return array(
                'success' => false,
                'error' => __('', FLAVOR_PLATFORM_TEXT_DOMAIN) . $codigo_respuesta,
            );
        }
        ...
        if (!is_array($datos_cotizacion)) {
            ...
            return array(
                'success' => false,
                'error' => __('', FLAVOR_PLATFORM_TEXT_DOMAIN),
            );
        }
        ...
        if (isset($datos_cotizacion['error'])) {
            ...
            return array(
                'success' => false,
                'error' => __('', FLAVOR_PLATFORM_TEXT_DOMAIN) . $datos_cotizacion['error'],
            );
        }
    ...
    public function preparar_transaccion_swap($quote_response, $wallet_publica) {
        ...
        if (isset($datos_swap['error'])) {
            ...
            return array(
                'success' => false,
                'error' => __('', FLAVOR_PLATFORM_TEXT_DOMAIN) . $datos_swap['error'],
            );
        }
