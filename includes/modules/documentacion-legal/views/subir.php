...
<div class="doc-legal-subir">
    <h2><?php _e('Subir documento', 'flavor-chat-ia'); ?></h2>
    <p class="doc-legal-intro">
        <?php _e('Comparte documentos de interes con la comunidad. Los documentos seran revisados antes de su publicacion.', 'flavor-chat-ia'); ?>
    </p>
    ...
    <form id="form-subir-documento" class="doc-legal-form" method="post" enctype="multipart/form-data">
        ...
        <div class="doc-legal-form-section">
            <h3><?php _e('Informacion del documento', 'flavor-chat-ia'); ?></h3>

            <div class="doc-legal-form-group">
                <label for="doc_titulo"><?php _e('Titulo', 'flavor-chat-ia'); ?> <span class="required">*</span></label>
                <input type="text" id="doc_titulo" name="titulo" required maxlength="200" placeholder="<?php esc_attr_e('Titulo descriptivo del documento', 'flavor-chat-ia'); ?>">
            </div>

            <div class="doc-legal-form-group">
                <label for="doc_descripcion"><?php _e('Descripcion', 'flavor-chat-ia'); ?></label>
                <textarea id="doc_descripcion" name="descripcion" rows="4" placeholder="<?php esc_attr_e('Breve descripcion del contenido y utilidad del documento', 'flavor-chat-ia'); ?>"></textarea>
            </div>

            <div class="doc-legal-form-row">
                <div class="doc-legal-form-group">
                    <label for="doc_categoria"><?php _e('Categoria', 'flavor-chat-ia'); ?> <span class="required">*</span></label>
                ...
                <div class="doc-legal-form-group">
                    <label for="doc_tags"><?php _e('Etiquetas', 'flavor-chat-ia'); ?></label>
                    <input type="text" id="doc_tags" name="tags" placeholder="<?php esc_attr_e('Separadas por comas', 'flavor-chat-ia'); ?>">
                </div>
            </div>
        </div>

        <div class="doc-legal-form-section">
            <h3><?php _e('Archivo', 'flavor-chat-ia'); ?></h3>

            <div class="doc-legal-form-group">
                <label for="doc_archivo"><?php _e('Seleccionar archivo', 'flavor-chat-ia'); ?> <span class="required">*</span></label>
                <div class="doc-legal-upload-area" id="upload-area">
                    <span class="dashicons dashicons-cloud-upload"></span>
                    <p><?php _e('Arrastra un archivo aqui o haz clic para seleccionar', 'flavor-chat-ia'); ?></p>
                    <input type="file" id="doc_archivo" name="archivo" required accept=".pdf,.doc,.docx,.odt,.txt,.rtf">
                </div>
                <small class="doc-legal-help">
                    <?php printf(
                        __('Formatos permitidos: %s. Tamano maximo: %s', 'flavor-chat-ia'),
        ...
        <div class="doc-legal-form-actions">
            <button type="submit" class="doc-legal-btn doc-legal-btn-primary">
                ...
                <?php _e('Enviar documento', 'flavor-chat-ia'); ?>
            </button>
