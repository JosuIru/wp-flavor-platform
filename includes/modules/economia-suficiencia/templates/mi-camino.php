...
<div class="es-container">
    <header class="es-header">
        <h2><?php esc_html_e('Mi Camino de Suficiencia', 'flavor-platform'); ?></h2>
        <p><?php esc_html_e('Tu progreso hacia una vida más plena con menos', 'flavor-platform'); ?></p>
    </header>
    ...
    <div class="es-nivel-card">
        ...
        <div class="es-nivel-card__puntos">
            <div class="es-nivel-card__puntos-item">
                ...
                <div class="es-nivel-card__puntos-label"><?php esc_html_e('Puntos', 'flavor-platform'); ?></div>
            </div>
        </div>
        ...
        <div class="es-progreso-nivel">
            <div class="es-progreso-nivel__header">
                <span><?php esc_html_e('Progreso al siguiente nivel', 'flavor-platform'); ?></span>
    ...
    <div class="es-stats-grid">
        <div class="es-stat-card">
            ...
            <div class="es-stat-card__label"><?php esc_html_e('Compromisos activos', 'flavor-platform'); ?></div>
        </div>
        <div class="es-stat-card">
            ...
            <div class="es-stat-card__label"><?php esc_html_e('Prácticas este mes', 'flavor-platform'); ?></div>
        </div>
        <div class="es-stat-card">
            ...
            <div class="es-stat-card__label"><?php esc_html_e('Objetos compartidos', 'flavor-platform'); ?></div>
        </div>
        <div class="es-stat-card">
            ...
            <div class="es-stat-card__label"><?php esc_html_e('Reflexiones', 'flavor-platform'); ?></div>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
        ...
        <div class="es-necesidades-radar">
            <h3><?php esc_html_e('Mi mapa de necesidades', 'flavor-platform'); ?></h3>
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('economia_suficiencia', 'compromisos')); ?>" class="es-card" style="display: flex; align-items: center; gap: 1rem; text-decoration: none; color: inherit;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; color: var(--es-text-light);">
                            <?php esc_html_e('Elige una práctica de suficiencia', 'flavor-platform'); ?>
                        </p>
                    </div>
                </a>
                ...
                <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('economia_suficiencia', 'biblioteca')); ?>" class="es-card" style="display: flex; align-items: center; gap: 1rem; text-decoration: none; color: inherit;">
                    ...
                    <div>
                        ...
                        <p style="margin: 0; font-size: 0.9rem; color: var(--es-text-light);">
                            <?php esc_html_e('Añade algo a la biblioteca comunitaria', 'flavor-platform'); ?>
                        </p>
                    </div>
                </a>
                ...
                <button class="es-card es-btn-abrir-modal" data-modal="modal-reflexion" style="display: flex; align-items: center; gap: 1rem; text-decoration: none; color: inherit; background: var(--es-bg-card); border: none; cursor: pointer; text-align: left; width: 100%;">
                    <span style="font-size: 2rem;">💭</span>
                    <div>
                        <strong><?php esc_html_e('Escribir una reflexión', 'flavor-platform'); ?></strong>
                        <p style="margin: 0; font-size: 0.9rem; color: var(--es-text-light);">
                            <?php esc_html_e('Registra tus pensamientos sobre suficiencia', 'flavor-platform'); ?>
                        </p>
                    </div>
                </button>
            </div>
...
<div id="modal-reflexion" class="es-modal">
    <div class="es-modal__contenido">
        <div class="es-modal__header">
            <h3><?php esc_html_e('Nueva reflexión', 'flavor-platform'); ?></h3>
            <button class="es-modal__cerrar">&times;</button>
        </div>
        <form class="es-modal__body es-form-reflexion">
            <div class="es-form-grupo">
                <label for="reflexion-categoria"><?php esc_html_e('Sobre qué necesidad reflexionas', 'flavor-platform'); ?></label>
            ...
            <div class="es-form-grupo">
                <label for="reflexion-respuesta"><?php esc_html_e('Tu reflexión', 'flavor-platform'); ?> *</label>
                <textarea name="respuesta" id="reflexion-respuesta" rows="5" required
                          placeholder="<?php esc_attr_e('¿Qué has descubierto sobre tus necesidades reales?', 'flavor-platform'); ?>"></textarea>
            </div>
