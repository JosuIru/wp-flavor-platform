...
class Flavor_Email_Marketing_Frontend_Controller {
    ...
    public function shortcode_listado($atts) {
        ...
        echo '<p>' . __('Módulo Email Marketing - Listado', 'flavor-chat-ia') . '</p>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function registrar_tabs($tabs) {
        $tabs['email-marketing'] = [
            'titulo' => __('Email Marketing', 'flavor-chat-ia'),
    ...
    public function render_tab_principal() {
        ...
        echo '<h3>' . esc_html__('Email Marketing', 'flavor-chat-ia') . '</h3>';
        echo '<p>' . esc_html__('Contenido del tab de Email Marketing.', 'flavor-chat-ia') . '</p>';
        echo '</div>';
    }
}
