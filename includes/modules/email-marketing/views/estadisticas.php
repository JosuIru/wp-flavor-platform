...
<div class="wrap em-estadisticas">
    <h1><?php _e('Estadísticas', 'flavor-chat-ia'); ?></h1>
        ...
        <div class="em-stats-grid">
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Suscriptores totales', 'flavor-chat-ia'); ?></span>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Emails enviados', 'flavor-chat-ia'); ?></span>
                </div>
            </div>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Tasa de apertura promedio', 'flavor-chat-ia'); ?></span>
                </div>
            </div>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Tasa de clicks promedio', 'flavor-chat-ia'); ?></span>
                </div>
            </div>
        </div>
    ...
    <?php else: ?>
        ...
        <div class="em-stats-grid">
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Enviados', 'flavor-chat-ia'); ?></span>
                </div>
            </div>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Aperturas', 'flavor-chat-ia'); ?></span>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Clicks', 'flavor-chat-ia'); ?></span>
            ...
            <div class="em-stat-card">
                ...
                <div class="em-stat-content">
                    ...
                    <span class="em-stat-label"><?php _e('Bajas', 'flavor-chat-ia'); ?></span>
        ...
        <div class="em-stats-row">
            ...
            <div class="em-stats-panel">
                ...
                <?php else: ?>
                    <p class="em-no-data"><?php _e('No hay datos de clicks aún.', 'flavor-chat-ia'); ?></p>
                <?php endif; ?>
            </div>
            ...
            <div class="em-stats-panel">
                ...
                <?php else: ?>
                    <p class="em-no-data"><?php _e('No hay datos de dispositivos aún.', 'flavor-chat-ia'); ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="em-stats-panel em-panel-full">
            <h3><?php _e('Aperturas por hora', 'flavor-chat-ia'); ?></h3>
            <?php if (!empty($datos['aperturas_por_hora'])): ?>
                <div class="em-chart-container">
                    <canvas id="em-chart-horas" height="200"></canvas>
                </div>
            <?php else: ?>
                <p class="em-no-data"><?php _e('No hay datos de aperturas aún.', 'flavor-chat-ia'); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('em-chart-horas'), {
        ...
        data: {
            ...
            datasets: [{
                label: '<?php _e('Aperturas', 'flavor-chat-ia'); ?>',
