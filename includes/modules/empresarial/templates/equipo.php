...
if (empty($miembros_equipo)) {
    $miembros_equipo = [
        [
            'nombre'   => 'Ana García',
            'puesto'   => __('Directora General', 'flavor-chat-ia'),
            'bio'      => __('Más de 15 años de experiencia en gestión empresarial.', 'flavor-chat-ia'),
            'foto'     => '',
            'linkedin' => '#',
            'twitter'  => '#',
        ],
        [
            ...
            'puesto'   => __('Director Técnico', 'flavor-chat-ia'),
            'bio'      => __('Experto en desarrollo de soluciones tecnológicas.', 'flavor-chat-ia'),
            'foto'     => '',
            'linkedin' => '#',
            'twitter'  => '#',
        ],
        [
            'nombre'   => 'María López',
            'puesto'   => __('Directora de Marketing', 'flavor-chat-ia'),
            'bio'      => __('Especialista en estrategias de marketing digital.', 'flavor-chat-ia'),
            'foto'     => '',
            'linkedin' => '#',
            'twitter'  => '#',
        ],
        [
            ...
            'puesto'   => __('Director Financiero', 'flavor-chat-ia'),
            'bio'      => __('Amplia experiencia en gestión financiera corporativa.', 'flavor-chat-ia'),
            'foto'     => '',
            'linkedin' => '#',
            'twitter'  => '#',
        ],
