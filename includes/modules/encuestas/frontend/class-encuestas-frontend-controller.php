<?php
/**
 * Frontend Controller para Encuestas
 *
...
/**
 * Controlador Frontend para el módulo de Encuestas
 */
class Flavor_Encuestas_Frontend_Controller {
    ...
    public function registrar_assets() {
        ...
        wp_register_style(
            'flavor-encuestas',
            $base_url . '/assets/css/encuestas.css',
        ...
        wp_register_script(
            'flavor-encuestas',
            $base_url . '/assets/js/encuestas.js',
            ['jquery'],
            $version,
            true
        );
    ...
    public function encolar_assets() {
        wp_enqueue_style('flavor-encuestas');
        wp_enqueue_script('flavor-encuestas');
    }
    ...
    public function registrar_shortcodes() {
        if (!shortcode_exists('encuestas_listado')) {
            add_shortcode('encuestas_listado', [$this, 'shortcode_listado']);
        }
    }
    ...
    public function shortcode_listado($atts) {
        ...
        echo '<p>' . __('Módulo Encuestas - Listado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function render_tab_principal() {
        ...
        echo '<h3>' . esc_html__('Encuestas', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</h3>';
        echo '<p>' . esc_html__('Contenido del tab de Encuestas.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
    }
}
