...
class Flavor_Energia_Comunitaria_Dashboard_Tab {
    ...
    public function render_tab_resumen() {
        ...
        echo '<a class="flavor-btn flavor-btn-primary" href="' . esc_url(home_url('/mi-portal/energia-comunitaria/')) . '">' . esc_html__('Abrir módulo', 'flavor-chat-ia') . '</a>';
        echo '<a class="flavor-btn flavor-btn-secondary" href="' . esc_url(home_url('/mi-portal/energia-comunitaria/registrar-lectura/')) . '">' . esc_html__('Registrar lectura', 'flavor-chat-ia') . '</a>';
        echo '<a class="flavor-btn flavor-btn-outline" href="' . esc_url(home_url('/mi-portal/energia-comunitaria/mantenimiento/')) . '">' . esc_html__('Ver mantenimiento', 'flavor-chat-ia') . '</a>';
        echo '</div>';
