...
class Flavor_Energia_Comunitaria_Frontend_Controller {
    ...
    public function shortcode_listado($atts) {
        ...
        echo '<p>' . __('Módulo Energía Comunitaria - Listado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function registrar_tabs($tabs) {
        $tabs['energia-comunitaria'] = [
            'titulo' => __('Energía Comunitaria', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function render_tab_principal() {
        ...
        echo '<h3>' . esc_html__('Energía Comunitaria', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</h3>';
        echo '<p>' . esc_html__('Contenido del tab de Energía Comunitaria.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
    }
}
