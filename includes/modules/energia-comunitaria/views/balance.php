...
<div class="energia-balance" x-data="energiaBalance()">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
        <div style="display: flex; gap: 8px;">
            <button class="button <?php echo $periodo === 'semana' ? 'button-primary' : ''; ?>"
                    onclick="location.href='?periodo=semana'"><?php esc_html_e('Semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button class="button <?php echo $periodo === 'mes' ? 'button-primary' : ''; ?>"
                    onclick="location.href='?periodo=mes'"><?php esc_html_e('Mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button class="button <?php echo $periodo === 'trimestre' ? 'button-primary' : ''; ?>"
                    onclick="location.href='?periodo=trimestre'"><?php esc_html_e('Trimestre', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button class="button <?php echo $periodo === 'año' ? 'button-primary' : ''; ?>"
                    onclick="location.href='?periodo=año'"><?php esc_html_e('Año', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
        </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-bottom: 24px;">
        <div style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: #fff; padding: 20px; border-radius: 12px;">
            <div style="font-size: 11px; opacity: 0.8; text-transform: uppercase;"><?php esc_html_e('Generado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #fff; padding: 20px; border-radius: 12px;">
            <div style="font-size: 11px; opacity: 0.8; text-transform: uppercase;"><?php esc_html_e('Consumido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div style="background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%); color: #fff; padding: 20px; border-radius: 12px;">
            <div style="font-size: 11px; opacity: 0.8; text-transform: uppercase;"><?php esc_html_e('Vertido a red', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div style="background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); color: #fff; padding: 20px; border-radius: 12px;">
            <div style="font-size: 11px; opacity: 0.8; text-transform: uppercase;"><?php esc_html_e('Ahorro estimado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    ...
    <div style="background: #fff; padding: 20px; border-radius: 12px; margin-bottom: 24px; border: 1px solid #e5e7eb;">
        <h3 style="margin: 0 0 16px;"><?php esc_html_e('Evolución del período', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    <div style="background: #fff; padding: 20px; border-radius: 12px; border: 1px solid #e5e7eb;">
        <h3 style="margin: 0 0 16px;"><?php esc_html_e('Registro de lecturas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        ...
        <table class="wp-list-table widefat fixed striped">
            <thead>
                <tr>
                    ...
                    <th><?php esc_html_e('Instalación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th><?php esc_html_e('Comunidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th style="text-align: right;"><?php esc_html_e('Generado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th style="text-align: right;"><?php esc_html_e('Consumido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th style="text-align: right;"><?php esc_html_e('Vertido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th><?php esc_html_e('Validada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                </tr>
            </thead>
            <tbody>
        ...
        <p style="text-align: center; color: #666; padding: 20px;">
            <?php esc_html_e('No hay lecturas registradas en este período.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </p>
        <?php endif; ?>
    </div>
    ...
    <div x-show="showModalLectura" x-cloak
        ...
        <div style="background: #fff; border-radius: 12px; padding: 24px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
            <h2 style="margin: 0 0 20px;"><?php esc_html_e('Registrar Lectura', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
    ...
    if (ctx) {
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: '<?php echo esc_js(__('Generado', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>',
                    ...
                    {
                        label: '<?php echo esc_js(__('Consumido', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>',
                    ...
                    {
                        label: '<?php echo esc_js(__('Vertido', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>',
