...
$tipos = [
    'solar_fotovoltaica' => ['label' => __('Solar Fotovoltaica', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '☀️', 'color' => '#f59e0b'],
    'solar_termica' => ['label' => __('Solar Térmica', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '🌡️', 'color' => '#ef4444'],
    'eolica' => ['label' => __('Eólica', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '💨', 'color' => '#3b82f6'],
    'biomasa' => ['label' => __('Biomasa', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '🌿', 'color' => '#10b981'],
    'hidraulica' => ['label' => __('Hidráulica', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '💧', 'color' => '#06b6d4'],
    'bateria' => ['label' => __('Batería/Almacenamiento', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '🔋', 'color' => '#8b5cf6'],
    'punto_recarga' => ['label' => __('Punto de Recarga', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '⚡', 'color' => '#ec4899'],
    'otro' => ['label' => __('Otro', FLAVOR_PLATFORM_TEXT_DOMAIN), 'icon' => '⚙️', 'color' => '#6b7280'],
];
...
<div class="energia-instalaciones" x-data="energiaInstalaciones()">
    ...
    <div style="display: flex; gap: 12px; margin-bottom: 20px; flex-wrap: wrap; align-items: center;">
        ...
        <select x-model="filtroEstado" @change="filtrar()" style="padding: 8px 12px;">
            ...
            <option value="activa"><?php esc_html_e('Activa', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
            <option value="mantenimiento"><?php esc_html_e('En mantenimiento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
            <option value="inactiva"><?php esc_html_e('Inactiva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
        </select>
        ...
        <button class="button button-primary" @click="showModalInstalacion = true">
            ...
            <?php esc_html_e('Nueva Instalación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
    </div>
        ...
        <div class="instalacion-card" style="border: 1px solid #e5e7eb; border-radius: 12px; overflow: hidden; background: #fff;">
            ...
            <div style="padding: 16px;">
                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin-bottom: 12px;">
                    <div>
                        <div style="font-size: 11px; color: #666; text-transform: uppercase;"><?php esc_html_e('Potencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                        <div style="font-size: 18px; font-weight: bold;"><?php echo number_format($inst->potencia_kw, 2); ?> kW</div>
                    </div>
                    <div>
                        <div style="font-size: 11px; color: #666; text-transform: uppercase;"><?php esc_html_e('Tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    ...
    <div style="text-align: center; padding: 60px 20px; background: #f9fafb; border-radius: 12px;">
        ...
        <h3><?php esc_html_e('No hay instalaciones registradas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <p style="color: #666;"><?php esc_html_e('Añade tu primera instalación energética para empezar a gestionar la producción.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        <button class="button button-primary button-hero" @click="showModalInstalacion = true">
            <?php esc_html_e('Añadir Instalación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
    </div>
    <?php endif; ?>
    ...
    <div x-show="showModalInstalacion" x-cloak
        ...
        <div style="background: #fff; border-radius: 12px; padding: 24px; max-width: 600px; width: 90%; max-height: 90vh; overflow-y: auto;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h2 style="margin: 0;"><?php esc_html_e('Nueva Instalación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
