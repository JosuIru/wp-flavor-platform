...
<div class="energia-participantes" x-data="energiaParticipantes()">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
        <div style="display: flex; gap: 12px; align-items: center;">
            ...
            <span style="color: #666; font-size: 13px;">
                <?php echo count($participantes); ?> <?php esc_html_e('participantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </span>
        </div>

        <button class="button button-primary" @click="showModalParticipante = true">
            <span class="dashicons dashicons-plus-alt2"></span>
            <?php esc_html_e('Añadir Participante', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
    </div>
        ...
        <table class="wp-list-table widefat fixed striped" style="margin: 0;">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;"><?php esc_html_e('Coeficiente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th style="text-align: center;"><?php esc_html_e('% Reparto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th><?php esc_html_e('Desde', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <strong><?php echo esc_html($p->display_name ?: __('Usuario', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></strong>
                        <br>
                    ...
                    <td>
                        <?php
                        $roles = [
                            'miembro' => ['label' => __('Miembro', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#6b7280'],
                            'gestor' => ['label' => __('Gestor', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#3b82f6'],
                            'administrador' => ['label' => __('Administrador', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#10b981'],
                        ];
            ...
            <tfoot>
                <tr style="background: #f9fafb;">
                    <td colspan="4" style="text-align: right; font-weight: bold;">
                        <?php esc_html_e('Total:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </td>
                    <td style="text-align: center; font-weight: bold;">
    ...
    <div style="text-align: center; padding: 60px 20px; background: #f9fafb; border-radius: 12px;">
        ...
        <h3><?php esc_html_e('No hay participantes registrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <p style="color: #666;"><?php esc_html_e('Añade participantes a las comunidades energéticas para gestionar el reparto.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        <button class="button button-primary" @click="showModalParticipante = true">
            <?php esc_html_e('Añadir Participante', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
    </div>
    ...
    <div style="margin-top: 20px; padding: 16px; background: #fef3c7; border-radius: 8px; border-left: 4px solid #f59e0b;">
        <h4 style="margin: 0 0 8px; color: #92400e;"><?php esc_html_e('Sobre los coeficientes de reparto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <p style="margin: 0; color: #78350f; font-size: 13px;">
            <?php esc_html_e('El coeficiente de reparto determina qué porcentaje de la energía generada corresponde a cada participante. Se puede basar en la inversión realizada, consumo estimado, o acuerdo entre los miembros.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </p>
    </div>
    ...
    <div x-show="showModalParticipante" x-cloak
        ...
        <div style="background: #fff; border-radius: 12px; padding: 24px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
            <h2 style="margin: 0 0 20px;"><?php esc_html_e('Añadir Participante', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
