...
class Flavor_Espacios_Dashboard_Widget extends Flavor_Dashboard_Widget_Base {
    ...
    public function __construct() {
        ...
        $this->title = __('Espacios', FLAVOR_PLATFORM_TEXT_DOMAIN);
        $this->description = __('Reserva de espacios comunitarios', FLAVOR_PLATFORM_TEXT_DOMAIN);
    ...
    private function fetch_widget_data(int $user_id): array {
        ...
        return [
            'stats' => $stats,
            'items' => $items,
            'empty_state' => __('No hay espacios disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'footer' => [
                [
    ...
    private function get_espacios_disponibles(int $limite): array {
        ...
        foreach ($espacios as $espacio) {
            $capacidad = $espacio->capacidad > 0 ? sprintf(__('%d pers.', FLAVOR_PLATFORM_TEXT_DOMAIN), $espacio->capacidad) : '';
