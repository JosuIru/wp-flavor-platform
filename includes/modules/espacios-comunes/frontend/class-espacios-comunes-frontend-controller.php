...
class Flavor_Espacios_Comunes_Frontend_Controller {
    ...
    public function registrar_assets() {
        ...
        wp_localize_script('flavor-espacios-comunes', 'flavorEspacios', [
            ...
            'i18n' => [
                ...
                'confirmar_cancelar' => __('¿Confirmas que quieres cancelar esta reserva?', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'selecciona_fecha' => __('Selecciona una fecha', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'selecciona_horario' => __('Selecciona un horario', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ],
        ]);
    }
    ...
    public function shortcode_proxima_reserva($atts) {
        ...
        if (!$proxima) {
            return '<div class="flavor-widget flavor-widget--empty">
                ...
                <p>' . esc_html__('No tienes reservas próximas', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>
            </div>';
        }
        ...
        <div class="flavor-espacios-listado">
            <?php if (empty($espacios)): ?>
                <div class="flavor-empty-state">
                    ...
                    <p><?php esc_html_e('No hay espacios disponibles.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php else: ?>
                            ...
                            <div class="flavor-card-body">
                                ...
                                <div class="espacio-info">
                                    <?php if ($espacio->capacidad): ?>
                                        <span class="info-item">
                                            ...
                                            <?php echo intval($espacio->capacidad); ?> <?php esc_html_e('personas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                        </span>
                                    <?php endif; ?>
                                ...
                                <?php if ($espacio->tarifa_hora > 0): ?>
                                    <p class="espacio-tarifa">
                                        <strong><?php echo number_format_i18n($espacio->tarifa_hora, 2); ?> €</strong>/<?php esc_html_e('hora', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                    </p>
                                <?php else: ?>
                                    <p class="espacio-tarifa gratuito"><?php esc_html_e('Gratuito', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                <?php endif; ?>
                            </div>
    ...
    public function shortcode_detalle($atts) {
        ...
        if (!$espacio) {
            return '<p class="flavor-error">' . __('Espacio no encontrado.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        <div class="flavor-espacio-detalle">
                ...
                <?php if ($espacio->capacidad): ?>
                    <div class="stat-card">
                        ...
                        <div>
                            ...
                            <span class="stat-label"><?php esc_html_e('Capacidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if ($espacio->superficie): ?>
                    <div class="stat-card">
                        ...
                        <div>
                            ...
                            <span class="stat-label"><?php esc_html_e('Superficie', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="stat-card">
                    ...
                    <div>
                        ...
                        <?php else: ?>
                            <span class="stat-value gratuito"><?php esc_html_e('Gratuito', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <?php endif; ?>
                        <span class="stat-label"><?php esc_html_e('Tarifa', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>
            ...
            <?php if (!empty($equipamiento)): ?>
                <div class="espacio-equipamiento">
                    <h2><?php esc_html_e('Equipamiento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            ...
            <?php if ($espacio->horario_apertura && $espacio->horario_cierre): ?>
                <div class="espacio-horarios">
                    <h2><?php esc_html_e('Horarios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                    <p>
            ...
            <?php if (!empty($galeria)): ?>
                <div class="espacio-galeria">
                    <h2><?php esc_html_e('Galería', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            ...
            <?php if ($espacio->normas): ?>
                <div class="espacio-normas">
                    <h3><?php esc_html_e('Normas de Uso', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            ...
            <?php if (is_user_logged_in() && $espacio->estado === 'disponible'): ?>
                <div class="espacio-cta">
                    <a href="<?php echo esc_url(home_url('/espacios/' . $espacio->slug . '/reservar')); ?>" class="flavor-btn flavor-btn-primary flavor-btn-lg">
                        <span class="dashicons dashicons-calendar-alt"></span>
                        <?php esc_html_e('Reservar este Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                </div>
            <?php elseif (!is_user_logged_in()): ?>
                <div class="espacio-cta">
                    <p><?php esc_html_e('Inicia sesión para reservar este espacio.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php endif; ?>
        </div>
        <?php
    ...
    public function shortcode_reservar($atts) {
        if (!is_user_logged_in()) {
            return '<p class="flavor-login-required">' . __('Debes iniciar sesión para reservar.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        if (!$espacio) {
            return '<p class="flavor-error">' . __('Espacio no disponible para reservas.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        <div class="flavor-espacios-reservar">
            <div class="reserva-header">
                <h2><?php esc_html_e('Reservar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <?php echo esc_html($espacio->nombre); ?></h2>
                <?php if ($espacio->tarifa_hora > 0): ?>
                    <p class="reserva-tarifa">
                        <span class="dashicons dashicons-money-alt"></span>
                        <?php echo number_format_i18n($espacio->tarifa_hora, 2); ?> €/<?php esc_html_e('hora', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </p>
                <?php endif; ?>
            </div>
            ...
            <form id="form-reservar-espacio" class="flavor-form">
                ...
                <div class="flavor-form-row">
                    <div class="flavor-form-group flavor-form-col-6">
                        <label for="fecha"><?php esc_html_e('Fecha', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                ...
                <div class="flavor-form-row">
                    <div class="flavor-form-group flavor-form-col-6">
                        <label for="hora_inicio"><?php esc_html_e('Hora inicio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                ...
                <div class="flavor-form-group">
                    <label for="asistentes"><?php esc_html_e('Número de asistentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <input type="number" name="asistentes" id="asistentes" min="1" max="<?php echo intval($espacio->capacidad ?? 100); ?>">
                    <?php if ($espacio->capacidad): ?>
                        <p class="flavor-form-help"><?php printf(esc_html__('Capacidad máxima: %d personas', FLAVOR_PLATFORM_TEXT_DOMAIN), intval($espacio->capacidad)); ?></p>
                    <?php endif; ?>
                </div>

                <div class="flavor-form-group">
                    <label for="notas"><?php esc_html_e('Notas adicionales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <textarea name="notas" id="notas" rows="2"></textarea>
                </div>

                <?php if ($espacio->tarifa_hora > 0): ?>
                    <div class="reserva-resumen" id="resumen-reserva" style="display:none;">
                        <h4><?php esc_html_e('Resumen', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
                        <p><?php esc_html_e('Duración:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <span id="duracion-horas">-</span> <?php esc_html_e('horas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <p><?php esc_html_e('Total estimado:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <strong><span id="total-importe">-</span> €</strong></p>
                    </div>
                <?php endif; ?>
            ...
            <div id="disponibilidad-horaria" class="disponibilidad-panel" style="display:none;">
                <h4><?php esc_html_e('Horarios ocupados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    public function shortcode_mis_reservas($atts) {
        ...
        <div class="flavor-espacios-mis-reservas">
            ...
            <?php if (empty($reservas)): ?>
                <div class="flavor-empty-state">
                    <span class="dashicons dashicons-calendar-alt"></span>
                    <p><?php esc_html_e('No tienes reservas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <a href="<?php echo esc_url(home_url('/espacios/')); ?>" class="flavor-btn flavor-btn-primary">
                        <?php esc_html_e('Ver Espacios Disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                </div>
            <?php else: ?>
                <div class="reservas-lista">
                    ...
                    <?php if (!empty($reservas_pasadas)): ?>
                        <h3><?php esc_html_e('Historial', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                        <div class="flavor-table-responsive">
                            <table class="flavor-table">
                                <thead>
                                    <tr>
                                        <th><?php esc_html_e('Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
        ...
        <div class="flavor-espacios-calendario">
            <div class="calendario-filtros">
                <select id="filtro-espacio-calendario">
                    <option value=""><?php esc_html_e('Todos los espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <?php foreach ($espacios as $espacio): ?>
            ...
            <div id="calendario-espacios" class="calendario-container" data-espacio="<?php echo intval($atts['espacio_id']); ?>">
                ...
                <p class="cargando"><?php esc_html_e('Cargando calendario...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>

            <div class="calendario-leyenda">
                <span class="leyenda-item disponible"><span class="dot"></span> <?php esc_html_e('Disponible', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                <span class="leyenda-item ocupado"><span class="dot"></span> <?php esc_html_e('Ocupado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                <span class="leyenda-item mi-reserva"><span class="dot"></span> <?php esc_html_e('Mi reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <?php
        return ob_get_clean();
    ...
    public function ajax_reservar() {
        ...
        if (strtotime($fecha) < strtotime('today')) {
            wp_send_json_error(__('No puedes reservar en fechas pasadas', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
        ...
        if (!$espacio) {
            wp_send_json_error(__('Espacio no disponible', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
        ...
        if ($resultado) {
            ...
            $mensaje = $espacio->requiere_aprobacion
                ? __('Reserva enviada. Recibirás confirmación pronto.', FLAVOR_PLATFORM_TEXT_DOMAIN)
    ...
    public function ajax_cancelar_reserva() {
        ...
        if (!$reserva_id) {
            wp_send_json_error(__('Reserva no válida', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
        ...
        if (!$reserva) {
            wp_send_json_error(__('Reserva no encontrada', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }

        if ($reserva->estado === 'cancelada') {
            wp_send_json_error(__('Esta reserva ya está cancelada', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
        ...
        if (strtotime($fecha_reserva) < time()) {
            wp_send_json_error(__('No puedes cancelar una reserva pasada', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
        ...
        if ($resultado !== false) {
            ...
            wp_send_json_error(__('Error al cancelar la reserva', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
    }
