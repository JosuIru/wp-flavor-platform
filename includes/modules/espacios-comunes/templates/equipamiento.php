...
<div class="espacios-wrapper">
    <div class="espacios-header">
        <h2 class="espacios-titulo"><?php _e('Equipamiento Disponible', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
    ...
    <p style="color: #6b7280; margin-bottom: 1.5rem;">
        <?php _e('Consulta el equipamiento disponible en cada espacio para planificar mejor tu reserva.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </p>

    <!-- Filtro rápido por tipo de equipamiento -->
    <div style="margin-bottom: 2rem;">
        <label style="font-weight: 500; display: block; margin-bottom: 0.5rem;"><?php _e('Buscar espacios con:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                ...
                <div class="reserva-card">
                        ...
                        <div class="reserva-card-info">
                            ...
                            <div style="margin-top: 0.5rem; display: flex; gap: 1rem; font-size: 0.875rem; color: #6b7280;">
                                <span>
                                    ...
                                    <?php printf(__('Hasta %d personas', FLAVOR_PLATFORM_TEXT_DOMAIN), $espacio->capacidad_personas); ?>
                                </span>
                                <span>
                    ...
                    <?php if ($equipamiento): ?>
                        <div style="margin-top: 1rem;">
                            <label style="font-size: 0.75rem; color: #6b7280; text-transform: uppercase; display: block; margin-bottom: 0.5rem;">
                                <?php _e('Equipamiento disponible', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </label>
                    ...
                    <?php else: ?>
                        <p style="color: #9ca3af; font-style: italic; margin-top: 1rem;">
                            <?php _e('No hay equipamiento registrado para este espacio.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </p>
                    <?php endif; ?>
    ...
    <?php else: ?>
        <div class="espacios-empty">
            ...
            <h3><?php _e('No se encontraron espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <?php if ($filtro_equipamiento): ?>
                <p><?php printf(__('No hay espacios con "%s" disponible.', FLAVOR_PLATFORM_TEXT_DOMAIN), esc_html($filtro_equipamiento)); ?></p>
                <a href="<?php echo remove_query_arg('equipo'); ?>" class="btn btn-primary">
                    <?php _e('Ver todos los espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
            <?php else: ?>
                <p><?php _e('No hay espacios disponibles en este momento.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php if (!$filtro_equipamiento && $tipos_equipamiento): ?>
        <div style="margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #e5e7eb;">
            <h3 style="margin-bottom: 1rem;"><?php _e('Resumen de equipamiento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                       ...
                       style="display: flex; align-items: center; gap: 0.75rem; padding: 1rem; background: #f9fafb; border-radius: 8px; text-decoration: none; color: inherit; transition: all 0.2s;">
                        ...
                        <div style="flex: 1;">
                            ...
                            <span style="font-size: 0.875rem; color: #6b7280;">
                                <?php printf(_n('%d espacio', '%d espacios', $count, FLAVOR_PLATFORM_TEXT_DOMAIN), $count); ?>
                            </span>
                        </div>
