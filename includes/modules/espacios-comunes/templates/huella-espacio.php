...
<div class="ec-huella">
    <div class="ec-huella__header">
        ...
        <div>
            <h3 class="ec-huella__titulo"><?php esc_html_e('Huella de Uso', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    <div class="ec-huella__resumen">
        ...
        <div class="ec-huella__coste">
            <span class="ec-huella__coste-label"><?php esc_html_e('Coste estimado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
    ...
    <?php if (!empty($consumos)): ?>
        <div class="ec-huella__desglose">
            <h4><?php esc_html_e('Desglose por tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    <?php else: ?>
        <div class="ec-huella__sin-datos">
            ...
            <p><?php esc_html_e('No hay datos de consumo registrados para este período.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    <?php endif; ?>

    <div class="ec-huella__consejos">
        <h4><span class="dashicons dashicons-lightbulb"></span> <?php esc_html_e('Consejos de ahorro', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <ul>
            <?php if ($tendencia === 'subiendo'): ?>
                <li><?php esc_html_e('Apaga luces y equipos al terminar de usar el espacio.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
                <li><?php esc_html_e('Ajusta la climatización a temperaturas moderadas (20-22°C).', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
            <?php endif; ?>
            <li><?php esc_html_e('Aprovecha la luz natural siempre que sea posible.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
            <li><?php esc_html_e('Reporta fugas de agua o equipos defectuosos.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
        </ul>
    </div>
</div>
