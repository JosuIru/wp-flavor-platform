...
<div class="dm-dashboard">
    ...
    <div class="dm-header">
        <div class="dm-header__title">
            ...
            <div>
                <h1><?php esc_html_e('Dashboard de Espacios Comunes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h1>
                <p><?php esc_html_e('Gestión y reservas de espacios compartidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        </div>
        <div class="dm-header__actions">
            <a href="<?php echo esc_url(admin_url('admin.php?page=espacios-nuevo')); ?>" class="dm-btn dm-btn--primary">
                <span class="dashicons dashicons-plus-alt2"></span>
                <?php esc_html_e('Nuevo Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
        </div>
    </div>
    ...
    <div class="dm-alert dm-alert--info">
        ...
        <?php esc_html_e('Faltan tablas del módulo Espacios Comunes o aún no hay reservas registradas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="dm-quick-links">
        ...
        <div class="dm-quick-links__grid">
            <a href="<?php echo esc_url(admin_url('admin.php?page=espacios-listado')); ?>" class="dm-quick-links__item dm-quick-links__item--primary">
                ...
                <?php esc_html_e('Espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
            ...
            <a href="<?php echo esc_url(admin_url('admin.php?page=espacios-normas')); ?>" class="dm-quick-links__item dm-quick-links__item--warning">
                ...
                <?php esc_html_e('Normas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
    ...
    <div class="dm-stats-grid dm-stats-grid--4">
        <div class="dm-stat-card dm-stat-card--primary">
            ...
            <div class="dm-stat-card__content">
                ...
                <div class="dm-stat-card__label"><?php esc_html_e('Total Espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                <div class="dm-stat-card__meta"><?php esc_html_e('disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
        ...
        <div class="dm-stat-card dm-stat-card--success">
            ...
            <div class="dm-stat-card__content">
                ...
                <div class="dm-stat-card__meta"><?php esc_html_e('en curso o próximas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
        ...
        <div class="dm-stat-card dm-stat-card--highlight">
            ...
            <div class="dm-stat-card__content">
                ...
                <div class="dm-stat-card__meta"><?php esc_html_e('promedio mensual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="dm-grid dm-grid--2">
        ...
        <div class="dm-card">
            <div class="dm-card__header">
                <h3><?php esc_html_e('Espacios Más Populares', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            ...
            <ol class="dm-ranking">
                ...
                <li>
                    ...
                    <strong><?php echo esc_html(number_format_i18n($espacio->total_reservas)); ?> <?php esc_html_e('reservas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                </li>
                <?php endforeach; ?>
            </ol>
            <?php else : ?>
            <div class="dm-empty">
                <span class="dashicons dashicons-building"></span>
                <p><?php esc_html_e('No hay datos de uso disponibles.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="dm-card">
            ...
            <div class="dm-empty">
                <span class="dashicons dashicons-calendar"></span>
                <p><?php esc_html_e('No hay reservas próximas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3><?php esc_html_e('Estado Actual de Espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        ...
        <div class="dm-spaces-grid">
            ...
            <div class="dm-space-status dm-space-status--<?php echo $disponible ? 'available' : 'occupied'; ?>">
                ...
                <span class="dm-badge dm-badge--<?php echo $disponible ? 'success' : 'error'; ?>">
                    <?php echo $disponible ? esc_html__('Disponible', FLAVOR_PLATFORM_TEXT_DOMAIN) : esc_html__('Ocupado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="dm-empty">
            <span class="dashicons dashicons-building"></span>
            <p><?php esc_html_e('No hay espacios registrados.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="dm-grid dm-grid--2">
        <div class="dm-card dm-card--chart">
            <div class="dm-card__header">
                <h3><?php esc_html_e('Uso por Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
        ...
        <div class="dm-card dm-card--chart">
            <div class="dm-card__header">
                <h3><?php esc_html_e('Reservas por Día de la Semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            <div class="dm-card__chart">
...
jQuery(document).ready(function($) {
    ...
    var diasSemana = ['<?php echo esc_js(__('Lun', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Mar', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Mié', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Jue', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Vie', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Sáb', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', '<?php echo esc_js(__('Dom', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>'];
