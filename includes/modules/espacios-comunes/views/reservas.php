...
<div class="wrap flavor-reservas-management">
    <h1 class="wp-heading-inline">
        <?php _e('Gestión de Reservas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </h1>
    <button type="button" class="page-title-action" id="btn-nueva-reserva">
        <?php _e('Nueva Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </button>
    ...
    <div class="flavor-view-switcher">
        <button class="flavor-view-btn active" data-view="calendario">
            ...
            <?php _e('Calendario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </button>
        ...
        <div class="flavor-calendar-controls">
            ...
            <div class="flavor-calendar-filters">
                <select id="filtro-espacio-calendario" class="flavor-select">
                    <option value=""><?php _e('Todos los espacios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                </select>
                <button id="btn-hoy" class="button"><?php _e('Hoy', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            </div>
        </div>
    ...
    <div id="vista-lista" class="flavor-view-content" style="display: none;">
        ...
        <div class="flavor-filters-bar">
            <div class="flavor-filter-group">
                ...
                <input type="text" id="search-reservas" class="flavor-search-input" placeholder="<?php _e('Usuario, espacio...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            </div>
            <div class="flavor-filter-group">
                <label><?php _e('Espacio:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
            ...
            <div class="flavor-filter-group">
                ...
                <select id="filtro-estado-reserva" class="flavor-select">
                    ...
                    <option value="<?php echo esc_attr__('confirmada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Confirmada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
            ...
            <div class="flavor-filter-group">
                ...
                <select id="filtro-periodo" class="flavor-select">
                    <option value="<?php echo esc_attr__('proximas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Próximas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="<?php echo esc_attr__('hoy', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Hoy', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="<?php echo esc_attr__('semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Esta semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="<?php echo esc_attr__('mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Este mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    <option value="<?php echo esc_attr__('todas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"><?php _e('Todas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                </select>
            </div>
        </div>
            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th><?php _e('Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                ...
                <tbody id="reservas-list">
                    <tr>
                        <td colspan="8" class="flavor-loading"><?php _e('Cargando reservas...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<div id="modal-reserva" class="flavor-modal" style="display: none;">
    ...
    <div class="flavor-modal-content">
        <div class="flavor-modal-header">
            <h2 id="modal-reserva-title"><?php _e('Nueva Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        ...
        <div class="flavor-modal-body">
            <form id="form-reserva">
                ...
                <div class="flavor-form-group">
                    <label for="reserva-espacio"><?php _e('Espacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                    <select id="reserva-espacio" name="espacio_id" required class="widefat">
                        <option value=""><?php _e('Seleccionar espacio...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    </select>
                </div>

                <div class="flavor-form-group">
                    <label for="reserva-usuario"><?php _e('Usuario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                    <select id="reserva-usuario" name="usuario_id" required class="widefat">
                        <option value=""><?php _e('Seleccionar usuario...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    </select>
                </div>

                <div class="flavor-form-row">
                    <div class="flavor-form-group">
                        <label for="reserva-fecha"><?php _e('Fecha', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                ...
                <div class="flavor-form-row">
                    <div class="flavor-form-group">
                        <label for="reserva-hora-inicio"><?php _e('Hora inicio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                        <input type="time" id="reserva-hora-inicio" name="hora_inicio" required class="widefat">
                    </div>

                    <div class="flavor-form-group">
                        <label for="reserva-hora-fin"><?php _e('Hora fin', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> *</label>
                        <input type="time" id="reserva-hora-fin" name="hora_fin" required class="widefat">
                    </div>
                </div>

                <div class="flavor-form-group">
                    <label for="reserva-proposito"><?php _e('Propósito', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <textarea id="reserva-proposito" name="proposito" rows="3" class="widefat" placeholder="<?php _e('Describe el propósito de la reserva...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></textarea>
                </div>

                <div class="flavor-form-group">
                    <label for="reserva-asistentes"><?php _e('Número de asistentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <input type="number" id="reserva-asistentes" name="num_asistentes" min="1" class="widefat">
                </div>

                <div class="flavor-form-group">
                    <label for="reserva-estado"><?php _e('Estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                ...
                <div class="flavor-form-group">
                    <label for="reserva-notas"><?php _e('Notas internas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <textarea id="reserva-notas" name="notas_admin" rows="3" class="widefat"></textarea>
                </div>
            </form>
        </div>
        <div class="flavor-modal-footer">
            <button type="button" class="button" id="btn-cancelar-reserva"><?php _e('Cancelar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button type="button" class="button button-primary" id="btn-guardar-reserva"><?php _e('Guardar Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
        </div>
    </div>
</div>
...
<div id="modal-detalle-reserva" class="flavor-modal" style="display: none;">
    ...
    <div class="flavor-modal-content">
        <div class="flavor-modal-header">
            <h2><?php _e('Detalles de la Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <button type="button" class="flavor-modal-close">
                <span class="dashicons dashicons-no"></span>
            </button>
        </div>
        ...
        <div class="flavor-modal-footer">
            <button type="button" class="button" id="btn-cerrar-detalle"><?php _e('Cerrar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
            <button type="button" class="button" id="btn-editar-desde-detalle"><?php _e('Editar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
        </div>
    </div>
</div>
...
jQuery(document).ready(function($) {
    ...
    $('#btn-nueva-reserva').on('click', function() {
        ...
        $('#reserva-id').val('');
        $('#modal-reserva-title').text('<?php _e('Nueva Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    renderizarCalendario();
                    cargarReservasLista();
                    alert('<?php _e('Reserva guardada correctamente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');
                }
            }
        });
    });
    ...
    function renderizarReservasLista(reservas) {
        if (reservas.length === 0) {
            $('#reservas-list').html('<tr><td colspan="8" style="text-align: center;"><?php _e('No se encontraron reservas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></td></tr>');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    $('#modal-reserva-title').text('<?php _e('Editar Reserva', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');
                    $('#modal-reserva').fadeIn();
                }
            }
        });
    ...
    $(document).on('click', '.btn-eliminar-reserva', function() {
        if (!confirm('<?php _e('¿Estás seguro de eliminar esta reserva?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>')) return;
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    renderizarCalendario();
                    cargarReservasLista();
                    alert('<?php _e('Reserva eliminada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>');
                }
            }
        });
    });
