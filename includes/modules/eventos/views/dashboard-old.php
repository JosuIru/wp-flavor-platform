...
$proximos_eventos = $wpdb->get_results($wpdb->prepare(
    "SELECT id, titulo, fecha_inicio, aforo_maximo, inscritos_count, ubicacion_nombre, estado
     FROM {$tabla_eventos}
     WHERE estado = 'publicado' AND fecha_inicio >= %s
...
<div class="wrap dm-dashboard">
    ...
    <div class="dm-header">
        ...
        <div class="dm-header__actions">
            <a href="<?php echo esc_url(admin_url('admin.php?page=eventos-dashboard&action=nuevo')); ?>" class="dm-btn dm-btn--primary">
    ...
    <div class="dm-card">
        ...
        <div class="dm-action-grid">
            ...
            <a href="<?php echo esc_url(Flavor_Chat_Helpers::get_action_url('eventos', '')); ?>" class="dm-action-card dm-action-card--purple">
