...
class Flavor_GC_Export {
    ...
    public function exportar_pedidos_filtrado() {
        if (!current_user_can('manage_options')) {
            wp_die(__('No autorizado', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
    ...
    public function exportar_consolidado() {
        ...
        if (!$ciclo_id) {
            wp_die(__('Ciclo no especificado', FLAVOR_PLATFORM_TEXT_DOMAIN));
        }
    ...
    private function generar_html_consolidado($datos) {
        ...
        <body>
            <div class="header">
                ...
                <p class="meta">
                    <strong><?php echo esc_html__('Consolidado de Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong><br>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="text-right"><?php echo esc_html__('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th><?php echo esc_html__('Unidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="text-right"><?php echo esc_html__('Precio Unit.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="text-right"><?php echo esc_html__('Total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <table>
                <tr class="grand-total">
                    <td colspan="4"><strong><?php echo esc_html__('TOTAL GENERAL', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong></td>
