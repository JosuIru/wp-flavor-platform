...
<div class="flavor-gc-carrito-completo" data-usuario="<?php echo esc_attr($usuario_id); ?>">
    ...
    <?php if (!is_user_logged_in()): ?>
        ...
        <div class="flavor-gc-carrito-mensaje flavor-gc-carrito-login">
            ...
            <p><?php _e('Necesitas iniciar sesion para ver y gestionar tu pedido.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    ...
    <?php elseif (empty($items_lista)): ?>
        ...
        <div class="flavor-gc-carrito-mensaje flavor-gc-carrito-vacio-estado">
            ...
            <h2><?php _e('Tu pedido esta vacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <p><?php _e('Todavia no has anadido ningun producto a tu pedido. Explora nuestro catalogo para empezar.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <a href="<?php echo esc_url($url_catalogo); ?>" class="flavor-gc-btn flavor-gc-btn-primary flavor-gc-btn-lg">
                <span class="dashicons dashicons-carrot"></span>
                <?php _e('Ver catalogo de productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
        </div>
    ...
    <?php else: ?>
        ...
        <header class="flavor-gc-carrito-header">
            <div class="flavor-gc-carrito-titulo">
                <h1>
                    <span class="dashicons dashicons-cart"></span>
                    <?php _e('Mi Pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </h1>
                <span class="flavor-gc-items-count">
                    <?php printf(
                        _n('%d producto', '%d productos', count($items_lista), FLAVOR_PLATFORM_TEXT_DOMAIN),
                        count($items_lista)
                    ); ?>
                </span>
            </div>
            ...
            <?php if ($ciclo_actual): ?>
                <div class="flavor-gc-carrito-ciclo-banner">
                    <div class="flavor-gc-ciclo-estado <?php echo $ciclo_actual['estado'] === 'abierto' ? 'abierto' : 'cerrado'; ?>">
                        ...
                        <?php else: ?>
                            <span class="dashicons dashicons-lock"></span>
                            <?php _e('Ciclo cerrado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        <?php endif; ?>
                    </div>
                    <div class="flavor-gc-ciclo-detalles">
                        <div class="flavor-gc-ciclo-detalle">
                            ...
                            <div>
                                <span class="flavor-gc-label"><?php _e('Ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        ...
                        <div class="flavor-gc-ciclo-detalle">
                            ...
                            <div>
                                <span class="flavor-gc-label"><?php _e('Cierre de pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        ...
                        <div class="flavor-gc-ciclo-detalle">
                            ...
                            <div>
                                <span class="flavor-gc-label"><?php _e('Entrega', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                <strong>
            ...
            <?php else: ?>
                <div class="flavor-gc-alerta flavor-gc-alerta-warning">
                    ...
                    <div>
                        <strong><?php _e('No hay ciclo de pedidos activo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                        <p><?php _e('Tu lista se conserva, pero no podras confirmar el pedido hasta que se abra un nuevo ciclo.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    </div>
                </div>
            <?php endif; ?>
        </header>
        ...
        <div class="flavor-gc-carrito-contenido">
            ...
            <div class="flavor-gc-carrito-tabla-wrapper">
                <table class="flavor-gc-carrito-tabla">
                    <thead>
                        <tr>
                            <th class="flavor-gc-col-producto"><?php _e('Producto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="flavor-gc-col-productor"><?php _e('Productor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="flavor-gc-col-precio"><?php _e('Precio/ud', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="flavor-gc-col-cantidad"><?php _e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            <th class="flavor-gc-col-subtotal"><?php _e('Subtotal', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    ...
                    <tbody id="gc-carrito-items">
                        <?php foreach ($items_lista as $item): ?>
                            ...
                            <tr class="flavor-gc-carrito-fila"
                                    ...
                                    <div class="flavor-gc-producto-info">
                                        ...
                                        <div class="flavor-gc-producto-texto">
                                            ...
                                            <?php if (!empty($item['es_ecologico'])): ?>
                                                <span class="flavor-gc-badge-eco-mini"><?php echo esc_html__('ECO', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>

                                <td class="flavor-gc-col-productor" data-label="<?php esc_attr_e('Productor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                ...
                                <td class="flavor-gc-col-precio" data-label="<?php esc_attr_e('Precio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                ...
                                <td class="flavor-gc-col-cantidad" data-label="<?php esc_attr_e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                    <div class="flavor-gc-cantidad-control">
                                        ...
                                        <input type="number"
                                               ...
                                               step="1"
                                               aria-label="<?php esc_attr_e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                        <button type="button"
                                ...
                                <td class="flavor-gc-col-subtotal" data-label="<?php esc_attr_e('Subtotal', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                                    <span class="flavor-gc-subtotal-valor"><?php echo number_format($subtotal_item, 2, ',', '.'); ?></span>
                                    <span class="flavor-gc-subtotal-moneda"><?php echo esc_html__('EUR', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                </td>
                                ...
                                <td class="flavor-gc-col-acciones">
                                    <button type="button"
                                            ...
                                            title="<?php esc_attr_e('Eliminar producto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            ...
            <aside class="flavor-gc-carrito-resumen">
                <div class="flavor-gc-resumen-card">
                    <h3><?php _e('Resumen del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>

                    <div class="flavor-gc-resumen-lineas">
                        <div class="flavor-gc-resumen-linea">
                            <span><?php _e('Subtotal productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        ...
                        <?php if ($porcentaje_gestion > 0): ?>
                            <div class="flavor-gc-resumen-linea flavor-gc-linea-gestion">
                                <span>
                                    <?php printf(__('Gastos de gestion (%s%%)', FLAVOR_PLATFORM_TEXT_DOMAIN), number_format($porcentaje_gestion, 1)); ?>
                                    <button type="button" class="flavor-gc-info-btn" id="gc-info-gestion" aria-label="<?php esc_attr_e('Info gastos gestion', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                            ...
                            <div class="flavor-gc-info-gestion-detalle" id="gc-gestion-detalle" style="display:none;">
                                <p><?php _e('Este porcentaje cubre los gastos operativos del grupo: coordinacion, local de reparto, materiales, etc.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                            </div>
                        <?php endif; ?>

                        <div class="flavor-gc-resumen-linea flavor-gc-linea-total">
                            <strong><?php _e('Total del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                    ...
                    <?php if ($ciclo_actual && $ciclo_actual['estado'] === 'abierto'): ?>
                        <div class="flavor-gc-resumen-acciones">
                            <button type="button"
                                ...
                                <span class="flavor-gc-btn-texto"><?php _e('Confirmar pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                            ...
                            <p class="flavor-gc-resumen-nota">
                                <?php _e('Al confirmar, tu pedido sera procesado para la proxima entrega.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </p>
                        </div>
                    <?php else: ?>
                        <div class="flavor-gc-resumen-bloqueado">
                            <span class="dashicons dashicons-lock"></span>
                            <p><?php _e('Espera a que se abra un nuevo ciclo para confirmar tu pedido.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="flavor-gc-acciones-secundarias">
                    <a href="<?php echo esc_url($url_catalogo); ?>" class="flavor-gc-btn flavor-gc-btn-secondary flavor-gc-btn-block">
                        ...
                        <?php _e('Seguir comprando', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                    <button type="button" class="flavor-gc-btn flavor-gc-btn-text flavor-gc-btn-block" id="gc-vaciar-pedido">
                        <span class="dashicons dashicons-trash"></span>
                        <?php _e('Vaciar pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </button>
                </div>
            </aside>
        </div>
        ...
        <?php if (!empty($notas_ciclo)): ?>
            <div class="flavor-gc-carrito-notas">
                <h4>
                    ...
                    <?php _e('Notas del ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </h4>
...
<div class="flavor-gc-modal" id="gc-modal-confirmar" style="display:none;">
    ...
    <div class="flavor-gc-modal-contenido">
        <button type="button" class="flavor-gc-modal-cerrar" aria-label="<?php esc_attr_e('Cerrar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            <span class="dashicons dashicons-no-alt"></span>
        </button>
        <div class="flavor-gc-modal-header">
            <span class="dashicons dashicons-yes-alt"></span>
            <h3><?php _e('Confirmar pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        </div>
        <div class="flavor-gc-modal-body">
            <p><?php _e('Estas a punto de confirmar tu pedido. Una vez confirmado:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <ul>
                <li><?php _e('Recibiras un email de confirmacion', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
                <li><?php _e('Tu pedido se agregara al consolidado del ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
                <li><?php _e('Podras recogerlo en la fecha y lugar indicados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></li>
            </ul>
            <div class="flavor-gc-modal-resumen">
                <span><?php _e('Total a pagar:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        ...
        <div class="flavor-gc-modal-footer">
            ...
            <button type="button" class="flavor-gc-btn flavor-gc-btn-primary" id="gc-modal-confirmar-btn">
                <span class="flavor-gc-btn-texto"><?php _e('Si, confirmar pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                <span class="flavor-gc-btn-loading" style="display:none;">
                    <span class="dashicons dashicons-update-alt flavor-spin"></span>
                </span>
            </button>
...
<div class="flavor-gc-modal flavor-gc-modal-exito" id="gc-modal-exito" style="display:none;">
    ...
    <div class="flavor-gc-modal-contenido">
        <div class="flavor-gc-modal-header flavor-gc-exito">
            ...
            <h3><?php _e('Pedido confirmado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        </div>
        <div class="flavor-gc-modal-body">
            <p><?php _e('Tu pedido ha sido confirmado correctamente.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <p class="flavor-gc-modal-info">
                <?php _e('Hemos enviado un email con los detalles del pedido. Podras consultarlo en cualquier momento desde tu cuenta.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </p>
        </div>
        <div class="flavor-gc-modal-footer">
            <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('grupos-consumo', 'mis-pedidos')); ?>" class="flavor-gc-btn flavor-gc-btn-primary">
                <?php _e('Ver mis pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
        </div>
    </div>
</div>
