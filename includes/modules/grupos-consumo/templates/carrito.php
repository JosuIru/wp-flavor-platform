...
<div class="gc-carrito-wrapper" data-usuario="<?php echo esc_attr($usuario_id); ?>">
    ...
    <?php if (!is_user_logged_in()): ?>
        <div class="gc-carrito-login-requerido">
            ...
            <p><?php _e('Inicia sesión para ver tu lista de compra.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    ...
    <?php elseif (empty($items_lista)): ?>
        <div class="gc-carrito-vacio">
            ...
            <p><?php _e('Añade productos desde el catálogo para empezar tu pedido.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    ...
    <?php else: ?>
        ...
        <?php if ($ciclo_actual): ?>
            <div class="gc-carrito-ciclo-info">
                ...
                <div class="gc-carrito-ciclo-texto">
                    ...
                    <span><?php printf(__('Cierre: %s', FLAVOR_PLATFORM_TEXT_DOMAIN), esc_html($ciclo_actual['fecha_cierre'])); ?></span>
                </div>
            </div>
        <?php endif; ?>
        ...
        <div class="gc-carrito-lista">
            <table class="gc-carrito-tabla">
                <thead>
                    <tr>
                        <th class="gc-col-producto"><?php _e('Producto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="gc-col-precio"><?php _e('Precio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="gc-col-cantidad"><?php _e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="gc-col-subtotal"><?php _e('Subtotal', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    ...
                    <?php foreach ($items_lista as $item): ?>
                        <tr class="gc-carrito-item" data-id="<?php echo esc_attr($item['id']); ?>">
                            ...
                            <td class="gc-col-acciones">
                                <button type="button" class="gc-btn-eliminar" data-action="eliminar" title="<?php esc_attr_e('Eliminar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                ...
                <tfoot>
                    <tr class="gc-carrito-total">
                        <td colspan="3" class="gc-total-label"><?php _e('Total estimado:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></td>
        ...
        <div class="gc-carrito-acciones">
            ...
            <?php else: ?>
                <div class="gc-carrito-aviso">
                    ...
                    <?php _e('No hay ciclo de pedidos abierto actualmente.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </div>
            <?php endif; ?>
        </div>
        ...
        <?php if (!empty($args['notas_ciclo'])): ?>
            <div class="gc-carrito-notas">
                <h4><?php _e('Notas del ciclo:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
