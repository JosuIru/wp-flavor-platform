        ...
        <div class="gc-ciclo-card gc-ciclo-activo">
            <div class="gc-ciclo-header">
                ...
                <div class="gc-ciclo-countdown" id="gc-countdown-container">
                    <span class="gc-countdown-label"><?php esc_html_e('Cierra en:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-ciclo-body">
                ...
                <div class="gc-ciclo-fechas">
                    <div class="gc-fecha-item">
                        ...
                        <div class="gc-fecha-content">
                            <span class="gc-fecha-label"><?php esc_html_e('Inicio de pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                            <strong>
                                <?php
                    ...
                    <div class="gc-fecha-item gc-fecha-destacada">
                        ...
                        <div class="gc-fecha-content">
                            <span class="gc-fecha-label"><?php esc_html_e('Cierre de pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                            <strong>
                                <?php
                    ...
                    <div class="gc-fecha-item">
                        ...
                        <div class="gc-fecha-content">
                            <span class="gc-fecha-label"><?php esc_html_e('Entrega', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                            <strong>
                                <?php
                    ...
                    <div class="gc-fecha-item">
                        ...
                        <div class="gc-fecha-content">
                            <span class="gc-fecha-label"><?php esc_html_e('Lugar de recogida', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                ...
                <div class="gc-ciclo-stats">
                    <h3><?php esc_html_e('Estado del ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                    <div class="gc-stats-grid">
                        <div class="gc-stat-item">
                            ...
                            <span class="gc-stat-label"><?php esc_html_e('Participantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                        <div class="gc-stat-item">
                            <span class="gc-stat-value"><?php echo esc_html($estadisticas_ciclo['total_productos']); ?></span>
                            <span class="gc-stat-label"><?php esc_html_e('Productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                        <div class="gc-stat-item">
                            <span class="gc-stat-value"><?php echo number_format($estadisticas_ciclo['importe_total'], 2, ',', '.'); ?> &euro;</span>
                            <span class="gc-stat-label"><?php esc_html_e('Total acumulado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                    </div>

                    <?php if (!empty($estadisticas_ciclo['productos_populares'])) : ?>
                    <div class="gc-productos-populares">
                        <h4><?php esc_html_e('Productos mas pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        ...
        <div class="gc-ciclo-card gc-ciclo-proximo">
            <div class="gc-ciclo-header">
                <div class="gc-ciclo-titulo">
                    <span class="gc-status-badge gc-status-info">
                        ...
                        <?php esc_html_e('Proximo Ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </span>
            ...
            <div class="gc-ciclo-body">
                <div class="gc-ciclo-mensaje">
                    ...
                    <p>
                        <?php
                        printf(
                            esc_html__('El proximo ciclo de pedidos comenzara el %s.', FLAVOR_PLATFORM_TEXT_DOMAIN),
                ...
                <div class="gc-ciclo-fechas gc-fechas-compactas">
                    <div class="gc-fecha-item">
                        <span class="gc-fecha-label"><?php esc_html_e('Apertura:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <strong><?php echo esc_html(date_i18n('j M, H:i', strtotime($meta_proximo['fecha_inicio']))); ?></strong>
                    </div>
                    <div class="gc-fecha-item">
                        <span class="gc-fecha-label"><?php esc_html_e('Cierre:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-ciclo-footer">
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('grupos_consumo', 'productos')); ?>" class="gc-btn gc-btn-secondary">
                    ...
                    <?php esc_html_e('Ver productos disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
            </div>
        </div>
    ...
    <?php else : ?>
        ...
        <div class="gc-ciclo-card gc-ciclo-vacio">
            <div class="gc-ciclo-empty">
                <span class="dashicons dashicons-calendar-alt"></span>
                <h3><?php esc_html_e('No hay ciclos programados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <p><?php esc_html_e('Actualmente no hay ciclos de pedidos activos ni programados. Vuelve pronto para ver las novedades.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
...
(function() {
    ...
    function actualizarCountdown() {
        ...
        if (diferencia <= 0) {
            countdownElement.textContent = '<?php echo esc_js(__('Ciclo cerrado', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>';
