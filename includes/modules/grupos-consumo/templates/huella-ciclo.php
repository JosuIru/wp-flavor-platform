...
$nivel = 'bajo';
$nivel_color = '#f44336';
$nivel_texto = __('Mejorable', FLAVOR_PLATFORM_TEXT_DOMAIN);
...
<?php if ($estilo === 'badge'): ?>
    <div class="gc-huella-badge gc-huella-badge--<?php echo esc_attr($nivel); ?>">
        ...
        <span class="gc-huella-badge__label"><?php esc_html_e('Sello de Conciencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
    </div>
...
<?php elseif ($estilo === 'resumen'): ?>
    <div class="gc-huella-resumen">
        ...
        <div class="gc-huella-resumen__texto">
            ...
            <small><?php printf(esc_html__('%s kg CO₂ evitados', FLAVOR_PLATFORM_TEXT_DOMAIN), number_format($huella['co2_evitado_kg'], 1)); ?></small>
        </div>
    </div>
    ...
    <div class="gc-huella gc-huella--completo">
        <div class="gc-huella__header">
            <div class="gc-huella__titulo-wrapper">
                ...
                <h3 class="gc-huella__titulo"><?php esc_html_e('Huella Ecológica', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            <?php if ($ciclo_titulo): ?>
        ...
        <div class="gc-huella__metricas">
            <div class="gc-huella__metrica">
                ...
                <div class="gc-huella__metrica-datos">
                    ...
                    <span class="gc-huella__metrica-label"><?php esc_html_e('Transporte evitado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            ...
            <div class="gc-huella__metrica">
                ...
                <div class="gc-huella__metrica-datos">
                    ...
                    <span class="gc-huella__metrica-label"><?php esc_html_e('CO₂ evitado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            ...
            <div class="gc-huella__metrica">
                ...
                <div class="gc-huella__metrica-datos">
                    ...
                    <span class="gc-huella__metrica-label"><?php esc_html_e('Plástico evitado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            ...
            <div class="gc-huella__metrica">
                ...
                <div class="gc-huella__metrica-datos">
                    ...
                    <span class="gc-huella__metrica-label"><?php esc_html_e('Agua ahorrada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="gc-huella__detalles">
            <div class="gc-huella__detalle">
                ...
                <?php esc_html_e('productores locales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </div>
            <div class="gc-huella__detalle">
            ...
            <div class="gc-huella__detalle">
                ...
                <?php esc_html_e('productos eco', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </div>
            <div class="gc-huella__detalle">
                <span class="dashicons dashicons-location"></span>
                <strong><?php echo esc_html(number_format($huella['km_medio_producto'], 0)); ?> km</strong>
                <?php esc_html_e('distancia media', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </div>
        </div>
        ...
        <div class="gc-huella__footer">
            <small>
                <?php
                printf(
                    esc_html__('Calculado: %s • Total procesado: %s kg', FLAVOR_PLATFORM_TEXT_DOMAIN),
