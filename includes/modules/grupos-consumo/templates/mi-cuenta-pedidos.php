...
<div class="gc-dashboard-pedidos">
    ...
    <?php if ($pedido_actual): ?>
        ...
        <div class="gc-pedido-actual">
            <div class="gc-pedido-actual-header">
                <span class="gc-badge gc-badge-success"><?php _e('Pedido activo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-pedido-actual-info">
                <div class="gc-info-item">
                    ...
                    <span><?php printf(__('Entrega: %s', FLAVOR_PLATFORM_TEXT_DOMAIN), date_i18n('d M Y', strtotime($pedido_actual['fecha_entrega']))); ?></span>
                </div>
                <div class="gc-info-item">
            ...
            <div class="gc-pedido-actual-productos">
                <h4><?php _e('Productos pedidos:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
                <ul>
            ...
            <div class="gc-pedido-actual-footer">
                ...
                <div class="gc-pedido-estado">
                    <span class="gc-estado gc-estado-<?php echo esc_attr($pedido_actual['estado_pago']); ?>">
                        <?php echo $pedido_actual['estado_pago'] === 'pagado' ? __('Pagado', FLAVOR_PLATFORM_TEXT_DOMAIN) : __('Pendiente de pago', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </span>
                </div>
            </div>
        </div>
    ...
    <?php if (empty($pedidos) && !$pedido_actual): ?>
        <div class="gc-dashboard-empty">
            ...
            <p><?php _e('Tu historial de pedidos aparecerá aquí.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    <?php elseif (!empty($pedidos)): ?>
        ...
        <div class="gc-pedidos-historial">
                ...
                <?php foreach ($pedidos as $pedido): ?>
                    <div class="gc-pedido-mini" data-id="<?php echo esc_attr($pedido['id']); ?>">
                        ...
                        <div class="gc-pedido-mini-info">
                            ...
                            <span><?php echo count($pedido['productos']); ?> <?php _e('productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
            ...
            <a href="<?php echo esc_url(add_query_arg('gc_section', 'historial')); ?>" class="gc-btn gc-btn-secondary gc-btn-full">
                <?php _e('Ver historial completo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
        </div>
    <?php endif; ?>
</div>
