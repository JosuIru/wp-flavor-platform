...
if (!is_user_logged_in()) {
    ...
    echo '<p>' . esc_html__('Inicia sesion para ver los detalles de tu pedido.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
...
if (!$entrega) {
    ...
    echo '<h3>' . esc_html__('Pedido no encontrado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</h3>';
    echo '<p>' . esc_html__('No se ha encontrado el pedido solicitado o no tienes pedidos aun.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
    echo '<a href="' . esc_url(Flavor_Platform_Helpers::get_action_url('grupos_consumo', 'productos')) . '" class="gc-btn gc-btn-primary">';
    echo esc_html__('Ver catalogo', FLAVOR_PLATFORM_TEXT_DOMAIN);
    echo '</a></div>';
    return;
}
...
// Estados del pedido
$estados_pago = [
    'pendiente'          => ['label' => __('Pendiente de pago', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-warning', 'icon' => 'clock'],
    'pendiente_recogida' => ['label' => __('Pago en recogida', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-info', 'icon' => 'location'],
    'procesando'         => ['label' => __('Procesando pago', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-info', 'icon' => 'update'],
    'completado'         => ['label' => __('Pagado', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-success', 'icon' => 'yes'],
    'fallido'            => ['label' => __('Pago fallido', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-error', 'icon' => 'no'],
    'reembolsado'        => ['label' => __('Reembolsado', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-secondary', 'icon' => 'undo'],
];

$estados_recogida = [
    'pendiente' => ['label' => __('Pendiente de recoger', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-warning', 'icon' => 'clock'],
    'preparado' => ['label' => __('Preparado para recoger', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-info', 'icon' => 'yes-alt'],
    'recogido'  => ['label' => __('Recogido', FLAVOR_PLATFORM_TEXT_DOMAIN), 'class' => 'gc-status-success', 'icon' => 'yes'],
];
...
foreach ($items_pedido as $item) {
    ...
    if (!isset($items_por_productor[$productor_id])) {
        ...
        $items_por_productor[$productor_id] = [
            'nombre' => $productor ? $productor->post_title : __('Sin productor', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'items'  => [],
        ];
    }
...
<div class="gc-mi-pedido-container">
    ...
    <header class="gc-pedido-header">
        <div class="gc-pedido-titulo">
            ...
            <div>
                <span class="gc-pedido-numero"><?php printf(__('Pedido #%d', FLAVOR_PLATFORM_TEXT_DOMAIN), $entrega->id); ?></span>
                <h2><?php echo esc_html($entrega->ciclo_nombre ?: __('Ciclo de pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></h2>
            </div>
        </div>
    ...
    <div class="gc-pedido-content">
        ...
        <div class="gc-pedido-main">
            ...
            <div class="gc-pedido-timeline">
                <h3><?php esc_html_e('Estado del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="gc-timeline">
                    <div class="gc-timeline-item gc-timeline-completado">
                        ...
                        <div class="gc-timeline-content">
                            <strong><?php esc_html_e('Pedido realizado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                    ...
                    <div class="gc-timeline-item <?php echo $entrega->estado_pago === 'completado' ? 'gc-timeline-completado' : 'gc-timeline-pendiente'; ?>">
                        ...
                        <div class="gc-timeline-content">
                            <strong><?php esc_html_e('Pago confirmado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                    ...
                    <div class="gc-timeline-item <?php echo ($entrega->estado_recogida ?? '') === 'preparado' || ($entrega->estado_recogida ?? '') === 'recogido' ? 'gc-timeline-completado' : 'gc-timeline-pendiente'; ?>">
                        ...
                        <div class="gc-timeline-content">
                            <strong><?php esc_html_e('Pedido preparado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                        </div>
                    </div>
                    ...
                    <div class="gc-timeline-item <?php echo ($entrega->estado_recogida ?? '') === 'recogido' ? 'gc-timeline-completado' : 'gc-timeline-pendiente'; ?>">
                        ...
                        <div class="gc-timeline-content">
                            <strong><?php esc_html_e('Pedido recogido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
            ...
            <div class="gc-pedido-productos">
                <h3>
                    <?php esc_html_e('Productos del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        ...
                        <?php foreach ($productor_data['items'] as $item) :
                            ...
                            switch ($item->estado) {
                                case 'confirmado':
                                    ...
                                    $estado_item_label = __('Confirmado', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                    break;
                                case 'completado':
                                    $estado_item_class = 'gc-item-completado';
                                    $estado_item_label = __('Preparado', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                    break;
                                case 'cancelado':
                                    $estado_item_class = 'gc-item-cancelado';
                                    $estado_item_label = __('Cancelado', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                    break;
                                case 'sin_stock':
                                    $estado_item_class = 'gc-item-sin-stock';
                                    $estado_item_label = __('Sin stock', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                    break;
                                default:
                                    $estado_item_class = 'gc-item-pendiente';
                                    $estado_item_label = __('Pendiente', FLAVOR_PLATFORM_TEXT_DOMAIN);
                            }
                        ?>
        ...
        <aside class="gc-pedido-sidebar">
            ...
            <div class="gc-sidebar-card gc-resumen-economico">
                <h3><?php esc_html_e('Resumen', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                ...
                <div class="gc-resumen-lineas">
                    ...
                    <div class="gc-resumen-linea gc-linea-gestion">
                        <span><?php esc_html_e('Gastos de gestion', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-sidebar-card gc-info-entrega">
                <h3><?php esc_html_e('Entrega', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>

                <?php if ($ciclo_meta['fecha_entrega']) : ?>
                <div class="gc-info-item">
                    <span class="dashicons dashicons-calendar-alt"></span>
                    <div>
                        <span class="gc-info-label"><?php esc_html_e('Fecha', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <strong>
                ...
                <div class="gc-info-item">
                    ...
                    <div>
                        <span class="gc-info-label"><?php esc_html_e('Lugar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-sidebar-card gc-notas-pedido">
                <h3><?php esc_html_e('Notas del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            ...
            <div class="gc-sidebar-acciones">
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('grupos_consumo', 'mis-pedidos')); ?>" class="gc-btn gc-btn-text gc-btn-block">
                    ...
                    <?php esc_html_e('Ver todos mis pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
            </div>
        </aside>
    </div>
