...
<div class="wrap gc-admin-consolidado">
    <h1><?php _e('Consolidado de Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h1>

    <!-- Selector de Ciclo -->
    <div class="gc-ciclo-selector">
        <form method="get">
            <input type="hidden" name="page" value="<?php echo esc_attr__('gc-consolidado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            <label for="ciclo"><?php _e('Seleccionar Ciclo:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
    ...
    <?php if ($ciclo_id && $ciclo_info): ?>
            ...
            <div class="gc-info-card">
                ...
                <div class="gc-info-grid">
                    <div class="gc-info-item">
                        <span class="gc-info-label"><?php _e('Estado:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <span class="gc-estado gc-estado-<?php echo esc_attr($estado_ciclo); ?>">
                            <?php echo esc_html(ucfirst($estado_ciclo)); ?>
                        </span>
                    </div>
                    <div class="gc-info-item">
                        <span class="gc-info-label"><?php _e('Cierre:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <span><?php echo $fecha_cierre ? date_i18n('d M Y H:i', strtotime($fecha_cierre)) : 'N/A'; ?></span>
                    </div>
                    <div class="gc-info-item">
                        <span class="gc-info-label"><?php _e('Entrega:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <span><?php echo $fecha_entrega ? date_i18n('d M Y', strtotime($fecha_entrega)) : 'N/A'; ?></span>
                    </div>
                    <div class="gc-info-item gc-info-total">
                        <span class="gc-info-label"><?php _e('Total General:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="gc-acciones">
                <a href="<?php echo wp_nonce_url(admin_url('admin-post.php?action=gc_exportar_consolidado&ciclo_id=' . $ciclo_id . '&formato=excel'), 'gc_exportar_consolidado'); ?>"
                   class="button button-primary">
                    ...
                    <?php _e('Exportar Excel', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
                ...
                <button type="button" class="button gc-btn-enviar-productores" data-ciclo="<?php echo $ciclo_id; ?>">
                    ...
                    <?php _e('Enviar a Productores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </button>
        ...
        <div class="gc-kpis-grid">
            ...
            <div class="gc-kpi-card">
                ...
                <div class="gc-kpi-content">
                    ...
                    <span class="gc-kpi-label"><?php _e('Consumidores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            <div class="gc-kpi-card">
                ...
                <div class="gc-kpi-content">
                    ...
                    <span class="gc-kpi-label"><?php _e('Productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
            <div class="gc-kpi-card">
        ...
        <?php if (!empty($totales_por_productor)): ?>
            <div class="gc-resumen-chart">
                <h2><?php _e('Distribución por Productor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        ...
        <?php if (!empty($consolidado)): ?>
            <div class="gc-tabla-card">
                <h2><?php _e('KPIs por productor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <table class="wp-list-table widefat fixed striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-right"><?php _e('% del ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="gc-consolidado-lista">
                    ...
                    <div class="gc-productor-card" data-productor="<?php echo $productor_id; ?>">
                        ...
                        <div class="gc-productor-detalle">
                            <table class="wp-list-table widefat fixed striped">
                                <thead>
                                    <tr>
                                        <th class="column-producto"><?php _e('Producto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                        <th class="column-cantidad"><?php _e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                        <th class="column-unidad"><?php _e('Unidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                        <th class="column-precio"><?php _e('Precio Unit.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                        <th class="column-total"><?php _e('Total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot>
                                    <tr class="gc-subtotal-row">
                                        <td colspan="4" class="text-right">
                                            <strong><?php _e('Subtotal:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                                        </td>
                                        <td>
                ...
                <div class="gc-total-general-card">
                    <div class="gc-total-general">
                        <span class="gc-total-label"><?php _e('TOTAL GENERAL:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        ...
        <?php else: ?>
            <div class="gc-no-data">
                ...
                <p><?php _e('No hay datos de consolidado para este ciclo.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                <p class="description"><?php _e('El consolidado se genera automáticamente cuando se cierran los pedidos del ciclo.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        <?php endif; ?>
    ...
    <?php else: ?>
        <div class="gc-no-data">
            <span class="dashicons dashicons-info"></span>
            <p><?php _e('No hay ciclos disponibles.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    <?php endif; ?>
</div>
...
jQuery(document).ready(function($) {
    ...
    $('.gc-btn-enviar-productores').on('click', function() {
        ...
        gcConsolidadoConfirmar('<?php echo esc_js(__('¿Enviar el consolidado a todos los productores?', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', function() {
            $.post(ajaxurl, {
                ...
                if (response.success) {
                    ...
                    gcConsolidadoAviso(response.data.message || '<?php echo esc_js(__('Error al enviar', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>', 'error');
                }
            });
        });
    });
