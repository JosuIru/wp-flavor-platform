...
<div class="wrap gc-admin-reportes">
    <h1><?php _e('Reportes y Estadísticas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h1>
            ...
            <div class="gc-filtro-grid">
                <div class="gc-filtro-item">
                    ...
                    <select name="periodo" id="gc-periodo-select">
                        <option value="semana" <?php selected($periodo, 'semana'); ?>><?php _e('Última semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                        <option value="mes" <?php selected($periodo, 'mes'); ?>><?php _e('Este mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                        <option value="trimestre" <?php selected($periodo, 'trimestre'); ?>><?php _e('Último trimestre', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                        <option value="anio" <?php selected($periodo, 'anio'); ?>><?php _e('Este año', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                        <option value="custom" <?php selected($periodo, 'custom'); ?>><?php _e('Personalizado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                    </select>
                </div>
                ...
                <div class="gc-filtro-item">
                    <button type="submit" class="button button-primary"><?php _e('Aplicar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="gc-filtro-periodo">
        <form method="get">
            ...
            <div class="gc-filtro-grid">
                <div class="gc-filtro-item">
                    <label><?php _e('Ciclo:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <select name="ciclo_id">
                        <option value="0"><?php _e('Todos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></option>
                ...
                <div class="gc-filtro-item">
                    <label><?php _e('Productor:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                ...
                <div class="gc-filtro-item">
                    <a class="button button-secondary" href="<?php echo esc_url(wp_nonce_url(admin_url('admin-post.php?action=gc_exportar_pedidos_filtrado&ciclo_id=' . $filtro_ciclo . '&productor_id=' . $filtro_productor . '&desde=' . $fecha_inicio . '&hasta=' . $fecha_fin), 'gc_exportar_pedidos_filtrado')); ?>">
                        <?php _e('Exportar CSV filtrado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                </div>
            </div>
        </form>
    ...
    <div class="gc-kpis-grid">
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card gc-kpi-highlight">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Facturación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Ticket medio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Pedidos este mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Facturación este mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Consumidores activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Suscripciones activas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('MRR (Ingresos recurrentes)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        <div class="gc-kpi-card">
            ...
            <div class="gc-kpi-content">
                ...
                <span class="gc-kpi-label"><?php _e('Productores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="gc-graficos-grid">
        ...
        <div class="gc-grafico-card gc-grafico-wide">
            <h2><?php _e('Evolución de Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        ...
        <div class="gc-grafico-card">
            <h2><?php _e('Pedidos por Estado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <div class="gc-chart-container">
        ...
        <div class="gc-grafico-card">
            <h2><?php _e('Suscripciones por Frecuencia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <div class="gc-chart-container">
    ...
    <div class="gc-tablas-grid">
        ...
        <div class="gc-tabla-card">
            <h2><?php _e('Resumen por ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th><?php _e('Ciclo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Importe', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($resumen_ciclos)): ?>
                        <tr><td colspan="3" class="text-center"><?php _e('Sin datos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></td></tr>
                    <?php else: ?>
        ...
        <!-- Top Productos -->
        <div class="gc-tabla-card">
            <h2><?php _e('Top 10 Productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th>#</th>
                ...
                <tbody>
                    <?php if (empty($top_productos)): ?>
                        <tr><td colspan="4" class="text-center"><?php _e('Sin datos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></td></tr>
                    <?php else: ?>
        ...
        <!-- Top Productores -->
        <div class="gc-tabla-card">
            <h2><?php _e('Top 10 Productores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th>#</th>
                        <th><?php _e('Productor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Importe', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
                        <?php foreach ($top_productores as $i => $productor): ?>
                            <tr>
                                <td><?php echo $i + 1; ?></td>
                                <td><?php echo esc_html($productor->nombre ?: __('Sin nombre', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></td>
        ...
        <!-- Top Consumidores -->
        <div class="gc-tabla-card">
            <h2><?php _e('Top 10 Consumidores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        <th>#</th>
                        <th><?php _e('Consumidor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Pedidos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th class="text-right"><?php _e('Importe', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    </tr>
                </thead>
    ...
    <div class="gc-acciones-exportar">
        <h2><?php _e('Exportar Datos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
