...
<div class="he-container">
    <header class="he-header">
        <h2>
            ...
            <?php esc_html_e('Mis Logros Ecológicos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </h2>
        <p><?php esc_html_e('Reconocimientos por tu contribución a la sostenibilidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </header>
    ...
    <div style="background: linear-gradient(135deg, var(--he-primary), var(--he-secondary)); border-radius: var(--he-radius); padding: 2rem; color: white; text-align: center; margin-bottom: 2rem;">
        ...
        <div style="font-size: 1.1rem; opacity: 0.9;"><?php esc_html_e('puntos ecológicos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div style="display: flex; justify-content: center; gap: 2rem; margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid rgba(255,255,255,0.3);">
            <div>
                ...
                <div style="font-size: 0.9rem; opacity: 0.85;"><?php esc_html_e('logros desbloqueados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
            <div>
                <div style="font-size: 1.5rem; font-weight: 600;"><?php echo count($logros) - count($logros_obtenidos); ?></div>
                <div style="font-size: 0.9rem; opacity: 0.85;"><?php esc_html_e('por desbloquear', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
    </div>
    ...
    <section style="margin-bottom: 2rem;">
        <h3 style="margin-bottom: 1rem;">
            ...
            <?php esc_html_e('Logros desbloqueados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </h3>
    ...
    <section>
        <h3 style="margin-bottom: 1rem;">
            ...
            <?php esc_html_e('Por desbloquear', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </h3>
        <div class="he-logros-grid">
    ...
    <div style="text-align: center; margin-top: 2rem; padding-top: 2rem; border-top: 1px solid var(--he-border);">
        <p style="color: var(--he-text-light); margin-bottom: 1rem;">
            <?php esc_html_e('Sigue registrando acciones ecológicas para desbloquear más logros', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </p>
        <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('huella_ecologica', 'mis-registros')); ?>" class="he-btn he-btn--primary">
            ...
            <?php esc_html_e('Registrar acción', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </a>
    </div>
</div>
