    ...
    <div class="dm-card">
        <div class="dm-alert dm-alert--info">
            ...
            <div>
                ...
                <p><?php esc_html_e('Las tablas del módulo Huella Ecológica aún no han sido creadas. Activa el módulo completamente para generar la estructura necesaria.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        </div>
    </div>
    <?php
...
<div class="dm-stats-grid dm-stats-grid--4">
    <div class="dm-stat-card dm-stat-card--eco dm-stat-card--horizontal">
        ...
        <div class="dm-stat-card__content">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('kg CO₂ Total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
    </div>
    ...
    <div class="dm-stat-card dm-stat-card--success dm-stat-card--horizontal">
        ...
        <div class="dm-stat-card__content">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('kg Compensados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
    </div>
    ...
    <div class="dm-stat-card dm-stat-card--<?php echo $balance_neto <= 0 ? 'success' : 'warning'; ?> dm-stat-card--horizontal">
        ...
        <div class="dm-stat-card__content">
            ...
            <div class="dm-stat-card__label"><?php echo $balance_neto <= 0 ? esc_html__('Carbono Neutro', FLAVOR_PLATFORM_TEXT_DOMAIN) : esc_html__('Balance Neto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
    </div>
</div>
...
<div class="dm-alert dm-alert--info">
    ...
    <div>
        <strong><?php esc_html_e('Oportunidad de mejora', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
        <span><?php printf(esc_html__('Aún quedan %.1f kg de CO₂ por compensar.', FLAVOR_PLATFORM_TEXT_DOMAIN), $balance_neto); ?></span>
    </div>
</div>
<?php endif; ?>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3 class="dm-card__title">
                ...
                <?php esc_html_e('Emisiones Esta Semana', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </h3>
            <span class="dm-card__subtitle"><?php printf(esc_html__('%.1f kg CO₂ este mes', FLAVOR_PLATFORM_TEXT_DOMAIN), $co2_mes); ?></span>
        </div>
        ...
        <div class="dm-card__body">
            <?php if (empty($por_categoria)): ?>
                <div class="dm-empty">
                    ...
                    <p><?php esc_html_e('No hay registros todavía.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php else: ?>
...
<div class="dm-grid dm-grid--2">
    <div class="dm-card">
        <div class="dm-card__header">
            <h3 class="dm-card__title">
                ...
                <?php esc_html_e('Usuarios Más Sostenibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </h3>
            <span class="dm-card__subtitle"><?php esc_html_e('Menor huella mensual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="dm-card__body">
                        ...
                        <li class="dm-ranking__item">
                            ...
                            <div class="dm-ranking__content">
                                ...
                                <span class="dm-ranking__meta">
                                    <?php echo esc_html($usuario->registros); ?> <?php esc_html_e('registros', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </span>
                            </div>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3 class="dm-card__title">
                <span class="dashicons dashicons-chart-line"></span>
                <?php esc_html_e('Tendencia Mensual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </h3>
        </div>
        <div class="dm-card__body">
            <?php if (empty($tendencia)): ?>
                <div class="dm-empty">
                    ...
                    <p><?php esc_html_e('No hay datos históricos.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php else: ?>
                <div class="dm-data-list">
                    <?php
                    $meses = [
                        '01' => __('Enero', FLAVOR_PLATFORM_TEXT_DOMAIN), '02' => __('Febrero', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        '03' => __('Marzo', FLAVOR_PLATFORM_TEXT_DOMAIN), '04' => __('Abril', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        '05' => __('Mayo', FLAVOR_PLATFORM_TEXT_DOMAIN), '06' => __('Junio', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        '07' => __('Julio', FLAVOR_PLATFORM_TEXT_DOMAIN), '08' => __('Agosto', FLAVOR_PLATFORM_TEXT_DOMAIN),
                        '09' => __('Septiembre', FLAVOR_PLATFORM_TEXT_DOMAIN), '10' => __('Octubre', FLAVOR_PLATFORM_TEXT_DOMAIN),
...
<div class="dm-stats-grid dm-stats-grid--4">
    <div class="dm-stat-card dm-stat-card--secondary">
        ...
        <div class="dm-stat-card__label"><?php esc_html_e('Total Registros', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    </div>
    ...
    <div class="dm-stat-card dm-stat-card--info">
        ...
        <div class="dm-stat-card__label"><?php esc_html_e('kg/Usuario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    </div>
    ...
    <div class="dm-stat-card dm-stat-card--success">
        ...
        <div class="dm-stat-card__label"><?php esc_html_e('Objetivos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    </div>
    ...
    <div class="dm-stat-card dm-stat-card--primary">
        ...
        <div class="dm-stat-card__label"><?php esc_html_e('Cumplimiento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    </div>
</div>
