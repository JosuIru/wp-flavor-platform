...
<div class="dm-dashboard">
    ...
    <div class="dm-header">
        ...
        <div class="dm-header__actions">
            <a href="<?php echo esc_url(admin_url('admin.php?page=huertos-nuevo')); ?>" class="dm-btn dm-btn--primary">
    ...
    <div class="dm-quick-links">
        ...
        <a href="<?php echo esc_url(home_url('/mi-portal/huertos-urbanos/')); ?>" class="dm-quick-links__item" target="_blank">
