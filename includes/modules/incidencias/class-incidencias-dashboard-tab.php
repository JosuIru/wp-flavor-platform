...
class Flavor_Incidencias_Dashboard_Tab {
    ...
    public function registrar_tabs($tabs) {
        ...
        $tabs['incidencias-mis-reportes'] = [
            'label' => __('Mis Reportes', 'flavor-chat-ia'),
            'icon' => 'clipboard',
    ...
    public function render_tab_resumen() {
        ...
        <div class="flavor-panel flavor-incidencias-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Incidencias del Barrio', 'flavor-chat-ia'); ?></h2>
                <p class="flavor-panel-subtitle"><?php esc_html_e('Reporta y sigue el estado de las incidencias urbanas', 'flavor-chat-ia'); ?></p>
            </div>
            ...
            <div class="flavor-panel-kpis">
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Total Reportadas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Mis Reportes', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
    ...
    public function render_tab_mis_reportes() {
        ...
        <div class="flavor-panel flavor-mis-incidencias-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-clipboard"></span> <?php esc_html_e('Mis Reportes', 'flavor-chat-ia'); ?></h2>
                <a href="<?php echo esc_url(home_url('/incidencias/nueva/')); ?>" class="flavor-btn flavor-btn-primary flavor-btn-sm">
                    <span class="dashicons dashicons-plus-alt2"></span>
                    <?php esc_html_e('Nuevo Reporte', 'flavor-chat-ia'); ?>
                </a>
            </div>
            ...
            <?php if (empty($mis_incidencias)): ?>
                <div class="flavor-empty-state">
                    ...
                    <p><?php esc_html_e('No has reportado ninguna incidencia todavía.', 'flavor-chat-ia'); ?></p>
                    <a href="<?php echo esc_url(home_url('/incidencias/nueva/')); ?>" class="flavor-btn flavor-btn-primary">
                        <?php esc_html_e('Reportar primera incidencia', 'flavor-chat-ia'); ?>
                    </a>
                </div>
            <?php else: ?>
                ...
                <div class="flavor-panel-footer">
                    <a href="<?php echo esc_url(home_url('/incidencias/mis-incidencias/')); ?>" class="flavor-btn flavor-btn-outline">
                        <?php esc_html_e('Ver todos mis reportes', 'flavor-chat-ia'); ?>
                    </a>
                </div>
            <?php endif; ?>
        </div>
