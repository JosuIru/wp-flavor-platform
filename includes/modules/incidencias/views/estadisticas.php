...
<div class="wrap">
    ...
    <div class="postbox" style="margin: 20px 0;">
        <div class="inside">
            <form method="get" action="" style="display: flex; align-items: end; gap: 15px; flex-wrap: wrap;">
                <input type="hidden" name="page" value="flavor-incidencias-estadisticas">
                ...
                <div>
                    ...
                    <a href="?page=flavor-incidencias-estadisticas" class="button">Limpiar</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin: 20px 0;">
        ...
        <div class="postbox">
            <div class="postbox-header">
                <h2>Tendencia de Reportes Diarios</h2>
            </div>
            <div class="inside">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 20px 0;">
        ...
        <div class="postbox">
            <div class="postbox-header">
                <h2>Tiempo de Resolución por Prioridad</h2>
            </div>
            <div class="inside">
    ...
    <div class="postbox" style="margin: 20px 0;">
        <div class="postbox-header">
            <h2>Comparativa Mensual (Últimos 6 Meses)</h2>
        </div>
        <div class="inside">
    ...
    <div class="postbox" style="margin: 20px 0;">
        <div class="postbox-header">
            <h2>Estadísticas Detalladas por Categoría</h2>
        </div>
