    ...
    public function render_tab_resumen() {
        ...
        <div class="flavor-panel flavor-marketplace-panel">
            ...
            <div class="flavor-panel-actions">
                <a href="<?php echo esc_url(home_url('/marketplace/nuevo/')); ?>" class="flavor-btn flavor-btn-primary">
                    <span class="dashicons dashicons-plus-alt2"></span>
                    <?php esc_html_e('Publicar Anuncio', 'flavor-chat-ia'); ?>
                </a>
                <a href="<?php echo esc_url(home_url('/marketplace/')); ?>" class="flavor-btn flavor-btn-secondary">
    ...
    public function render_tab_mis_anuncios() {
        ...
        <div class="flavor-panel">
            <div class="flavor-panel-header">
                ...
                <a href="<?php echo esc_url(home_url('/marketplace/nuevo/')); ?>" class="flavor-btn flavor-btn-primary flavor-btn-sm">
                    <span class="dashicons dashicons-plus-alt2"></span>
                    ...
                    <?php foreach ($anuncios as $anuncio): ?>
                        <div class="flavor-card">
                            ...
                            <div class="flavor-card-footer">
                                <a href="<?php echo esc_url(home_url('/marketplace/' . $anuncio->slug)); ?>" class="flavor-btn flavor-btn-sm flavor-btn-outline">
                                    <?php esc_html_e('Ver', 'flavor-chat-ia'); ?>
                                </a>
                                <a href="<?php echo esc_url(home_url('/marketplace/editar/' . $anuncio->id)); ?>" class="flavor-btn flavor-btn-sm flavor-btn-secondary">
        ...
        <div class="flavor-panel">
            ...
            <?php if (empty($favoritos)): ?>
                <div class="flavor-empty-state">
                    ...
                    <a href="<?php echo esc_url(home_url('/marketplace/')); ?>" class="flavor-btn flavor-btn-primary">
