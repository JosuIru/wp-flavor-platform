    ...
    <div class="dm-header">
        <div class="dm-header__content">
            <h1 class="dm-header__title">
                ...
                <?php esc_html_e('Categorías y Tipos', 'flavor-chat-ia'); ?>
            </h1>
            <p class="dm-header__description">
                <?php esc_html_e('Estructura taxonómica del marketplace para navegar, filtrar y organizar anuncios.', 'flavor-chat-ia'); ?>
            </p>
        </div>
        <div class="dm-header__actions">
            <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=marketplace_categoria&post_type=marketplace_item')); ?>" class="dm-btn dm-btn--primary">
                <?php esc_html_e('Gestionar categorías', 'flavor-chat-ia'); ?>
            </a>
            <a href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=marketplace_tipo&post_type=marketplace_item')); ?>" class="dm-btn dm-btn--secondary">
                <?php esc_html_e('Gestionar tipos', 'flavor-chat-ia'); ?>
            </a>
        </div>
    </div>
    ...
    <div class="dm-stats-grid" style="margin-bottom:16px;">
        <div class="dm-stat-card">
            <div class="dm-stat-card__content">
                ...
                <div class="dm-stat-card__label"><?php esc_html_e('Categorías', 'flavor-chat-ia'); ?></div>
            </div>
        </div>
        <div class="dm-stat-card dm-stat-card--info">
            <div class="dm-stat-card__content">
                <div class="dm-stat-card__value"><?php echo number_format_i18n($total_tipos); ?></div>
                <div class="dm-stat-card__label"><?php esc_html_e('Tipos', 'flavor-chat-ia'); ?></div>
            </div>
        </div>
        <div class="dm-stat-card dm-stat-card--success">
            <div class="dm-stat-card__content">
                <div class="dm-stat-card__value"><?php echo number_format_i18n($total_publicados); ?></div>
                <div class="dm-stat-card__label"><?php esc_html_e('Anuncios publicados', 'flavor-chat-ia'); ?></div>
            </div>
        </div>
        <div class="dm-stat-card dm-stat-card--warning">
            <div class="dm-stat-card__content">
                <div class="dm-stat-card__value"><?php echo number_format_i18n($total_sin_categoria); ?></div>
                <div class="dm-stat-card__label"><?php esc_html_e('Sin categoría', 'flavor-chat-ia'); ?></div>
            </div>
        </div>
    </div>
    ...
    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:16px; align-items:start;">
        <div class="dm-card" style="padding:0; overflow:auto;">
            <div style="padding:16px; border-bottom:1px solid #e5e7eb;">
                <h2 style="margin:0;"><?php esc_html_e('Categorías', 'flavor-chat-ia'); ?></h2>
            </div>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e('Anuncios', 'flavor-chat-ia'); ?></th>
                ...
                <?php if (!is_wp_error($categorias) && !empty($categorias)) : ?>
                    <?php foreach ($categorias as $categoria) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="button button-small" href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=marketplace_categoria&post_type=marketplace_item')); ?>"><?php esc_html_e('Editar taxonomía', 'flavor-chat-ia'); ?></a>
                                <a class="button button-small" href="<?php echo esc_url(admin_url('admin.php?page=marketplace-productos&categoria=' . rawurlencode($categoria->slug))); ?>"><?php esc_html_e('Filtrar en anuncios', 'flavor-chat-ia'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr><td colspan="4"><?php esc_html_e('No hay categorías registradas.', 'flavor-chat-ia'); ?></td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
        ...
        <div class="dm-card" style="padding:0; overflow:auto;">
            <div style="padding:16px; border-bottom:1px solid #e5e7eb;">
                <h2 style="margin:0;"><?php esc_html_e('Tipos de anuncio', 'flavor-chat-ia'); ?></h2>
            </div>
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                ...
                <?php if (!is_wp_error($tipos) && !empty($tipos)) : ?>
                    <?php foreach ($tipos as $tipo) : ?>
                        <tr>
                            ...
                            <td>
                                <a class="button button-small" href="<?php echo esc_url(admin_url('edit-tags.php?taxonomy=marketplace_tipo&post_type=marketplace_item')); ?>"><?php esc_html_e('Editar taxonomía', 'flavor-chat-ia'); ?></a>
                                <a class="button button-small" href="<?php echo esc_url(admin_url('admin.php?page=marketplace-productos&tipo=' . rawurlencode($tipo->slug))); ?>"><?php esc_html_e('Filtrar en anuncios', 'flavor-chat-ia'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr><td colspan="4"><?php esc_html_e('No hay tipos registrados.', 'flavor-chat-ia'); ?></td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
