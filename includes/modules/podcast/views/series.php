...
<div class="wrap">
    <h1>
        ...
        <a href="#" class="page-title-action" onclick="abrirModalNuevaSerie(); return false;">
            <span class="dashicons dashicons-plus-alt"></span> Nueva Serie
        </a>
    </h1>
    ...
    <div class="flavor-series-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 20px; margin: 20px 0;">
        ...
        <?php if (empty($podcasts)): ?>
            <div style="grid-column: 1 / -1; text-align: center; padding: 60px 20px; background: #fff; border-radius: 8px;">
                ...
                <h3 style="color: #666;">No hay series de podcast todavía</h3>
                <p style="color: #999;">Crea tu primera serie para comenzar a publicar episodios</p>
                <button onclick="abrirModalNuevaSerie()" class="button button-primary button-large">
                    <span class="dashicons dashicons-plus-alt"></span> Crear Primera Serie
                </button>
            </div>
        <?php else: ?>
                    ...
                    <div style="padding: 20px;">
                        ...
                        <div style="display: flex; gap: 15px; margin: 15px 0; padding-top: 15px; border-top: 1px solid #f0f0f1; font-size: 13px;">
                            ...
                            <div style="flex: 1;">
                                ...
                                <div style="color: #666; font-size: 11px;">Reproducciones</div>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; gap: 10px; margin-top: 15px;">
                            ...
                            <button onclick="verEpisodiosSerie(<?php echo $podcast->id; ?>)" class="button button-small button-primary" style="flex: 1;">
                                <span class="dashicons dashicons-playlist-audio"></span> Episodios
                            </button>
                        </div>

                        <div style="margin-top: 10px;">
                            <button onclick="generarRSS(<?php echo $podcast->id; ?>)" class="button button-small" style="width: 100%;">
                                <span class="dashicons dashicons-rss"></span> Feed RSS
                            </button>
                        </div>
                    </div>
...
<div id="modal-nueva-serie" style="display: none; position: fixed; z-index: 100000; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5);">
    <div style="background-color: #fff; margin: 5% auto; padding: 30px; width: 90%; max-width: 700px; border-radius: 8px; max-height: 80vh; overflow-y: auto;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            ...
            <button onclick="cerrarModalNuevaSerie()" style="background: none; border: none; font-size: 24px; cursor: pointer;">&times;</button>
        </div>

        <form id="form-nueva-serie" method="post" enctype="multipart/form-data">

            <div style="margin-bottom: 20px;">
                <label for="serie_titulo" style="display: block; margin-bottom: 5px; font-weight: 600;">Título de la Serie:</label>
                <input type="text" name="titulo" id="serie_titulo" class="regular-text" required style="width: 100%;" placeholder="Ej: Historias del Barrio">
            </div>

            <div style="margin-bottom: 20px;">
                <label for="serie_descripcion" style="display: block; margin-bottom: 5px; font-weight: 600;">Descripción:</label>
                <textarea name="descripcion" id="serie_descripcion" rows="5" class="large-text" required style="width: 100%;" placeholder="Describe de qué trata tu podcast..."></textarea>
            </div>

            <div style="margin-bottom: 20px;">
                <label for="serie_categoria" style="display: block; margin-bottom: 5px; font-weight: 600;">Categoría:</label>
                <input type="text" name="categoria" id="serie_categoria" class="regular-text" list="categorias-existentes" style="width: 100%;" placeholder="Ej: Noticias locales">
            ...
            <div style="margin-bottom: 20px;">
                <label for="serie_idioma" style="display: block; margin-bottom: 5px; font-weight: 600;">Idioma:</label>
            ...
            <div style="margin-bottom: 20px;">
                <label for="serie_imagen" style="display: block; margin-bottom: 5px; font-weight: 600;">Imagen de Portada:</label>
                <input type="file" name="imagen_portada" id="serie_imagen" accept="image/*">
                <p class="description">Recomendado: 1400x1400px (formato cuadrado)</p>
            </div>

            <div style="margin-bottom: 20px;">
                <label for="serie_estado" style="display: block; margin-bottom: 5px; font-weight: 600;">Estado Inicial:</label>
            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 30px;">
                <button type="button" onclick="cerrarModalNuevaSerie()" class="button button-large">Cancelar</button>
                <button type="submit" class="button button-primary button-large">
                    <span class="dashicons dashicons-saved"></span> Crear Serie
                </button>
            </div>
