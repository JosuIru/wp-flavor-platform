...
<div class="flavor-pp-formulario-contenedor">
    <div class="flavor-pp-formulario-header">
        <h2><?php esc_html_e('Proponer un proyecto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        <p class="flavor-pp-formulario-intro">
            <?php esc_html_e('Comparte tu idea para mejorar el barrio. Las propuestas seran revisadas y, si cumplen los requisitos, pasaran a votacion.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </p>
    </div>
    ...
    <form id="flavor-pp-form-propuesta" class="flavor-pp-formulario" method="post">
        ...
        <div class="flavor-pp-campo">
            <label for="pp-titulo" class="flavor-pp-label">
                <?php esc_html_e('Titulo del proyecto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                <span class="requerido">*</span>
            </label>
            <input type="text" id="pp-titulo" name="titulo" class="flavor-pp-input" required
                   maxlength="200"
                   placeholder="<?php esc_attr_e('Ej: Parque infantil accesible en Plaza Mayor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            <span class="flavor-pp-ayuda"><?php esc_html_e('Maximo 200 caracteres', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        ...
        <div class="flavor-pp-campo">
            <label for="pp-descripcion" class="flavor-pp-label">
                <?php esc_html_e('Descripcion detallada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                <span class="requerido">*</span>
            </label>
            <textarea id="pp-descripcion" name="descripcion" class="flavor-pp-textarea" required
                      rows="6" maxlength="2000"
                      placeholder="<?php esc_attr_e('Describe tu propuesta: que problema resuelve, a quien beneficia, donde se ubicaria...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></textarea>
            <span class="flavor-pp-ayuda"><?php esc_html_e('Minimo 50 caracteres, maximo 2000', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        ...
        <div class="flavor-pp-campo-grupo">
            <div class="flavor-pp-campo flavor-pp-campo-mitad">
                <label for="pp-presupuesto" class="flavor-pp-label">
                    <?php esc_html_e('Presupuesto estimado (EUR)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    <span class="requerido">*</span>
                </label>
                ...
                <span class="flavor-pp-ayuda">
                    <?php printf(
                        esc_html__('Entre %s y %s EUR', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <div class="flavor-pp-campo flavor-pp-campo-mitad">
                <label for="pp-ubicacion" class="flavor-pp-label">
                    <?php esc_html_e('Ubicacion sugerida', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </label>
                <input type="text" id="pp-ubicacion" name="ubicacion" class="flavor-pp-input"
                       maxlength="200"
                       placeholder="<?php esc_attr_e('Ej: Calle Mayor, 15', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            </div>
        </div>

        <div class="flavor-pp-campo">
            <label for="pp-imagen" class="flavor-pp-label">
                <?php esc_html_e('Imagen ilustrativa (opcional)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </label>
            <div class="flavor-pp-upload-area" id="pp-upload-area">
                ...
                <div class="flavor-pp-upload-placeholder">
                    ...
                    <span class="flavor-pp-ayuda"><?php esc_html_e('JPG, PNG o WebP. Maximo 2MB.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
        ...
        <div class="flavor-pp-campo flavor-pp-campo-checkbox">
            <label class="flavor-pp-checkbox-label">
                ...
                <span><?php
                    printf(
                        esc_html__('He leido y acepto las %scondiciones de participacion%s', FLAVOR_PLATFORM_TEXT_DOMAIN),
