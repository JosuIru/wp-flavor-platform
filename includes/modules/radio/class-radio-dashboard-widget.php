    ...
    private function fetch_widget_data(): array {
        ...
        if ($emision_actual) {
            $stats[] = [
                ...
                'color' => 'success',
                'url' => $es_admin ? admin_url('admin.php?page=radio') : home_url('/mi-portal/radio/'),
            ];
        } else {
            $stats[] = [
        ...
        $stats[] = [
            ...
            'url' => $es_admin ? admin_url('admin.php?page=radio&tab=programas') : home_url('/mi-portal/radio/programas/'),
        ];
    ...
    private function get_programas_destacados(int $limite): array {
        ...
        foreach ($programas as $programa) {
            $items[] = [
                ...
                'url' => $es_admin ? admin_url('admin.php?page=radio&programa=' . $programa->id) : home_url('/mi-portal/radio/programa/' . $programa->id . '/'),
            ];
        }
