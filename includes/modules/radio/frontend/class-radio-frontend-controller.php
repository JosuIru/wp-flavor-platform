...
class Flavor_Radio_Frontend_Controller {
    ...
    public function registrar_assets() {
        ...
        wp_localize_script('flavor-radio-frontend', 'flavorRadioConfig', [
            ...
            'strings' => [
                'reproduciendo' => __('En vivo', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'pausado' => __('Pausado', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'cargando' => __('Conectando...', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'error' => __('Error de conexión', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'enviado' => __('Mensaje enviado', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'dedicatoriaEnviada' => __('Dedicatoria enviada correctamente', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ],
        ]);
    }
    ...
    public function registrar_dashboard_tabs($tabs) {
        $tabs['radio'] = [
            'titulo' => __('Radio', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        <div class="flavor-radio-dashboard">
                ...
                <div class="flavor-radio-en-vivo">
                    <div class="flavor-radio-visual">
                        ...
                        <div class="flavor-radio-status" id="radio-status">
                            <span class="flavor-radio-badge-live"><?php _e('EN VIVO', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                    </div>
                    <div class="flavor-radio-info">
                        <h2><?php echo esc_html($radio_settings['nombre_radio'] ?? __('Radio Comunitaria', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></h2>
                        <p class="flavor-radio-slogan"><?php echo esc_html($radio_settings['slogan'] ?? ''); ?></p>
                        <?php if ($programa_actual): ?>
                        <div class="flavor-ahora-suena">
                            <strong><?php _e('Ahora:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
            ...
            <div class="flavor-radio-acciones">
                <button type="button" class="flavor-accion-card" id="btn-dedicatoria">
                    ...
                    <span><?php _e('Enviar dedicatoria', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </button>
                <a href="#programacion" class="flavor-accion-card">
                    <span class="dashicons dashicons-calendar-alt"></span>
                    <span><?php _e('Programación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </a>
                <a href="#podcasts" class="flavor-accion-card">
                    <span class="dashicons dashicons-microphone"></span>
                    <span><?php _e('Podcasts', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </a>
            </div>
            ...
            <div class="flavor-panel">
                <h3 class="flavor-panel-titulo">
                    <span class="dashicons dashicons-heart"></span>
                    <?php _e('Mis dedicatorias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </h3>
                ...
                <div class="flavor-dedicatorias-lista">
                    ...
                    <div class="flavor-dedicatoria-item">
                        <div class="flavor-dedicatoria-texto">
                            ...
                            <small><?php _e('Canción:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <?php echo esc_html($ded->cancion_solicitada); ?></small>
                            <?php endif; ?>
                        </div>
                ...
                <?php else: ?>
                <p class="flavor-vacio"><?php _e('Aún no has enviado dedicatorias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                <?php endif; ?>
            </div>
                ...
                <div class="flavor-modal-contenido">
                    ...
                    <form id="form-dedicatoria">
                        <div class="flavor-form-grupo">
                            <label><?php _e('Para quién', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                            <input type="text" name="destinatario" required placeholder="<?php esc_attr_e('Nombre del destinatario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                        </div>
                        <div class="flavor-form-grupo">
                            <label><?php _e('Tu mensaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                            <textarea name="mensaje" rows="3" required placeholder="<?php esc_attr_e('Escribe tu dedicatoria...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></textarea>
                        </div>
                        <div class="flavor-form-grupo">
                            <label><?php _e('Canción solicitada (opcional)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                            <input type="text" name="cancion" placeholder="<?php esc_attr_e('Artista - Canción', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                        </div>
        ...
        <div class="flavor-radio-player flavor-radio-player-<?php echo esc_attr($atts['estilo']); ?>"
            ...
            <div class="flavor-radio-header">
                ...
                <span class="flavor-radio-badge-live" id="badge-live" style="display:none;">
                    <?php _e('EN VIVO', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
            </div>
            <?php endif; ?>
            ...
            <div class="flavor-radio-controles-player">
                ...
                <div class="flavor-radio-info-actual" id="info-actual">
                    <span class="flavor-radio-estado"><?php _e('Haz clic para escuchar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            ...
            <div class="radio-now-playing" id="radio-now-playing" style="display: none;">
                ...
                <button type="button" class="btn-share-song" title="<?php esc_attr_e('Compartir', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            ...
            <div class="radio-share-buttons">
                ...
                <button type="button" class="btn-share copy-link" data-red="copy" data-tipo="radio" title="<?php esc_attr_e('Copiar enlace', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
    ...
    public function shortcode_programacion($atts) {
        ...
        if (!Flavor_Platform_Helpers::tabla_existe($tabla_programas)) {
            return '<p class="flavor-aviso">' . __('Programación no disponible', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        $dias_es = [
            'monday' => __('Lunes', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'tuesday' => __('Martes', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'wednesday' => __('Miércoles', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'thursday' => __('Jueves', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'friday' => __('Viernes', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'saturday' => __('Sábado', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'sunday' => __('Domingo', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ];
        ...
        <div class="flavor-radio-programacion" id="programacion">
            <h2><?php _e('Programación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
            ...
            <div class="flavor-programacion-contenido">
                ...
                <div class="flavor-programacion-dia <?php echo $dia === $dia_actual ? 'activo' : ''; ?>"
                    ...
                    <?php if (!empty($programacion[$dia])): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                    <p class="flavor-vacio"><?php _e('Sin programación para este día', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <?php endif; ?>
                </div>
                <?php endforeach; ?>
            </div>
    ...
    public function shortcode_dedicatorias($atts) {
        if (!is_user_logged_in()) {
            return '<p class="flavor-aviso">' . __('Inicia sesión para enviar dedicatorias', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        <div class="flavor-radio-dedicatorias">
            ...
            <form id="form-dedicatoria-standalone" class="flavor-form-dedicatoria">
                ...
                <div class="flavor-form-grupo">
                    ...
                    <textarea name="mensaje" rows="3" required placeholder="<?php esc_attr_e('Tu dedicatoria...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"></textarea>
                </div>
                <div class="flavor-form-grupo">
                    <label><?php _e('Canción (opcional)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></label>
                    <input type="text" name="cancion" placeholder="<?php esc_attr_e('Artista - Título', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                </div>
                <button type="submit" class="flavor-btn flavor-btn-primary">
                    <span class="dashicons dashicons-heart"></span>
        ...
        <div class="flavor-radio-chat">
            <div class="flavor-chat-header">
                <h4>
                    ...
                    <?php _e('Chat en vivo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </h4>
            ...
            <form id="form-chat-radio" class="flavor-chat-form">
                <input type="text" name="mensaje" placeholder="<?php esc_attr_e('Escribe un mensaje...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>" autocomplete="off" maxlength="200">
                <button type="submit" class="flavor-btn flavor-btn-primary">
                    <span class="dashicons dashicons-arrow-right-alt"></span>
                </button>
            </form>
            <?php else: ?>
            <p class="flavor-chat-login"><?php _e('Inicia sesión para participar en el chat', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <?php endif; ?>
        </div>
        <?php
        return ob_get_clean();
    ...
    public function shortcode_podcasts($atts) {
        ...
        <div class="flavor-radio-podcasts" id="podcasts">
            <h2><?php _e('Programas grabados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
        ...
        <div class="flavor-radio-estadisticas">
            <div class="flavor-stats-grid">
                <div class="flavor-stat-card">
                    ...
                    <div class="flavor-stat-etiqueta"><?php _e('Programas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                <div class="flavor-stat-card">
                    ...
                    <div class="flavor-stat-etiqueta"><?php _e('Dedicatorias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                <div class="flavor-stat-card">
                    ...
                    <div class="flavor-stat-etiqueta"><?php _e('Oyentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
            </div>
        </div>
        <?php
        ...
        <div class="flavor-radio-programa-actual-widget">
            <?php if ($programa_actual): ?>
                <div class="flavor-programa-actual">
                    <span class="flavor-badge flavor-badge-live"><?php _e('EN DIRECTO', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <?php else: ?>
                <div class="flavor-sin-programa">
                    <p><?php _e('Música continua', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                </div>
            <?php endif; ?>

            <?php if ($programa_siguiente): ?>
                <div class="flavor-programa-siguiente">
                    <span class="flavor-label"><?php _e('A continuación:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
    ...
    public function ajax_enviar_dedicatoria() {
        ...
        if (empty($mensaje)) {
            wp_send_json_error(['message' => __('El mensaje es obligatorio', FLAVOR_PLATFORM_TEXT_DOMAIN)]);
        }
        ...
        if ($resultado === false) {
            wp_send_json_error(['message' => __('Error al enviar la dedicatoria', FLAVOR_PLATFORM_TEXT_DOMAIN)]);
        }

        wp_send_json_success([
            'message' => __('Dedicatoria enviada correctamente. Será emitida pronto.', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ]);
    }
    ...
    public function ajax_proponer_programa() {
        ...
        if (empty($nombre)) {
            wp_send_json_error(['message' => __('El nombre es obligatorio', FLAVOR_PLATFORM_TEXT_DOMAIN)]);
        }
        ...
        wp_send_json_success([
            'message' => __('Propuesta enviada. El equipo la revisará pronto.', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ]);
    }
    ...
    public function ajax_enviar_chat() {
        ...
        wp_send_json_error(['message' => __('Error al enviar mensaje', FLAVOR_PLATFORM_TEXT_DOMAIN)]);
    }
    ...
    private function obtener_etiqueta_estado($estado) {
        $etiquetas = [
            ...
            'emitida' => __('Emitida', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function shortcode_locutor_perfil($atts) {
        ...
        if (!$locutor_id) {
            return '<p class="flavor-aviso">' . __('Locutor no especificado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }

        $user = get_userdata($locutor_id);
        if (!$user) {
            return '<p class="flavor-aviso">' . __('Locutor no encontrado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        <div class="locutor-perfil">
            <div class="locutor-header">
                ...
                <p class="locutor-rol"><?php _e('Locutor', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            ...
            <div class="locutor-content">
                ...
                <div class="locutor-stats">
                    <div class="locutor-stat">
                        ...
                        <div class="locutor-stat-label"><?php _e('Programas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    </div>
                    <div class="locutor-stat">
                        <div class="locutor-stat-valor"><?php echo esc_html($total_episodios); ?></div>
                        <div class="locutor-stat-label"><?php _e('Episodios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    </div>
                    <div class="locutor-stat">
                        <div class="locutor-stat-valor"><?php echo esc_html($oyentes_promedio); ?></div>
                        <div class="locutor-stat-label"><?php _e('Oyentes/ep', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                    </div>
                </div>

                <?php if (!empty($programas)): ?>
                <div class="locutor-programas">
                    <h4><span class="dashicons dashicons-playlist-audio"></span> <?php _e('Sus programas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    public function shortcode_mis_favoritos($atts) {
        if (!is_user_logged_in()) {
            return '<p class="flavor-aviso">' . __('Inicia sesión para ver tus favoritos', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        }
        ...
        <div class="flavor-radio-favoritos">
            <h3>
                <span class="dashicons dashicons-heart"></span>
                <?php _e('Mis programas favoritos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </h3>
            ...
            <?php else: ?>
            <p class="flavor-vacio"><?php _e('No tienes programas favoritos todavía', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            <?php endif; ?>
        </div>
        <?php
        return ob_get_clean();
