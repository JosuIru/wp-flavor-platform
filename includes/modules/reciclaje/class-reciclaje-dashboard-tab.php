...
class Flavor_Reciclaje_Dashboard_Tab {
    ...
    public function registrar_tabs($tabs) {
        ...
        $tabs['reciclaje-mis-puntos'] = [
            'label'    => __('Mis Puntos', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        $tabs['reciclaje-recompensas'] = [
            'label'    => __('Recompensas', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function enqueue_assets() {
        ...
        wp_localize_script('flavor-reciclaje-dashboard', 'flavorReciclajeDashboard', [
            ...
            'i18n'    => [
                ...
                'confirmCanje' => __('Confirmar canje de puntos?', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function render_tab_mis_aportes() {
        ...
        <div class="flavor-dashboard-tab reciclaje-mis-aportes">
            <div class="tab-header">
                <h2><?php esc_html_e('Mis Aportes de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <p class="descripcion"><?php esc_html_e('Historial de todos tus depositos de reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>

            <!-- Resumen del mes -->
            <div class="resumen-mensual">
                <h3><?php esc_html_e('Este Mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="stats-grid stats-grid-4">
                    <div class="stat-card">
                        ...
                        <span class="stat-label"><?php esc_html_e('Depositos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="stat-card">
                        ...
                        <span class="stat-label"><?php esc_html_e('Material', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="stat-card">
                    ...
                    <div class="stat-card">
                        ...
                        <span class="stat-label"><?php esc_html_e('Verificados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="listado-aportes">
                <h3><?php esc_html_e('Historial de Depositos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                        ...
                        <table class="aportes-tabla">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e('Punto de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                            ...
                            <tbody>
                                <?php foreach ($aportes as $aporte): ?>
                                    <tr class="aporte-row <?php echo $aporte->verificado ? 'verificado' : 'pendiente'; ?>">
                                        ...
                                        <td class="punto">
                                            <?php echo esc_html($aporte->punto_nombre ?: __('Punto eliminado', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?>
                                        </td>
                                        <td class="material">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p><?php esc_html_e('Aun no has realizado ningun deposito de reciclaje.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                        <a href="<?php echo esc_url(get_permalink(get_option('flavor_reciclaje_puntos_page'))); ?>" class="button button-primary">
                            <?php esc_html_e('Encontrar puntos de reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
    ...
    public function render_tab_mis_puntos() {
        ...
        <div class="flavor-dashboard-tab reciclaje-mis-puntos">
            <div class="tab-header">
                <h2><?php esc_html_e('Mis Puntos de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <p class="descripcion"><?php esc_html_e('Puntos acumulados y tu posicion en el ranking comunitario', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            ...
            <div class="puntos-hero">
                <div class="puntos-disponibles">
                    ...
                    <span class="puntos-label"><?php esc_html_e('Puntos disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="puntos-detalles">
                    <div class="detalle">
                        <span class="valor"><?php echo esc_html(number_format_i18n($resumen_puntos['total_ganados'])); ?></span>
                        <span class="label"><?php esc_html_e('Total ganados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="detalle">
                        <span class="valor"><?php echo esc_html(number_format_i18n($resumen_puntos['canjeados'])); ?></span>
                        <span class="label"><?php esc_html_e('Canjeados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="ranking-section">
                <h3><?php esc_html_e('Tu Posicion en el Ranking', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="ranking-card">
                    <div class="ranking-posicion">
                        <span class="posicion-numero">#<?php echo esc_html($ranking_usuario['posicion']); ?></span>
                        <span class="posicion-label"><?php esc_html_e('de', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> <?php echo esc_html($ranking_usuario['total_participantes']); ?></span>
                    </div>
                    <div class="ranking-progreso">
                        ...
                        <span class="progreso-texto">
                            <?php
                            printf(
                                esc_html__('Estas en el top %d%% de recicladores', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <div class="top-ranking">
                <h3><?php esc_html_e('Top 5 Recicladores', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            ...
            <div class="grafico-progreso">
                <h3><?php esc_html_e('Puntos por Mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    public function render_tab_recompensas() {
        ...
        <div class="flavor-dashboard-tab reciclaje-recompensas">
            <div class="tab-header">
                <h2><?php esc_html_e('Recompensas de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <p class="descripcion"><?php esc_html_e('Canjea tus puntos por increibles recompensas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            ...
            <div class="puntos-banner">
                ...
                <span class="puntos-texto">
                    <?php esc_html_e('Tienes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    <strong><?php echo esc_html(number_format_i18n($puntos_disponibles)); ?></strong>
                    <?php esc_html_e('puntos disponibles para canjear', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
            </div>

            <!-- Recompensas disponibles -->
            <div class="recompensas-disponibles">
                <h3><?php esc_html_e('Recompensas Disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                                ...
                                <div class="recompensa-contenido">
                                    ...
                                    <div class="recompensa-footer">
                                        <span class="recompensa-puntos">
                                            ...
                                            <?php echo esc_html(number_format_i18n($puntos_necesarios)); ?> <?php esc_html_e('puntos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                        </span>
                                        ...
                                        <?php else: ?>
                                            <span class="puntos-faltantes">
                                                ...
                                                printf(esc_html__('Faltan %s pts', FLAVOR_PLATFORM_TEXT_DOMAIN), number_format_i18n($faltantes));
                                                ?>
                                            </span>
                                        <?php endif; ?>
                                    </div>
                ...
                <?php else: ?>
                    <div class="empty-state">
                        <span class="dashicons dashicons-awards"></span>
                        <p><?php esc_html_e('No hay recompensas disponibles en este momento.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="historial-canjes">
                <h3><?php esc_html_e('Mis Canjes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                ...
                <?php else: ?>
                    <p class="sin-canjes"><?php esc_html_e('Aun no has realizado ningun canje.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                <?php endif; ?>
            </div>
        </div>
        <?php
    ...
    public function render_tab_estadisticas() {
        ...
        <div class="flavor-dashboard-tab reciclaje-estadisticas">
            <div class="tab-header">
                <h2><?php esc_html_e('Mi Impacto Ambiental', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <p class="descripcion"><?php esc_html_e('Descubre el impacto positivo de tu reciclaje en el medio ambiente', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            ...
            <div class="impacto-hero">
                <div class="impacto-total">
                    ...
                    <span class="impacto-label"><?php esc_html_e('Total reciclado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>

            <!-- Metricas de impacto -->
            <div class="impacto-metricas">
                <h3><?php esc_html_e('Tu Contribucion Equivale A', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="metricas-grid">
                    <div class="metrica-card">
                        ...
                        <span class="metrica-label"><?php esc_html_e('Arboles salvados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="metrica-card">
                        <span class="metrica-icono">&#128167;</span>
                        <span class="metrica-valor"><?php echo esc_html(number_format_i18n($impacto['litros_agua_ahorrados'])); ?></span>
                        <span class="metrica-label"><?php esc_html_e('Litros de agua ahorrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="metrica-card">
                        <span class="metrica-icono">&#9889;</span>
                        <span class="metrica-valor"><?php echo esc_html(number_format_i18n($impacto['energia_kwh'], 1)); ?></span>
                        <span class="metrica-label"><?php esc_html_e('kWh de energia ahorrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="metrica-card">
                        <span class="metrica-icono">&#127757;</span>
                        <span class="metrica-valor"><?php echo esc_html(number_format_i18n($impacto['co2_evitado'], 1)); ?></span>
                        <span class="metrica-label"><?php esc_html_e('kg CO2 evitados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="desglose-materiales">
                <h3><?php esc_html_e('Desglose por Material', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                            ...
                            <div class="material-item">
                                <div class="material-info">
                                    ...
                                    <span class="material-stats">
                                        ...
                                        (<?php echo esc_html($material['num_depositos']); ?> <?php esc_html_e('depositos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>)
                                    </span>
                                </div>
                ...
                <?php else: ?>
                    <p class="sin-datos"><?php esc_html_e('Aun no tienes depositos verificados.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                <?php endif; ?>
            </div>

            <!-- Comparativa con la comunidad -->
            <div class="comparativa-comunidad">
                <h3><?php esc_html_e('Comparativa con la Comunidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="comparativa-grid">
                    <div class="comparativa-item">
                        <span class="comparativa-label"><?php esc_html_e('Tu promedio mensual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        <span class="comparativa-valor tu-valor"><?php echo esc_html(number_format_i18n($comparativa['promedio_usuario'], 2)); ?> kg</span>
                    </div>
                    <div class="comparativa-item">
                        <span class="comparativa-label"><?php esc_html_e('Promedio comunidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    ...
                    <div class="comparativa-item destacado">
                        ...
                        ?>
                        <span class="comparativa-label"><?php esc_html_e('Tu rendimiento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="evolucion-anual">
                <h3><?php esc_html_e('Tu Evolucion Anual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
    ...
    private function obtener_badges_usuario($usuario_id) {
        ...
        if ($estadisticas->total_depositos >= 1) {
            $badges[] = [
                'nombre'      => __('Iniciado', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#127793;',
                'descripcion' => __('Primer deposito realizado', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'clase'       => 'badge-bronce',
            ];
        }
        ...
        if ($estadisticas->total_depositos >= 10) {
            $badges[] = [
                'nombre'      => __('Constante', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#127942;',
                'descripcion' => __('10 depositos realizados', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'clase'       => 'badge-plata',
            ];
        }
        ...
        if ($estadisticas->total_depositos >= 50) {
            $badges[] = [
                'nombre'      => __('Experto', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#127941;',
                'descripcion' => __('50 depositos realizados', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'clase'       => 'badge-oro',
            ];
        }
        ...
        if ($estadisticas->total_kg >= 100) {
            $badges[] = [
                'nombre'      => __('Eco Guerrero', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#127795;',
                'descripcion' => __('100 kg reciclados', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'clase'       => 'badge-verde',
            ];
        }
        ...
        if ($estadisticas->tipos_diferentes >= 5) {
            $badges[] = [
                'nombre'      => __('Diversificado', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#127752;',
                'descripcion' => __('5 tipos de materiales diferentes', FLAVOR_PLATFORM_TEXT_DOMAIN),
        ...
        if ($estadisticas->total_puntos >= 1000) {
            $badges[] = [
                'nombre'      => __('Mil Puntos', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'icono'       => '&#11088;',
                'descripcion' => __('1000 puntos acumulados', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    private function obtener_canjes_usuario($usuario_id) {
        ...
        foreach ($canjes_guardados as $canje) {
            ...
            if (!$titulo_recompensa) {
                $titulo_recompensa = __('Recompensa eliminada', FLAVOR_PLATFORM_TEXT_DOMAIN);
            }
            $canjes_con_titulo[] = [
    ...
    public function ajax_load_tab_content() {
        ...
        switch ($tab_solicitada) {
            ...
            case 'reciclaje-estadisticas':
                ...
                break;
            default:
                wp_send_json_error(['message' => __('Tab no valida', FLAVOR_PLATFORM_TEXT_DOMAIN)]);
                return;
        }
