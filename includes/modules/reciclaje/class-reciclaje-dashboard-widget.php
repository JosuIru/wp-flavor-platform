...
class Flavor_Reciclaje_Dashboard_Widget extends Flavor_Dashboard_Widget_Base {
    ...
    public function __construct() {
        ...
        $this->title = __('Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN);
        $this->description = __('Puntos de reciclaje y recogidas', FLAVOR_PLATFORM_TEXT_DOMAIN);
    ...
    private function fetch_widget_data(int $user_id): array {
        ...
        if ($proxima_recogida) {
            ...
            $stats[] = [
                ...
                'label' => $proxima_recogida->tipo ?: __('Próx. recogida', FLAVOR_PLATFORM_TEXT_DOMAIN),
                'color' => 'warning',
        ...
        return [
            'stats' => $stats,
            'items' => $items,
            'empty_state' => __('No hay puntos de reciclaje registrados', FLAVOR_PLATFORM_TEXT_DOMAIN),
            'footer' => [
                [
