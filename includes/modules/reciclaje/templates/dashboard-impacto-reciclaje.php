...
<div class="rec-dashboard">
    <div class="rec-dashboard__header">
        ...
        <div>
            <h3><?php esc_html_e('Dashboard de Impacto', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <p><?php esc_html_e('Impacto ambiental colectivo de nuestra comunidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    </div>
    ...
    <div class="rec-dashboard__metricas">
        <div class="rec-dashboard__metrica rec-dashboard__metrica--principal">
            ...
            <div class="rec-dashboard__metrica-content">
                ...
                <span class="rec-dashboard__metrica-label"><?php esc_html_e('kg CO₂ ahorrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
        ...
        <div class="rec-dashboard__metricas-grid">
            <div class="rec-dashboard__metrica">
                ...
                <span class="rec-dashboard__metrica-label"><?php esc_html_e('kg reciclados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-dashboard__metrica">
                ...
                <span class="rec-dashboard__metrica-label"><?php esc_html_e('reutilizados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-dashboard__metrica">
                ...
                <span class="rec-dashboard__metrica-label"><?php esc_html_e('reparados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-dashboard__metrica">
                ...
                <span class="rec-dashboard__metrica-label"><?php esc_html_e('participantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="rec-dashboard__equivalencias">
        <h4><?php esc_html_e('Nuestro impacto equivale a...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <div class="rec-dashboard__equiv-grid">
            ...
            <div class="rec-dashboard__equiv-item">
                ...
                <span class="rec-dashboard__equiv-label"><?php esc_html_e('árboles plantados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-dashboard__equiv-item">
                <span class="rec-dashboard__equiv-icono">🚗</span>
                <span class="rec-dashboard__equiv-valor"><?php echo esc_html(number_format($km_coche, 0)); ?></span>
                <span class="rec-dashboard__equiv-label"><?php esc_html_e('km no recorridos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-dashboard__equiv-item">
                <span class="rec-dashboard__equiv-icono">💧</span>
                <span class="rec-dashboard__equiv-valor"><?php echo esc_html(number_format($litros_agua, 0)); ?></span>
                <span class="rec-dashboard__equiv-label"><?php esc_html_e('litros agua ahorrados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
    </div>
    ...
    <?php if (!empty($por_tipo)): ?>
        <div class="rec-dashboard__tipos">
            <h4><?php esc_html_e('Reciclaje por tipo de material', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    <?php if (!empty($tendencias)): ?>
        <div class="rec-dashboard__tendencias">
            <h4><?php esc_html_e('Evolución mensual', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    <?php if (!empty($top_recicladores)): ?>
        <div class="rec-dashboard__ranking">
            <h4><?php esc_html_e('Top Eco-ciudadanos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
    ...
    <div class="rec-dashboard__objetivos">
        <h4><?php esc_html_e('Objetivos comunitarios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <?php
        $objetivos = [
            ['meta' => 10000, 'actual' => $metricas_globales->co2_total_ahorrado ?? 0, 'label' => __('10.000 kg CO₂ ahorrados', FLAVOR_PLATFORM_TEXT_DOMAIN)],
            ['meta' => 100, 'actual' => $metricas_globales->participantes_activos ?? 0, 'label' => __('100 participantes activos', FLAVOR_PLATFORM_TEXT_DOMAIN)],
            ['meta' => 500, 'actual' => ($metricas_globales->items_reutilizados ?? 0) + ($metricas_globales->items_reparados ?? 0), 'label' => __('500 objetos salvados', FLAVOR_PLATFORM_TEXT_DOMAIN)],
        ];
    ...
    <div class="rec-dashboard__cta">
        ...
        <p><?php esc_html_e('¡Cada pequeña acción cuenta! Únete a nuestra comunidad sostenible.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </div>
</div>
<style>
