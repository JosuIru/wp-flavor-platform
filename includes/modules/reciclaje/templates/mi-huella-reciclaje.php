...
<div class="rec-huella">
    <div class="rec-huella__header">
        ...
        <div class="rec-huella__info">
            ...
            <span class="rec-huella__titulo"><?php esc_html_e('Eco-ciudadano', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
    </div>
    ...
    <div class="rec-huella__stats">
        <div class="rec-huella__stat">
            ...
            <span class="rec-huella__stat-label"><?php esc_html_e('kg reciclados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="rec-huella__stat">
            ...
            <span class="rec-huella__stat-label"><?php esc_html_e('reutilizados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="rec-huella__stat">
            ...
            <span class="rec-huella__stat-label"><?php esc_html_e('reparados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
    </div>

    <!-- Desglose CO2 -->
    <div class="rec-huella__desglose">
        <h4><?php esc_html_e('Desglose de ahorro', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <div class="rec-huella__desglose-items">
            <div class="rec-huella__desglose-item">
                <span class="rec-huella__desglose-label"><?php esc_html_e('Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="rec-huella__desglose-item">
                <span class="rec-huella__desglose-label"><?php esc_html_e('Reutilización', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                <div class="rec-huella__desglose-bar">
            ...
            <div class="rec-huella__desglose-item">
                <span class="rec-huella__desglose-label"><?php esc_html_e('Reparación', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                <div class="rec-huella__desglose-bar">
    ...
    <div class="rec-huella__equivalencias">
        <h4><?php esc_html_e('Tu impacto equivale a...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
        <div class="rec-huella__equiv-grid">
            <div class="rec-huella__equiv-item">
                ...
                <span class="rec-huella__equiv-label"><?php esc_html_e('árboles/año', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="rec-huella__equiv-item">
                <span class="dashicons dashicons-car"></span>
                <span class="rec-huella__equiv-valor"><?php echo esc_html(number_format($km_coche, 0)); ?></span>
                <span class="rec-huella__equiv-label"><?php esc_html_e('km no recorridos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
        </div>
    </div>
    ...
    <?php if ($totales): ?>
        <div class="rec-huella__totales">
            <h4><?php esc_html_e('Acumulado histórico', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
            <div class="rec-huella__totales-grid">
                <div class="rec-huella__total-item">
                    ...
                    <span class="rec-huella__total-label"><?php esc_html_e('kg CO₂ total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="rec-huella__total-item">
                    <span class="rec-huella__total-valor"><?php echo esc_html(number_format($totales->kg_total ?? 0, 0)); ?></span>
                    <span class="rec-huella__total-label"><?php esc_html_e('kg reciclados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="rec-huella__total-item">
                    <span class="rec-huella__total-valor"><?php echo esc_html($totales->items_reut ?? 0); ?></span>
                    <span class="rec-huella__total-label"><?php esc_html_e('items reutil.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
        </div>
    <?php endif; ?>
