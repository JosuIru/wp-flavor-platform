...
if (!is_user_logged_in()) {
    ...
    echo '<h3>' . esc_html__('Inicia sesión para ver tus puntos', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</h3>';
...
<div class="reciclaje-mis-puntos-wrapper">
    ...
    <div class="puntos-hero-card">
        <div class="puntos-hero-content">
            ...
            <div class="puntos-valor">
                ...
                <span class="puntos-label"><?php esc_html_e('puntos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            ...
            <?php else: ?>
                <div class="nivel-max"><?php esc_html_e('¡Nivel máximo alcanzado!', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="impacto-grid">
        <div class="impacto-card">
            ...
            <span class="impacto-label"><?php esc_html_e('Reciclado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="impacto-card">
            <span class="impacto-icono">🌿</span>
            <span class="impacto-valor"><?php echo esc_html(number_format($stats['co2_evitado'], 1)); ?> kg</span>
            <span class="impacto-label"><?php esc_html_e('CO₂ evitado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
        <div class="impacto-card">
            <span class="impacto-icono">📦</span>
            <span class="impacto-valor"><?php echo esc_html($stats['depositos']); ?></span>
            <span class="impacto-label"><?php esc_html_e('Depósitos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </div>
    </div>
    ...
    <div class="reciclaje-acciones">
        ...
        <a href="<?php echo esc_url(add_query_arg('vista', 'recompensas', get_permalink())); ?>" class="btn btn-outline">
            ...
            <?php esc_html_e('Canjear puntos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </a>
    </div>

    <!-- Historial -->
    <div class="historial-section">
        <h3><?php esc_html_e('Historial de puntos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <?php if ($historial): ?>
            <div class="historial-lista">
                <?php foreach ($historial as $item): ?>
                    <div class="historial-item">
                        <div class="historial-info">
                            <span class="historial-concepto"><?php echo esc_html($item->concepto ?? __('Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN)); ?></span>
        ...
        <?php else: ?>
            <div class="historial-empty">
                <p><?php esc_html_e('Aún no tienes movimientos de puntos.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        <?php endif; ?>
    </div>
</div>
