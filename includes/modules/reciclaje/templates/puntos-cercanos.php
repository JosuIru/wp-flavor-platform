...
$tipos_contenedores = [
    'papel' => ['nombre' => __('Papel y cartón', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#3b82f6', 'icono' => '📄'],
    'vidrio' => ['nombre' => __('Vidrio', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#22c55e', 'icono' => '🫙'],
    'plastico' => ['nombre' => __('Plástico y envases', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#fbbf24', 'icono' => '🧴'],
    'organico' => ['nombre' => __('Orgánico', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#92400e', 'icono' => '🍃'],
    'textil' => ['nombre' => __('Textil', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#8b5cf6', 'icono' => '👕'],
    'aceite' => ['nombre' => __('Aceite usado', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#f59e0b', 'icono' => '🛢️'],
    'pilas' => ['nombre' => __('Pilas y baterías', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#ef4444', 'icono' => '🔋'],
    'electronico' => ['nombre' => __('Electrónico', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#6366f1', 'icono' => '💻'],
    'punto_limpio' => ['nombre' => __('Punto limpio', FLAVOR_PLATFORM_TEXT_DOMAIN), 'color' => '#10b981', 'icono' => '♻️'],
];
...
<div class="reciclaje-puntos-wrapper">
    <div class="puntos-header">
        ...
        <p><?php esc_html_e('Encuentra el contenedor más cercano para reciclar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
    </div>
    ...
    <div class="puntos-lista">
        <h3><?php esc_html_e('Puntos disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                ...
                <div class="punto-card">
                    ...
                    <div class="punto-acciones">
                        <button class="btn btn-sm btn-outline" onclick="abrirMapa(<?php echo esc_attr($punto->latitud ?? 0); ?>, <?php echo esc_attr($punto->longitud ?? 0); ?>)">
                            ...
                            <?php esc_html_e('Cómo llegar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </button>
                    </div>
                </div>
            <?php endforeach; ?>
    ...
    <div class="reciclaje-guia-rapida">
        <h3><?php esc_html_e('¿Qué va en cada contenedor?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        <div class="guia-grid">
        ...
        <a href="<?php echo esc_url(add_query_arg('vista', 'guia', get_permalink())); ?>" class="ver-guia-completa">
            <?php esc_html_e('Ver guía completa de reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?> →
        </a>
    </div>
</div>
