...
<div class="rec-retos" data-nonce="<?php echo esc_attr($nonce); ?>">
    <div class="rec-retos__header">
        ...
        <div>
            <h3><?php esc_html_e('Retos Comunitarios', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <p><?php esc_html_e('Únete a retos colectivos de reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    </div>
    ...
    <?php if (empty($retos)): ?>
        <div class="rec-retos__vacio">
            ...
            <p><?php esc_html_e('No hay retos activos en este momento.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    <?php else: ?>
                ...
                <div class="rec-retos__reto <?php echo $participo ? 'rec-retos__reto--participando' : ''; ?>" data-id="<?php echo esc_attr($reto->id); ?>">
                    <div class="rec-retos__reto-header">
                        ...
                        <div class="rec-retos__reto-info">
                            ...
                            <span class="rec-retos__participantes">
                                ...
                                <?php printf(esc_html__('%d participantes', FLAVOR_PLATFORM_TEXT_DOMAIN), $reto->total_participantes); ?>
                            </span>
                        </div>
                        <div class="rec-retos__dias">
                            <span class="rec-retos__dias-valor"><?php echo esc_html($dias_restantes); ?></span>
                            <span class="rec-retos__dias-label"><?php esc_html_e('días', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="rec-retos__progreso">
                        <div class="rec-retos__progreso-header">
                            <span><?php printf(esc_html__('Progreso: %s de %s %s', FLAVOR_PLATFORM_TEXT_DOMAIN),
                    ...
                    <div class="rec-retos__reto-footer">
                        ...
                        <?php if ($participo): ?>
                            <span class="rec-retos__participando-badge">
                                ...
                                <?php esc_html_e('Participando', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                            </span>
    ...
    <div class="rec-retos__tipos">
        <h4><?php esc_html_e('Tipos de retos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h4>
