...
<div class="dm-dashboard">
    ...
    <div class="dm-header">
        <h1 class="dm-header__title">
            ...
            <?php esc_html_e('Dashboard de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </h1>
        <p class="dm-header__description">
            <?php esc_html_e('Gestiona puntos de reciclaje, monitoriza depósitos y mide el impacto ambiental', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
        </p>
    </div>
    ...
    <div class="dm-alert dm-alert--info">
        ...
        <?php esc_html_e('Faltan tablas del módulo Reciclaje o todavía no hay actividad registrada.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
    </div>
    <?php endif; ?>
    ...
    <div class="dm-stats-grid dm-stats-grid--4">
        <div class="dm-stat-card dm-stat-card--primary">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Puntos de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="dm-stat-card dm-stat-card--success">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Reciclado este Mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="dm-stat-card dm-stat-card--info">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Depósitos este Mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
        ...
        <div class="dm-stat-card dm-stat-card--warning">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Contenedores Llenos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        </div>
    </div>
    ...
    <div class="dm-grid dm-grid--2">
        ...
        <div class="dm-card dm-card--chart" style="grid-column: span 2;">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-chart-area"></span> <?php esc_html_e('Evolución de Reciclaje', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        ...
        <div class="dm-card dm-card--chart">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-chart-pie"></span> <?php esc_html_e('Reciclaje por Material', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            <div class="dm-card__chart">
        ...
        <div class="dm-card">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-awards"></span> <?php esc_html_e('Usuarios Más Activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                    ...
                    <div class="dm-ranking__content">
                        ...
                        <div class="dm-ranking__info">
                            ...
                            <span class="dm-text-muted dm-text-sm">
                                <?php echo sprintf(
                                    esc_html__('%s kg · %s puntos', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <div class="dm-empty">
                <span class="dashicons dashicons-groups"></span>
                <p><?php esc_html_e('No hay datos de usuarios activos este mes.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="dm-card">
            <div class="dm-card__header">
                <h3><span class="dashicons dashicons-warning"></span> <?php esc_html_e('Puntos que Necesitan Atención', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
                    ...
                    <div class="dm-focus-list__content">
                        ...
                        <span class="dm-text-sm">
                            ...
                            if ($punto->estado === 'lleno') {
                                esc_html_e('Punto lleno', FLAVOR_PLATFORM_TEXT_DOMAIN);
                            } elseif ($punto->estado === 'mantenimiento') {
                                esc_html_e('En mantenimiento', FLAVOR_PLATFORM_TEXT_DOMAIN);
                            }
                            if ($punto->contenedores_problema > 0) {
                                echo ' · ' . sprintf(
                                    esc_html__('%d contenedores necesitan vaciado', FLAVOR_PLATFORM_TEXT_DOMAIN),
            ...
            <div class="dm-alert dm-alert--success" style="margin: 20px;">
                ...
                <?php esc_html_e('Todos los puntos están operativos.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="dm-card dm-stat-card--highlight" style="--dm-stat-gradient: linear-gradient(135deg, var(--dm-eco, #10b981) 0%, #059669 100%);">
            <div class="dm-card__header" style="border-bottom-color: rgba(255,255,255,0.2);">
                <h3 style="color: white;"><span class="dashicons dashicons-admin-site"></span> <?php esc_html_e('Impacto Ambiental', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <span class="dm-card__meta" style="color: rgba(255,255,255,0.9);"><?php esc_html_e('Este mes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            <div class="dm-impact-grid" style="padding: 20px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; color: white;">
                <div class="dm-impact-item" style="text-align: center;">
                    ...
                    <div style="font-size: 13px; opacity: 0.9;"><?php esc_html_e('CO₂ evitado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                <div class="dm-impact-item" style="text-align: center;">
                    ...
                    <div style="font-size: 13px; opacity: 0.9;"><?php esc_html_e('Árboles equivalentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
                <div class="dm-impact-item" style="text-align: center;">
                    ...
                    <div style="font-size: 13px; opacity: 0.9;"><?php esc_html_e('Agua ahorrada', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
                </div>
            </div>
        </div>
    </div>
