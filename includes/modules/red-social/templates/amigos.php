            ...
            <?php if (empty($usuarios_lista)): ?>
                <div class="rs-amigos-vacio">
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($es_perfil_propio): ?>
                            <a href="?page=explorar" class="rs-btn-primary"><?php echo esc_html__('Explorar usuarios', 'flavor-chat-ia'); ?></a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php else: ?>
                <?php foreach ($usuarios_lista as $usuario_item): ?>
                    ...
                    <div class="rs-amigo-card" data-usuario-id="<?php echo esc_attr($usuario_item->ID); ?>">
                        <a href="?rs_perfil=<?php echo esc_attr($usuario_item->ID); ?>" class="rs-amigo-link">
