...
if (!$usuario_id) {
    ...
    echo '<a href="' . esc_url(wp_login_url(Flavor_Platform_Helpers::get_action_url('red_social', 'mi-actividad'))) . '" class="rs-btn-primary">' . esc_html__('Iniciar sesion', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</a>';
    echo '</div>';
    return;
}
                        ...
                        <?php foreach ($actividades as $actividad): ?>
                            <div class="rs-actividad-item rs-actividad-<?php echo esc_attr($actividad->tipo_actividad); ?>">
                                ...
                                <?php if ($actividad->tipo_actividad !== 'seguir'): ?>
                                    <a href="<?php echo esc_url(add_query_arg('publicacion_id', intval($actividad->referencia_id), Flavor_Platform_Helpers::get_action_url('red_social', ''))); ?>" class="rs-actividad-ver">
                                        <?php echo esc_html__('Ver', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo esc_url(add_query_arg('usuario_id', intval($actividad->referencia_id), Flavor_Platform_Helpers::get_action_url('red_social', 'perfil'))); ?>" class="rs-actividad-ver">
