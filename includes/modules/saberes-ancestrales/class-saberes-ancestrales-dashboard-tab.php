...
class Flavor_Saberes_Ancestrales_Dashboard_Tab {
    ...
    public function render_tab_resumen() {
        ...
        <div class="flavor-panel flavor-saberes-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-book-alt"></span> <?php esc_html_e('Saberes Ancestrales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <p class="flavor-panel-subtitle"><?php esc_html_e('Preservando la sabiduría de nuestros ancestros', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            ...
            <div class="flavor-panel-kpis">
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Saberes Documentados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Mis Aportes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Transmisiones Activas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Categorías', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>

            <div class="flavor-panel-section">
                <h3><?php esc_html_e('Áreas de Sabiduría', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="flavor-areas-grid">
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-carrot"></span>
                        <span><?php esc_html_e('Agricultura tradicional', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-heart"></span>
                        <span><?php esc_html_e('Medicina natural', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-art"></span>
                        <span><?php esc_html_e('Artesanías', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-microphone"></span>
                        <span><?php esc_html_e('Tradición oral', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-food"></span>
                        <span><?php esc_html_e('Gastronomía ancestral', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                    <div class="flavor-area-item">
                        <span class="dashicons dashicons-star-filled"></span>
                        <span><?php esc_html_e('Rituales y ceremonias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="flavor-panel-actions">
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('saberes_ancestrales', 'explorar')); ?>" class="flavor-btn flavor-btn-primary">
                    ...
                    <?php esc_html_e('Explorar Saberes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('saberes_ancestrales', 'compartir')); ?>" class="flavor-btn flavor-btn-secondary">
                    ...
                    <?php esc_html_e('Compartir un Saber', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('saberes_ancestrales', 'transmisiones')); ?>" class="flavor-btn flavor-btn-outline">
                    ...
                    <?php esc_html_e('Transmisiones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
            </div>
        </div>
        <?php
    ...
    public function render_tab_aportes() {
        ...
        <div class="flavor-panel flavor-aportes-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-edit"></span> <?php esc_html_e('Mis Aportes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h2>
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('saberes_ancestrales', 'compartir')); ?>" class="flavor-btn flavor-btn-primary flavor-btn-sm">
                    ...
                    <?php esc_html_e('Compartir Saber', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </a>
            </div>
            ...
            <?php if (empty($mis_saberes)): ?>
                <div class="flavor-empty-state">
                    ...
                    <p><?php esc_html_e('Aún no has compartido ningún saber ancestral.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <p class="flavor-text-muted"><?php esc_html_e('Tu conocimiento es valioso. Compártelo con la comunidad para que perdure.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                    <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('saberes_ancestrales', 'compartir')); ?>" class="flavor-btn flavor-btn-primary">
                        <?php esc_html_e('Compartir mi primer saber', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                </div>
            <?php else: ?>
