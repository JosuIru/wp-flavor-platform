...
<div class="dm-dashboard">
    ...
    <?php if (!$tablas_disponibles): ?>
        <div class="dm-alert dm-alert--info">
            ...
            <p><?php esc_html_e('Faltan tablas del módulo Talleres o aún no hay inscripciones registradas.', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        </div>
    <?php endif; ?>
    ...
    <div class="dm-header">
        <div class="dm-header__title">
            ...
            <h1><?php esc_html_e('Dashboard - Talleres Prácticos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h1>
        </div>
    </div>
    ...
    <div class="dm-quick-links">
        ...
        <a href="<?php echo esc_url(home_url('/mi-portal/talleres/')); ?>" class="dm-quick-links__item" target="_blank">
    ...
    <div class="dm-stats-grid dm-stats-grid--3">
        <div class="dm-stat-card dm-stat-card--primary">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Total Talleres', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div class="dm-stat-card dm-stat-card--success">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Talleres Activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div class="dm-stat-card dm-stat-card--warning">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Próximos Talleres', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
        ...
        <div class="dm-stat-card dm-stat-card--info">
            ...
            <div class="dm-stat-card__label"><?php esc_html_e('Inscripciones (mes)', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
    ...
    <div class="dm-grid dm-grid--2">
        ...
        <div class="dm-card">
            <div class="dm-card__header">
                <h3><?php esc_html_e('Talleres Más Populares', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            </div>
            <table class="dm-table">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Taller', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                        <th><?php esc_html_e('Inscritos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="2">
                                <div class="dm-empty">
                                    <span class="dashicons dashicons-hammer"></span>
                                    <p><?php esc_html_e('No hay talleres disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                </div>
                            </td>
                        </tr>
                    <?php endif; ?>
    ...
    <div class="dm-card">
        <div class="dm-card__header">
            <h3><?php esc_html_e('Próximos Talleres', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
        </div>
        <table class="dm-table">
            <thead>
                <tr>
                    <th><?php esc_html_e('Taller', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    <th><?php esc_html_e('Organizador', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></th>
                    ...
                    <tr>
                        <td colspan="5">
                            <div class="dm-empty">
                                ...
                                <p><?php esc_html_e('No hay talleres próximos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
