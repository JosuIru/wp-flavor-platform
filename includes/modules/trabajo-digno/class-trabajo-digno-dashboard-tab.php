...
class Flavor_Trabajo_Digno_Dashboard_Tab {
    ...
    public function registrar_tabs($tabs) {
        ...
        $tabs['trabajo-digno-ofertas'] = [
            'label' => __('Bolsa de Empleo', 'flavor-chat-ia'),
            'icon' => 'clipboard-list',
    ...
    public function render_tab_resumen() {
        ...
        <div class="flavor-panel flavor-trabajo-digno-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-businessman"></span> <?php esc_html_e('Trabajo Digno', 'flavor-chat-ia'); ?></h2>
                <p class="flavor-panel-subtitle"><?php esc_html_e('Empleo justo, equitativo y sostenible', 'flavor-chat-ia'); ?></p>
            </div>
            ...
            <div class="flavor-panel-kpis">
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Ofertas Activas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Mis Candidaturas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Cooperativas', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
                <div class="flavor-kpi-card flavor-kpi-success">
                    ...
                    <div class="flavor-kpi-content">
                        ...
                        <span class="flavor-kpi-label"><?php esc_html_e('Empleos Creados', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
            </div>

            <div class="flavor-panel-section">
                <h3><?php esc_html_e('Criterios de Trabajo Digno', 'flavor-chat-ia'); ?></h3>
                <div class="flavor-criteria-list">
                    <div class="flavor-criteria-item">
                        <span class="dashicons dashicons-money-alt"></span>
                        <span><?php esc_html_e('Salario justo y transparente', 'flavor-chat-ia'); ?></span>
                    </div>
                    <div class="flavor-criteria-item">
                        <span class="dashicons dashicons-clock"></span>
                        <span><?php esc_html_e('Horarios que respetan la vida personal', 'flavor-chat-ia'); ?></span>
                    </div>
                    <div class="flavor-criteria-item">
                        <span class="dashicons dashicons-universal-access"></span>
                        <span><?php esc_html_e('Igualdad y no discriminación', 'flavor-chat-ia'); ?></span>
                    </div>
                    <div class="flavor-criteria-item">
                        <span class="dashicons dashicons-shield"></span>
                        <span><?php esc_html_e('Seguridad y derechos laborales', 'flavor-chat-ia'); ?></span>
                    </div>
                </div>
            </div>
    ...
    public function render_tab_ofertas() {
        ...
        <div class="flavor-panel flavor-ofertas-panel">
            <div class="flavor-panel-header">
                <h2><span class="dashicons dashicons-megaphone"></span> <?php esc_html_e('Bolsa de Empleo Digno', 'flavor-chat-ia'); ?></h2>
            </div>

            <?php if (empty($ofertas)): ?>
                <div class="flavor-empty-state">
                    <span class="dashicons dashicons-megaphone"></span>
                    <p><?php esc_html_e('No hay ofertas de trabajo activas en este momento.', 'flavor-chat-ia'); ?></p>
                </div>
            <?php else: ?>
                        ...
                        <div class="flavor-card flavor-oferta-card">
                            ...
                            <div class="flavor-card-body">
                                <p class="flavor-oferta-empresa">
                                    ...
                                    <?php echo esc_html($oferta->empresa ?? __('Empresa no especificada', 'flavor-chat-ia')); ?>
                                </p>
                                <p class="flavor-oferta-ubicacion">
                                    <span class="dashicons dashicons-location"></span>
                                    <?php echo esc_html($oferta->ubicacion ?? __('Ubicación no especificada', 'flavor-chat-ia')); ?>
                                </p>
                                <?php if (!empty($oferta->salario_min) || !empty($oferta->salario_max)): ?>
                                    <p class="flavor-oferta-salario">
                                        ...
                                        if ($oferta->salario_min && $oferta->salario_max) {
                                            ...
                                            echo esc_html__('Desde ', 'flavor-chat-ia') . number_format_i18n($oferta->salario_min) . ' €';
                                        }
                                        ?>
                                    </p>
                                <?php endif; ?>
                            ...
                            <div class="flavor-card-footer">
                                <span class="flavor-text-muted">
                                    <?php printf(
                                        esc_html__('Límite: %s', 'flavor-chat-ia'),
