...
class Flavor_Trading_IA_Frontend_Controller {
    ...
    public function shortcode_listado($atts) {
        ...
        echo '<p>' . __('Módulo Trading IA - Listado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
        return ob_get_clean();
    }
    ...
    public function registrar_tabs($tabs) {
        $tabs['trading-ia'] = [
            'titulo' => __('Trading IA', FLAVOR_PLATFORM_TEXT_DOMAIN),
    ...
    public function render_tab_principal() {
        ...
        echo '<h3>' . esc_html__('Trading IA', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</h3>';
        echo '<p>' . esc_html__('Contenido del tab de Trading IA.', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</p>';
        echo '</div>';
    }
}
