    ...
    public function get_delivery_status_html($mensaje) {
        ...
        switch ($status) {
            case self::DELIVERY_PENDING:
                return '<span class="delivery-status pending" title="' . esc_attr__('Enviando...', FLAVOR_PLATFORM_TEXT_DOMAIN) . '">
            ...
            case self::DELIVERY_SENT:
                return '<span class="delivery-status sent" title="' . esc_attr__('Enviado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '">
            ...
            case self::DELIVERY_DELIVERED:
                return '<span class="delivery-status delivered" title="' . esc_attr__('Entregado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '">
            ...
            case self::DELIVERY_READ:
                return '<span class="delivery-status read" title="' . esc_attr__('Leído', FLAVOR_PLATFORM_TEXT_DOMAIN) . '">
        ...
        $wpdb->query($wpdb->prepare(
            "UPDATE {$tabla}
             ...
             WHERE es_temporal = 1
               ...
               AND eliminado = 0",
            __('Este mensaje ha expirado', FLAVOR_PLATFORM_TEXT_DOMAIN),
            '<em class="mensaje-expirado">' . __('Este mensaje ha expirado', FLAVOR_PLATFORM_TEXT_DOMAIN) . '</em>'
        ));
    }
    ...
    public function enhance_message_output($mensaje, $context) {
        ...
        if (!empty($mensaje->es_temporal)) {
            $mensaje->es_temporal_html = '<span class="mensaje-temporal-badge" title="' .
                esc_attr__('Mensaje temporal', FLAVOR_PLATFORM_TEXT_DOMAIN) . '">⏱</span>';
        }
