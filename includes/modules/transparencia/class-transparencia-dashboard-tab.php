    ...
    public function render_tab_mis_solicitudes() {
        ...
        <div class="flavor-panel flavor-transparencia-panel">
            <div class="flavor-panel-header">
                ...
                <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('transparencia', 'nueva-solicitud')); ?>"
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('transparencia', 'solicitud') . '/' . $solicitud->id . '/'); ?>"
        ...
        <div class="flavor-panel flavor-transparencia-documentos">
            ...
            <?php if (empty($documentos)): ?>
                <div class="flavor-empty-state">
                    ...
                    <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('transparencia', '')); ?>"
                       class="flavor-btn flavor-btn-primary">
                        <span class="dashicons dashicons-visibility"></span>
                        ...
                        <div class="flavor-card flavor-doc-card" data-documento-id="<?php echo esc_attr($documento->id); ?>">
                            ...
                            <div class="flavor-card-footer">
                                ...
                                <div class="flavor-card-actions">
                                    <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('transparencia', 'documento') . '/' . $documento->id . '/'); ?>"
                                       class="flavor-btn flavor-btn-sm flavor-btn-outline">
                                        <span class="dashicons dashicons-visibility"></span>
