...
<div class="flavor-network-widget flavor-network-directory-widget" data-limite="<?php echo esc_attr($atts['limite']); ?>">
    <div class="fn-directory-filters">
        <input type="text" class="fn-search-input" placeholder="<?php esc_attr_e('Buscar comunidades, empresas...', 'flavor-chat-ia'); ?>">
        ...
        <button type="button" class="fn-search-btn"><?php _e('Buscar', 'flavor-chat-ia'); ?></button>
    </div>
    <div class="fn-directory-results">
        <div class="fn-loading"><?php _e('Cargando directorio...', 'flavor-chat-ia'); ?></div>
    </div>
</div>
