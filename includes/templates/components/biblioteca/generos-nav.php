    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav id="genresMenu" class="hidden md:block">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div class="flex flex-col md:flex-row gap-2 md:gap-1 flex-wrap">
                        <!-- Todos -->
                        <a href="#" class="group flex items-center px-4 py-2.5 md:py-2 rounded-lg bg-purple-600 text-white font-medium transition-all duration-300 hover:bg-purple-700 hover:shadow-md">
                        ...
                        <!-- Literatura -->
                        <a href="#" class="group flex items-center px-4 py-2.5 md:py-2 rounded-lg text-gray-700 font-medium transition-all duration-300 hover:bg-purple-50 hover:text-purple-700 hover:shadow-sm">
        ...
        <div class="border-t border-gray-100 py-3 hidden" id="secondaryCategories">
            <div class="flex flex-wrap gap-2">
                <a href="#" class="px-3 py-1.5 text-sm text-gray-600 bg-gray-50 rounded-full hover:bg-purple-50 hover:text-purple-600 transition-colors">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <div class="flex items-center text-sm text-gray-600">
            <a href="#" class="hover:text-purple-600 transition-colors">Inicio</a>
            <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
            <a href="#" class="hover:text-purple-600 transition-colors">Biblioteca</a>
            <svg class="w-4 h-4 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
