...
<section class="<?php echo esc_attr($component_classes ?? ''); ?> relative overflow-hidden" style="background: linear-gradient(135deg, <?php echo esc_attr($color); ?>, <?php echo esc_attr($color); ?>dd);">
    ...
    <div class="relative max-w-6xl mx-auto px-6 py-20 text-center text-white">
        ...
        <form action="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('grupos_consumo', 'buscar')); ?>" method="get" class="max-w-xl mx-auto">
        ...
        <div class="flex flex-wrap justify-center gap-4 mt-8">
            <a href="<?php echo esc_url(Flavor_Platform_Helpers::get_action_url('grupos_consumo', '')); ?>" class="bg-white text-green-700 px-8 py-3 rounded-xl font-semibold hover:bg-green-50 transition-colors">
                Ver Grupos
            </a>
