...
class _TrabajoDignoScreenState extends ConsumerState<TrabajoDignoScreen> {
  ...
  void _verMiPerfil() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Mi perfil profesional - proximamente')),
    );
  }

  void _verDetalle(Map<String, dynamic> oferta) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Detalle de ${oferta['titulo']} - proximamente')),
    );
  }

  void _aplicar(Map<String, dynamic> oferta) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Aplicando a ${oferta['titulo']}...')),
    );
  }
}
