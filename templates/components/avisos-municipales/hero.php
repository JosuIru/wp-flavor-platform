    ...
    <div class="flavor-container relative z-10 py-16 lg:py-24">
        <div class="max-w-4xl mx-auto text-center mb-12">
            ...
            <?php if ($avisos_urgentes > 0) : ?>
                <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style="background: rgba(255,255,255,0.2); backdrop-filter: blur(10px);">
                    ...
                    <span class="text-white text-sm font-medium">
                        <?php echo esc_html($avisos_urgentes); ?> <?php echo esc_html__('avisos urgentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </span>
                </div>
            <?php endif; ?>
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 ml-2" style="background: rgba(255,255,255,0.15); backdrop-filter: blur(10px);">
                ...
                <span class="text-white text-sm font-medium"><?php echo esc_html__('Canal Oficial', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </div>
            ...
            <div class="max-w-2xl mx-auto mb-10">
                <form class="flex flex-col sm:flex-row gap-3" method="get">
                    <div class="flex-1 relative">
                        ...
                        <input type="text" name="buscar_aviso" placeholder="<?php echo esc_attr__('Buscar avisos...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>" class="w-full pl-12 pr-4 py-4 rounded-xl bg-white/10 backdrop-blur text-white placeholder-white/60 border border-white/20 focus:outline-none focus:ring-2 focus:ring-white/30" />
                    </div>
        ...
        <div class="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
            <div class="text-center p-4 rounded-xl bg-white/10 backdrop-blur border border-white/20">
                ...
                <div class="text-sm text-white/70"><?php echo esc_html__('Avisos Activos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
            <div class="text-center p-4 rounded-xl bg-white/10 backdrop-blur border border-white/20">
                <div class="text-3xl font-bold text-white"><?php echo esc_html($avisos_urgentes); ?></div>
                <div class="text-sm text-white/70"><?php echo esc_html__('Urgentes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
            <div class="text-center p-4 rounded-xl bg-white/10 backdrop-blur border border-white/20">
                <div class="text-3xl font-bold text-white"><?php echo esc_html(number_format_i18n($avisos_leidos)); ?></div>
                <div class="text-sm text-white/70"><?php echo esc_html__('Lecturas Totales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></div>
            </div>
        </div>
    </div>
</section>
