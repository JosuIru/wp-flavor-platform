...
<section class="flavor-component flavor-section relative min-h-screen flex items-center" style="padding-top: 0; padding-bottom: 0;">
    ...
    <div class="flavor-container relative z-10 py-20">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="text-xl md:text-2xl mb-12" style="color: rgba(255,255,255,0.9);"><?php echo esc_html($subtitulo ?? 'Movilidad sostenible 24/7'); ?></p>

            <div class="grid grid-cols-3 gap-4 mb-8 max-w-2xl mx-auto">
                <div class="flavor-card text-center">
                    <div class="text-3xl font-bold mb-1" style="color: var(--flavor-primary);">24/7</div>
                    <div class="text-xs" style="color: var(--flavor-text-muted);">Disponible</div>
                </div>
                <div class="flavor-card text-center">
                    <div class="text-3xl font-bold mb-1" style="color: var(--flavor-primary);">€0</div>
                    <div class="text-xs" style="color: var(--flavor-text-muted);">Primera Hora</div>
                </div>
                <div class="flavor-card text-center">
                    <div class="text-3xl font-bold mb-1" style="color: var(--flavor-primary);">50+</div>
                    <div class="text-xs" style="color: var(--flavor-text-muted);">Estaciones</div>
                </div>
            </div>

            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#estaciones" class="flavor-button flavor-button-primary px-8">Encontrar Estación</a>
                <a href="#como-funciona" class="flavor-button px-8">Cómo Funciona</a>
            </div>
        </div>
    </div>
</section>
