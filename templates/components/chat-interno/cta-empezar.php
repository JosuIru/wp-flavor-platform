                        ...
                        <div class="w-full h-full bg-white p-4 pt-8 overflow-hidden">
                            ...
                            <div class="flex items-center gap-3 pb-3 border-b border-gray-100 mb-3">
                                <div class="w-8 h-8 rounded-full bg-rose-500 flex items-center justify-center">
                                    <span class="text-white text-xs font-bold"><?php echo esc_html__('MG', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold text-gray-800"><?php echo esc_html__('Mi Grupo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                    <p class="text-[10px] text-green-500"><?php echo esc_html__('3 en linea', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                </div>
                            </div>
                            <!-- Mensajes de ejemplo -->
                            <div class="space-y-2">
                                <div class="flex justify-start">
                                    <div class="max-w-[80%] px-3 py-2 rounded-xl rounded-tl-sm bg-gray-100">
                                        <p class="text-[10px] text-gray-700"><?php echo esc_html__('Hola a todos! Quedamos manana?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                    </div>
                                </div>
                                <div class="flex justify-end">
                                    <div class="max-w-[80%] px-3 py-2 rounded-xl rounded-tr-sm bg-rose-500">
                                        <p class="text-[10px] text-white"><?php echo esc_html__('Perfecto, yo me apunto!', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                    </div>
                                </div>
                                <div class="flex justify-start">
                                    <div class="max-w-[80%] px-3 py-2 rounded-xl rounded-tl-sm bg-gray-100">
                                        <p class="text-[10px] text-gray-700"><?php echo esc_html__('Genial! A las 18h?', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                    </div>
                                </div>
                                <div class="flex justify-end">
                                    <div class="max-w-[80%] px-3 py-2 rounded-xl rounded-tr-sm bg-rose-500">
                                        <p class="text-[10px] text-white"><?php echo esc_html__('Nos vemos alli', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Input de mensaje -->
                            <div class="absolute bottom-4 left-4 right-4">
                                <div class="flex items-center gap-2 px-3 py-2 rounded-full bg-gray-100 border border-gray-200">
                                    <span class="text-[10px] text-gray-400 flex-1"><?php echo esc_html__('Escribe un mensaje...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="flex-1 text-center lg:text-left order-1 lg:order-2">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                    <a href="<?php echo esc_url($url_comenzar); ?>" class="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-gradient-to-r from-rose-500 to-pink-600 text-white font-semibold text-lg hover:from-rose-600 hover:to-pink-700 transition-all shadow-lg hover:shadow-xl">
                        ...
                        <?php echo esc_html__('Comenzar Ahora', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                    <span class="text-sm text-gray-500">
                        <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        </svg>
                        <?php echo esc_html__('Cifrado de extremo a extremo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </span>
                </div>
            </div>
        </div>
