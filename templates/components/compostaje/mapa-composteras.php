...
<section class="py-20" style="background: linear-gradient(to bottom, #f5f3f0 0%, #e8e3db 100%);">
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-4xl mx-auto mb-8">
            <div class="bg-white rounded-xl shadow-lg p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: #2D5016;">Barrio</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: #2D5016;">Estado</label>
                        <select class="w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-green-700" style="border-color: #d4c5b9;">
                            <option>Todas</option>
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: #2D5016;">Tipo</label>
                        <select class="w-full px-4 py-3 border-2 rounded-lg focus:outline-none focus:border-green-700" style="border-color: #d4c5b9;">
                            <option>Todos los tipos</option>
                            <option>Compostadora comunitaria</option>
                            <option>Vermicompostadora</option>
                            <option>Punto de recogida</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="aspect-video relative" style="background: linear-gradient(135deg, #d4c5b9 0%, #a89f94 100%);">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center">
                                ...
                                <p class="text-lg font-semibold" style="color: #6B4423;">Mapa Interactivo</p>
                                <p class="text-sm" style="color: #57534e;">Aquí se mostrará el mapa con las ubicaciones</p>
                            </div>
                        </div>
            ...
            <div class="space-y-4">
                <h3 class="text-xl font-bold mb-4" style="color: #2D5016;">Composteras Cercanas</h3>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2" style="border-color: #16a34a;">
                    <div class="p-5">
                        <div class="flex items-start justify-between mb-3">
                            <h4 class="font-bold text-lg" style="color: #2D5016;">Plaza Mayor</h4>
                            <span class="px-3 py-1 text-xs font-semibold rounded-full" style="background: #dcfce7; color: #16a34a;">Activa</span>
                        </div>
                        <p class="text-sm mb-3" style="color: #57534e;">Calle Principal, 123</p>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2" style="border-color: #d97706;">
                    <div class="p-5">
                        <div class="flex items-start justify-between mb-3">
                            <h4 class="font-bold text-lg" style="color: #2D5016;">Parque Verde</h4>
                            <span class="px-3 py-1 text-xs font-semibold rounded-full" style="background: #fed7aa; color: #c2410c;">Llena</span>
                        </div>
                        <p class="text-sm mb-3" style="color: #57534e;">Av. del Parque, 45</p>
                        <div class="flex items-center gap-2 text-sm mb-2" style="color: #6B4423;">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span>62 vecinos activos</span>
                        </div>
                        <div class="flex items-center gap-2 text-sm" style="color: #dc2626;">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                            </svg>
                            <span>Capacidad: 95%</span>
                        </div>
                ...
                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-2" style="border-color: #16a34a;">
                    <div class="p-5">
                        <div class="flex items-start justify-between mb-3">
                            <h4 class="font-bold text-lg" style="color: #2D5016;">Huerto Urbano</h4>
                            <span class="px-3 py-1 text-xs font-semibold rounded-full" style="background: #dcfce7; color: #16a34a;">Activa</span>
                        </div>
                        <p class="text-sm mb-3" style="color: #57534e;">Calle Verde, 78</p>
                        <div class="flex items-center gap-2 text-sm mb-2" style="color: #6B4423;">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                            </svg>
                            <span>38 vecinos activos</span>
                        </div>
        ...
        <div class="mt-12 bg-white rounded-xl shadow-lg p-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h4 class="font-bold mb-2" style="color: #2D5016;">Horarios</h4>
                    <p class="text-sm" style="color: #57534e;">Depósito 24/7<br>Recogida de compost: Sábados 10-12h</p>
                </div>
                <div class="text-center">
                    ...
                    <h4 class="font-bold mb-2" style="color: #2D5016;">Normativa</h4>
                    <p class="text-sm" style="color: #57534e;">Consulta las normas<br>de uso y el reglamento</p>
                </div>
                <div class="text-center">
                    ...
                    <h4 class="font-bold mb-2" style="color: #2D5016;">Soporte</h4>
                    <p class="text-sm" style="color: #57534e;">¿Necesitas ayuda?<br>Contacta con el equipo</p>
                </div>
            </div>
        </div>
    </div>
