    ...
    <div class="flavor-container">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/20 text-violet-300 text-sm font-medium mb-6 border border-violet-500/30">
                ...
                <?php echo esc_html__('Web3 ready', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </span>
            ...
            <div class="mt-8 flex items-center justify-center gap-6 text-sm text-gray-500">
                <div class="flex items-center gap-1">
                    ...
                    <span><?php echo esc_html__('Contratos auditados', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="flex items-center gap-1">
                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                    </svg>
                    <span><?php echo esc_html__('Sin custodia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
                <div class="flex items-center gap-1">
                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                    </svg>
                    <span><?php echo esc_html__('Transacciones rapidas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>
        </div>
    </div>
