...
<section class="flavor-component flavor-section py-12 lg:py-20 bg-gray-50">
    <div class="flavor-container">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 text-lg max-w-2xl mx-auto"><?php echo esc_html__('Todo lo necesario para gestionar tu facturacion de forma profesional', 'flavor-chat-ia'); ?></p>
        </div>
