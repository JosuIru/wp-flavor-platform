...
$url = $tema['url'] ?? '#';
$autor = $tema['autor'] ?? __('Usuario', 'flavor-chat-ia');
        ...
        <div class="flex-1 min-w-0">
            <div class="flex items-center flex-wrap gap-2 mb-1">
                ...
                <span class="px-2 py-0.5 rounded text-xs font-bold bg-indigo-100 text-indigo-700">
                    📌 <?php echo esc_html__('Fijado', 'flavor-chat-ia'); ?>
                </span>
                <?php endif; ?>
                <?php if ($popular): ?>
                <span class="px-2 py-0.5 rounded text-xs font-bold bg-red-100 text-red-600">
                    🔥 <?php echo esc_html__('Popular', 'flavor-chat-ia'); ?>
                </span>
                <?php endif; ?>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                ...
                <span class="flex items-center gap-1">
                    👁️ <?php echo esc_html($vistas); ?> <?php echo esc_html__('vistas', 'flavor-chat-ia'); ?>
                </span>
