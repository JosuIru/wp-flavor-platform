        ...
        <div class="rounded-2xl overflow-hidden shadow-xl bg-white">
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 lg:px-8 pt-8 pb-6">
                ...
                <p class="text-green-100 text-sm">
                    <?php echo esc_html__('Grupo Centro - Próxima entrega', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </p>
            </div>
            ...
            <div class="p-6 lg:p-8 space-y-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                    <?php echo esc_html__('Cierre del pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </p>
                                ...
                                <p class="text-sm text-gray-600">
                                    <?php
                                    if ($dias_restantes > 0) {
                                        echo esc_html(sprintf(_n('%d día restante', '%d días restantes', $dias_restantes, FLAVOR_PLATFORM_TEXT_DOMAIN), $dias_restantes));
                                    } else {
                                        echo esc_html__('Pedido cerrado', FLAVOR_PLATFORM_TEXT_DOMAIN);
                                    }
                                    ?>
                                </p>
                            </div>
                    ...
                    <div class="flavor-fecha-item">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">
                                    <?php echo esc_html__('Fecha de entrega', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </p>
                                <p class="text-lg font-bold text-gray-900">
                                    <?php echo esc_html(date_i18n(get_option('date_format'), strtotime($fecha_entrega))); ?>
                                </p>
                                <p class="text-sm text-gray-600">
                                    <?php echo esc_html__('Entre 17:00 y 20:00', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    <h4 class="text-lg font-bold text-gray-900">
                        <?php echo esc_html__('Información del Pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </h4>
                        ...
                        <div class="rounded-xl bg-blue-50 p-4 border border-blue-200">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <p class="text-xs font-semibold text-blue-600 uppercase">
                                    <?php echo esc_html__('Productos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </p>
                            </div>
                        ...
                        <div class="rounded-xl bg-purple-50 p-4 border border-purple-200">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <p class="text-xs font-semibold text-purple-600 uppercase">
                                    <?php echo esc_html__('Participantes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                                </p>
                            </div>
                            <p class="text-2xl font-bold text-gray-900">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        <p class="text-sm font-semibold text-gray-700">
                            <?php echo esc_html__('Participación del grupo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </p>
                    ...
                    <p class="text-xs text-gray-600">
                        <?php echo esc_html(sprintf(__('%d miembros de %d ya han realizado su pedido', FLAVOR_PLATFORM_TEXT_DOMAIN), $miembros_pedido, $miembros_totales)); ?>
                    </p>
                </div>
                ...
                <div class="space-y-3">
                    <?php if ($dias_restantes > 0) : ?>
                        ...
                        >
                            ...
                            <?php echo esc_html__('Realizar Pedido', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </a>
                    <?php else : ?>
                        <button disabled class="w-full inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-gray-300 text-gray-600 font-semibold text-lg cursor-not-allowed">
                            ...
                            <?php echo esc_html__('Pedido Cerrado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </button>
                    <?php endif; ?>
                    ...
                    >
                        ...
                        <?php echo esc_html__('Ver Productos Disponibles', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </a>
                </div>
            </div>
        </div>
