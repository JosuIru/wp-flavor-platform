    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-2xl">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Como solicitarlo</h3>
                <div class="space-y-4">
            ...
            <div class="bg-white/15 backdrop-blur-sm rounded-2xl p-8">
                <h3 class="text-2xl font-bold text-white mb-6">Requisitos</h3>
                <ul class="space-y-4">
                ...
                <div class="mt-6 p-4 rounded-xl bg-white/10">
                    <p class="text-white/90 text-sm">
                        <strong>Nota:</strong> El tiempo de espera actual es de aproximadamente 6-12 meses dependiendo del huerto solicitado.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="text-center">
            ...
            <p class="mt-6 text-white/70 text-sm">Convocatoria abierta todo el ano · Asignacion por sorteo entre solicitantes</p>
        </div>
    </div>
</section>
