    ...
    <div class="flavor-container relative z-10 py-20">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <a href="#solicitar-parcela" class="flavor-button flavor-button-primary px-8"><?php echo esc_html__('Solicitar Parcela', 'flavor-chat-ia'); ?></a>
                <a href="#ver-huertos" class="flavor-button px-8"><?php echo esc_html__('Ver Huertos', 'flavor-chat-ia'); ?></a>
            </div>

            <?php if (!empty($mostrar_estadisticas)): ?>
            <div class="flavor-card max-w-3xl mx-auto">
                <h3 class="text-2xl font-bold mb-6" style="color: var(--flavor-text);"><?php echo esc_html__('Estadísticas en Vivo', 'flavor-chat-ia'); ?></h3>
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-4 rounded-lg" style="background: rgba(var(--flavor-primary-rgb, 99, 102, 241), 0.1);">
                        <div>
                            ...
                            <div class="text-sm" style="color: var(--flavor-text-muted);"><?php echo esc_html__('Huertos Activos', 'flavor-chat-ia'); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between p-4 rounded-lg" style="background: rgba(var(--flavor-primary-rgb, 99, 102, 241), 0.1);">
                        <div>
                            <div class="text-3xl font-bold" style="color: var(--flavor-primary);">145</div>
                            <div class="text-sm" style="color: var(--flavor-text-muted);"><?php echo esc_html__('Hortelanos', 'flavor-chat-ia'); ?></div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between p-4 rounded-lg" style="background: rgba(var(--flavor-primary-rgb, 99, 102, 241), 0.1);">
                        <div>
                            <div class="text-3xl font-bold" style="color: var(--flavor-primary);">238</div>
                            <div class="text-sm" style="color: var(--flavor-text-muted);"><?php echo esc_html__('Parcelas Totales', 'flavor-chat-ia'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
