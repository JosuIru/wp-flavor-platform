    ...
    <div class="flavor-hero-overlay">
        <div class="flavor-hero-content">
            ...
            <div class="flavor-hero-actions">
                ...
                <a href="#clases" class="flavor-btn-ghost"><?php esc_html_e('Ver Clases', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></a>
            </div>
        </div>
    </div>
</section>
...
<section class="flavor-gym-clases" id="clases">
    <div class="flavor-container">
        ...
        <div class="flavor-clases-cta">
            <a href="#clases" class="flavor-btn-outline"><?php esc_html_e('Ver Horario Completo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></a>
        </div>
    </div>
</section>
...
<section class="flavor-gym-cta" style="background: <?php echo esc_attr($color_primario); ?>;">
    <div class="flavor-container">
        ...
        <a href="#planes" class="flavor-btn-white"><?php esc_html_e('Solicitar Prueba Gratuita', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></a>
    </div>
</section>
