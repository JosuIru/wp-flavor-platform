...
<section<?php if ($id_seccion): ?> id="<?php echo esc_attr($id_seccion); ?>"<?php endif; ?> class="flavor-marketplace-anuncios" style="--color-primario: <?php echo esc_attr($color_primario); ?>;">
