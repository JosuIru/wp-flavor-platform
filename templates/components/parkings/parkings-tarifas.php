    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-2 <?php echo $plan['destacado'] ? 'border-blue-500 scale-105' : 'border-gray-100'; ?> overflow-hidden">
                    ...
                    <div class="p-6 <?php echo $plan['destacado'] ? 'pt-12' : ''; ?>">
                        ...
                        <a href="#contratar-<?php echo sanitize_title($plan['nombre']); ?>" class="block w-full py-3 rounded-xl text-center font-semibold transition-all hover:scale-105 <?php echo $plan['destacado'] ? 'text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'; ?>" style="<?php echo $plan['destacado'] ? 'background: linear-gradient(135deg, #3b82f6 0%, #2563eb 100%);' : ''; ?>">
                            <?php echo esc_html__('Contratar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </a>
                    </div>
                </div>
            <?php endforeach; ?>
        ...
        <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo esc_html__('Seguridad 24/7', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <p class="text-sm text-gray-600"><?php echo esc_html__('Camaras de vigilancia y personal de seguridad las 24 horas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                <div class="inline-flex items-center justify-center p-3 rounded-xl bg-slate-100 text-slate-600 mb-4">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo esc_html__('Carga Electrica', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <p class="text-sm text-gray-600"><?php echo esc_html__('Puntos de carga para vehiculos electricos en todas las plantas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                <div class="inline-flex items-center justify-center p-3 rounded-xl bg-slate-100 text-slate-600 mb-4">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo esc_html__('Pago Facil', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <p class="text-sm text-gray-600"><?php echo esc_html__('Acepta todas las tarjetas, pago movil y facturacion automatica', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        </div>
    </div>
</section>
