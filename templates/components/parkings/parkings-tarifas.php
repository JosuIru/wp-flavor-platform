    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Seguridad 24/7</h3>
                <p class="text-sm text-gray-600">Camaras de vigilancia y personal de seguridad las 24 horas</p>
            </div>
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                <div class="inline-flex items-center justify-center p-3 rounded-xl bg-slate-100 text-slate-600 mb-4">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Carga Electrica</h3>
                <p class="text-sm text-gray-600">Puntos de carga para vehiculos electricos en todas las plantas</p>
            </div>
            <div class="text-center p-6 bg-slate-50 rounded-2xl">
                <div class="inline-flex items-center justify-center p-3 rounded-xl bg-slate-100 text-slate-600 mb-4">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-lg font-bold text-gray-900 mb-2">Pago Facil</h3>
                <p class="text-sm text-gray-600">Acepta todas las tarjetas, pago movil y facturacion automatica</p>
            </div>
        </div>
    </div>
</section>
