                    ...
                    <div class="relative z-10">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold opacity-90">
                                <?php echo esc_html__('Presupuesto Total', 'flavor-chat-ia'); ?>
                            </h3>
                        ...
                        <div class="bg-white bg-opacity-20 rounded-lg p-4 backdrop-blur-sm">
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm opacity-90"><?php echo esc_html__('Distribuido', 'flavor-chat-ia'); ?></span>
                        ...
                        <div class="mt-6 pt-6 border-t border-white border-opacity-20">
                            <div class="text-sm opacity-90 mb-1">
                                <?php echo esc_html__('Presupuesto Restante', 'flavor-chat-ia'); ?>
                            </div>
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mt-6">
                    ...
                    <ul class="space-y-3 text-sm text-gray-600">
                        <li class="flex items-start">
                            ...
                            <span><?php echo esc_html__('Crea y vota propuestas', 'flavor-chat-ia'); ?></span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 mr-3 mt-0.5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span><?php echo esc_html__('Elige dónde invertir el presupuesto', 'flavor-chat-ia'); ?></span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-4 h-4 mr-3 mt-0.5 text-green-600 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            <span><?php echo esc_html__('Las propuestas más votadas se ejecutan', 'flavor-chat-ia'); ?></span>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-slate-50 to-gray-50 px-6 py-4 border-b border-gray-100">
                            <h3 class="font-bold text-gray-900 flex items-center">
                                ...
                                <?php echo esc_html__('Desglose por Categorías', 'flavor-chat-ia'); ?>
                            </h3>
                        </div>
                                    ...
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <div class="text-right flex-shrink-0">
                                            <span class="<?php echo $color_light_clase; ?> text-xs font-semibold px-3 py-1 rounded-full">
                                                <?php echo $categoria['propuestas']; ?> <?php echo esc_html__('propuestas', 'flavor-chat-ia'); ?>
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-slate-50 to-gray-50 px-6 py-4 border-b border-gray-100">
                            <h3 class="font-bold text-gray-900 flex items-center">
                                ...
                                <?php echo esc_html__('Propuestas Ganadoras', 'flavor-chat-ia'); ?>
                            </h3>
                        </div>
                                    ...
                                    <div class="flex items-start justify-between gap-3 mb-2">
                                        ...
                                        <div class="flex-shrink-0">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-700">
                                                ...
                                                <?php echo esc_html__('Ganador', 'flavor-chat-ia'); ?>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between text-xs text-gray-600">
                                        <div class="flex items-center gap-3">
                                            <div class="flex items-center">
                                                ...
                                                <span><?php echo number_format($item['votos']); ?> <?php echo esc_html__('votos', 'flavor-chat-ia'); ?></span>
                                            </div>
                                            <div class="flex items-center">
