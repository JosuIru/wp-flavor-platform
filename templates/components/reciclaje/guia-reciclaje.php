    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-12">
            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold mb-4" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white;">
                ...
                <?php echo esc_html__('Guia', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </span>
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div>
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <span class="font-bold text-green-700"><?php echo esc_html__('SI depositar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                </div>
                                <ul class="space-y-2">
                            ...
                            <div>
                                <div class="flex items-center gap-2 mb-4">
                                    ...
                                    <span class="font-bold text-red-700"><?php echo esc_html__('NO depositar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                </div>
                                <ul class="space-y-2">
        ...
        <div class="mt-12 bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-8">
            <h3 class="text-2xl font-bold text-gray-900 mb-6 text-center"><?php echo esc_html__('Residuos Especiales', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
            <p class="text-center text-gray-600 mb-8"><?php echo esc_html__('Estos residuos requieren tratamiento especial. Llevalos al Punto Limpio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
        ...
        <div class="text-center mt-12">
            <a href="#guia-completa" class="inline-flex items-center gap-2 px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300 hover:shadow-lg hover:scale-105" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white;">
                ...
                <span><?php echo esc_html__('Descargar Guia PDF', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </a>
        </div>
    </div>
</section>
