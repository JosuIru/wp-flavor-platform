    ...
    <div class="flavor-container relative z-10 py-20">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <a href="#puntos-recogida" class="flavor-button flavor-button-primary px-8"><?php echo esc_html__('Puntos de Recogida', 'flavor-chat-ia'); ?></a>
                <a href="#guia" class="flavor-button px-8"><?php echo esc_html__('Guía Reciclaje', 'flavor-chat-ia'); ?></a>
            </div>

            <div class="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
                <div class="text-center">
                    <div class="text-3xl font-bold" style="color: var(--flavor-primary);"><?php echo esc_html__('15T', 'flavor-chat-ia'); ?></div>
                    <div class="text-sm" style="color: rgba(255,255,255,0.8);"><?php echo esc_html__('Reciclado/año', 'flavor-chat-ia'); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold" style="color: var(--flavor-primary);">85%</div>
                    <div class="text-sm" style="color: rgba(255,255,255,0.8);"><?php echo esc_html__('Tasa Reciclaje', 'flavor-chat-ia'); ?></div>
                </div>
            </div>
        </div>
    </div>
