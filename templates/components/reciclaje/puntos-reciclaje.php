        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="relative rounded-2xl overflow-hidden shadow-xl h-96 lg:h-auto bg-gradient-to-br from-emerald-100 to-teal-100">
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <p class="text-emerald-800 font-medium">Mapa interactivo</p>
                        <p class="text-emerald-600 text-sm">de puntos de reciclaje</p>
                    </div>
                </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-bold text-gray-900">Puntos mas cercanos</h3>
