    ...
    <div class="flavor-container relative z-10 py-20">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <a href="#unirse" class="flavor-button flavor-button-primary px-8">Únete Ahora</a>
                <a href="#explorar" class="flavor-button px-8">Explorar</a>
            </div>

            <div class="grid grid-cols-3 gap-6">
                <div class="text-center">
                    <div class="text-3xl font-bold" style="color: var(--flavor-primary);">2.5K</div>
                    <div class="text-sm" style="color: rgba(255,255,255,0.8);">Miembros</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold" style="color: var(--flavor-primary);">45</div>
                    <div class="text-sm" style="color: rgba(255,255,255,0.8);">Grupos</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold" style="color: var(--flavor-primary);">1.2K</div>
                    <div class="text-sm" style="color: rgba(255,255,255,0.8);">Posts/mes</div>
                </div>
            </div>
        </div>
    </div>
