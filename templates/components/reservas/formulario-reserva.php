    ...
    <form class="flavor-reserva-formulario" id="flavor-reserva-form" method="post">
        ...
        <div class="flavor-reserva-campo">
            <label for="flavor-reserva-tipo-servicio">
                <?php esc_html_e('Tipo de servicio', 'flavor-chat-ia'); ?>
            </label>
            <select id="flavor-reserva-tipo-servicio" name="tipo_servicio" required>
                <option value="mesa_restaurante"><?php esc_html_e('Mesa de Restaurante', 'flavor-chat-ia'); ?></option>
                <option value="espacio_coworking"><?php esc_html_e('Espacio Coworking', 'flavor-chat-ia'); ?></option>
                <option value="clase_deportiva"><?php esc_html_e('Clase Deportiva', 'flavor-chat-ia'); ?></option>
            </select>
        </div>
        ...
        <div class="flavor-reserva-campo">
            <label for="flavor-reserva-personas">
                <?php esc_html_e('Numero de personas', 'flavor-chat-ia'); ?>
            </label>
        ...
        <div class="flavor-reserva-campo">
            ...
            <input type="text" id="flavor-reserva-nombre" name="nombre_cliente"
                   placeholder="<?php esc_attr_e('Tu nombre y apellidos', 'flavor-chat-ia'); ?>"
                   required>
        </div>
        ...
        <div class="flavor-reserva-fila">
            ...
            <div class="flavor-reserva-campo flavor-reserva-campo--medio">
                ...
                <input type="tel" id="flavor-reserva-telefono" name="telefono_cliente"
                       placeholder="<?php esc_attr_e('600 123 456', 'flavor-chat-ia'); ?>">
            </div>
        </div>
