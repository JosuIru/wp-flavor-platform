<?php
/**
 * Partial: Equipo - Lista
 * Vertical list with larger photos and bios.
 *
 * Variables esperadas:
...
<section class="py-16 px-4 bg-white">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-12">
            <?php foreach ( $lista_miembros as $indice_miembro => $miembro ) :
                ...
                $es_imagen_izquierda = ( $indice_miembro % 2 === 0 );
            ?>
                <div class="flex flex-col md:flex-row <?php echo $es_imagen_izquierda ? '' : 'md:flex-row-reverse'; ?> items-center gap-8 p-6 rounded-2xl hover:bg-gray-50 transition-colors">
                    <!-- Photo -->
                    <div class="w-48 h-48 md:w-56 md:h-56 shrink-0 rounded-2xl overflow-hidden shadow-md bg-gray-100">
                        <?php if ( $foto_miembro ) : ?>
                            <img
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <?php if ( $cargo_miembro ) : ?>
                            <p class="text-base font-semibold mb-3" style="color: <?php echo esc_attr( $color_principal ); ?>;">
                            ...
                            <div class="flex items-center gap-4 justify-center md:justify-start">
                                <?php foreach ( $redes_miembro as $nombre_red => $url_red ) : ?>
                                    <a
                                        ...
                                        class="text-sm font-medium text-gray-500 hover:underline transition-colors"
