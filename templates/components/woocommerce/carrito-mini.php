    ...
    <div class="space-y-3 max-h-96 overflow-y-auto mb-4 pr-2">
                ...
                <div class="flavor-item-carrito flex gap-3 pb-3 border-b border-gray-100 hover:bg-gray-50 -mx-2 px-2 py-1 rounded transition-colors">
                    ...
                    <div class="flex-grow min-w-0">
                        ...
                        <p class="text-xs text-gray-500 mb-2">
                            <?php echo esc_html__('SKU:', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>&nbsp;<?php echo esc_html($item_carrito['sku']); ?>
                        </p>
                        <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-1 flex-shrink-0">
                        <button class="p-1 rounded hover:bg-gray-200 text-gray-400 hover:text-gray-600 transition-colors" title="<?php echo esc_attr__('Editar cantidad', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                        </button>
                        <button class="p-1 rounded hover:bg-red-50 text-gray-400 hover:text-red-600 transition-colors" title="<?php echo esc_attr__('Eliminar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php else : ?>
            ...
            <div class="text-center py-8">
                ...
                <p class="text-gray-500 text-sm"><?php echo esc_html__('Tu carrito esta vacio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></p>
            </div>
        <?php endif; ?>
    </div>
    ...
    <?php if (!empty($items_carrito)) : ?>
        ...
        <?php if (!$aplica_envio_gratis && floatval($gastos_envio) > 0) : ?>
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4 text-xs">
                <p class="text-blue-800">
                    <strong><?php echo esc_html__('Envio Gratuito', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                    <?php
                    $cantidad_faltante = floatval($envio_gratis_desde) - floatval($subtotal_carrito);
                    echo esc_html(sprintf(__('Falta %s€ para acceder a envio gratis', FLAVOR_PLATFORM_TEXT_DOMAIN), number_format($cantidad_faltante, 2, ',', '.')));
                    ?>
                </p>
            </div>
        <?php elseif ($aplica_envio_gratis) : ?>
            <div class="bg-green-50 border border-green-200 rounded-lg p-3 mb-4 text-xs">
                <p class="text-green-800 flex items-center gap-1">
                    ...
                    <strong><?php echo esc_html__('Envio Gratuito Aplicado', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></strong>
                </p>
            </div>
        <?php endif; ?>
            ...
            <div class="mb-4 pb-4 border-b border-gray-200">
                <details class="group">
                    <summary class="cursor-pointer text-sm font-medium text-purple-600 hover:text-purple-700 flex items-center gap-1 select-none">
                        ...
                        <?php echo esc_html__('Usar Cupón', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </summary>
                    <div class="mt-3 pt-3 border-t border-gray-200">
                        <input type="text" placeholder="<?php echo esc_attr__('Ingresa tu cupón aqui', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 mb-2">
                        <button class="w-full px-3 py-2 bg-purple-600 text-white text-sm font-medium rounded-lg hover:bg-purple-700 transition-colors">
                            <?php echo esc_html__('Aplicar Cupón', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                        </button>
                    </div>
                </details>
            </div>
        ...
        <div class="bg-gray-50 rounded-lg p-4 space-y-2 mb-4 border border-gray-200">
            <div class="flex justify-between text-sm">
                <span class="text-gray-600"><?php echo esc_html__('Subtotal', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <?php if (floatval($descuento_carrito) > 0) : ?>
                <div class="flex justify-between text-sm text-green-600">
                    <span><?php echo esc_html__('Descuento', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <?php if ($aplica_envio_gratis) : ?>
                <div class="flex justify-between text-sm text-green-600">
                    <span><?php echo esc_html__('Envio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    <span class="font-medium"><?php echo esc_html__('Gratis', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            <?php elseif (floatval($gastos_envio) > 0) : ?>
                <div class="flex justify-between text-sm">
                    <span class="text-gray-600"><?php echo esc_html__('Envio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            ...
            <div class="border-t border-gray-300 pt-2 mt-2 flex justify-between">
                <span class="font-bold text-gray-800"><?php echo esc_html__('Total', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        ...
        <div class="space-y-2">
            <a href="<?php echo esc_url($url_checkout); ?>" class="block w-full px-4 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold text-center hover:from-purple-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg">
                <span class="flex items-center justify-center gap-2">
                    ...
                    <?php echo esc_html__('Proceder al Pago', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                </span>
            </a>
            ...
            <a href="<?php echo esc_url($url_carrito); ?>" class="block w-full px-4 py-3 rounded-xl border-2 border-purple-600 text-purple-600 font-semibold text-center hover:bg-purple-50 transition-colors">
                <?php echo esc_html__('Ver Carrito Completo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </a>
        </div>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 text-center">
            <p class="text-xs text-gray-500 flex items-center justify-center gap-1">
                ...
                <?php echo esc_html__('Pago 100% Seguro con SSL', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
            </p>
        </div>
