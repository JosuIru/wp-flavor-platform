...
<div class="flavor-archive ayuda-vecinal">
    ...
    <div class="bg-gradient-to-r from-orange-500 to-amber-500 py-12 px-4">
        <div class="container mx-auto max-w-6xl">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2">Ayuda Vecinal</h1>
            <p class="text-white/90 text-lg">Conecta con vecinos que necesitan o ofrecen ayuda</p>
            ...
            <main class="flex-1">
                ...
                <div class="flex items-center justify-between mb-6">
                    <p class="text-gray-600">
                        Mostrando <span class="font-semibold"><?php echo count($solicitudes); ?></span> de <?php echo esc_html($total_solicitudes); ?> solicitudes
                    </p>
                ...
                <?php if (empty($solicitudes)): ?>
                    <div class="bg-gray-50 rounded-2xl p-12 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-700 mb-2">No hay solicitudes activas</h3>
                        <p class="text-gray-500 mb-4">Se el primero en pedir o ofrecer ayuda</p>
