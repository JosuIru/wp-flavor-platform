        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-blue-200"><?php echo esc_html__('Portal ciudadano - Tu ayuntamiento a un clic', 'flavor-chat-ia'); ?></p>
                </div>
            </div>
            <div class="flex gap-3">
                <a href="<?php echo esc_url(home_url('/ayuntamiento/tramites/')); ?>" class="bg-white text-blue-700 px-6 py-3 rounded-xl font-semibold hover:bg-blue-50 transition-all shadow-md">
                    <?php echo esc_html__('📋 Trámites', 'flavor-chat-ia'); ?>
                </a>
                <a href="<?php echo esc_url(home_url('/ayuntamiento/cita-previa/')); ?>" class="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-500 transition-all border border-blue-500">
                    <?php echo esc_html__('📅 Cita previa', 'flavor-chat-ia'); ?>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <form action="<?php echo esc_url(home_url('/ayuntamiento/buscar/')); ?>" method="get" class="flex gap-4">
            <div class="flex-1 relative">
                <input type="text" name="q" placeholder="<?php echo esc_attr__('¿Qué trámite o información buscas?', 'flavor-chat-ia'); ?>"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold text-gray-800"><?php echo esc_html__('📢 Últimas noticias', 'flavor-chat-ia'); ?></h2>
                <a href="<?php echo esc_url(home_url('/ayuntamiento/noticias/')); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                    <?php echo esc_html__('Ver todas →', 'flavor-chat-ia'); ?>
                </a>
            </div>
            <div class="space-y-4">
                <?php if (empty($noticias)): ?>
                <div class="bg-gray-50 rounded-xl p-6 text-center">
                    <p class="text-gray-500"><?php echo esc_html__('No hay noticias recientes', 'flavor-chat-ia'); ?></p>
                </div>
                <?php else: ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-800 mb-4"><?php echo esc_html__('📋 Trámites más solicitados', 'flavor-chat-ia'); ?></h3>
                <ul class="space-y-3">
                    <?php
                    $tramites_default = [
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6">
                <h3 class="font-semibold text-yellow-800 mb-3"><?php echo esc_html__('⚠️ Avisos importantes', 'flavor-chat-ia'); ?></h3>
