...
<div class="flavor-frontend flavor-banco-tiempo-archive">
    ...
    <div class="bg-gradient-to-r from-violet-500 to-purple-600 text-white rounded-2xl p-8 mb-8 shadow-lg">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold mb-2">⏰ Banco de Tiempo</h1>
                <p class="text-violet-100">Intercambia servicios con tus vecinos: 1 hora = 1 hora</p>
            </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            ...
            <p class="text-sm text-gray-500">Intercambios realizados</p>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="text-3xl mb-2">⏱️</div>
            <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['horas_intercambiadas'] ?? 0); ?>h</p>
            <p class="text-sm text-gray-500">Horas intercambiadas</p>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="text-3xl mb-2">⭐</div>
    ...
    <div class="bg-violet-50 rounded-2xl p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                ...
                <h3 class="font-semibold text-gray-800 mb-1">Ofrece</h3>
                <p class="text-sm text-gray-600">Comparte tus habilidades y talentos con la comunidad</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-violet-500 text-white rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">🤝</div>
                <h3 class="font-semibold text-gray-800 mb-1">Intercambia</h3>
                <p class="text-sm text-gray-600">1 hora de tu tiempo = 1 hora de cualquier servicio</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-violet-500 text-white rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">✨</div>
                <h3 class="font-semibold text-gray-800 mb-1">Recibe</h3>
                <p class="text-sm text-gray-600">Utiliza tus horas ganadas para recibir servicios</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-full text-center py-16 bg-gray-50 rounded-2xl">
            ...
            <p class="text-gray-500 mb-6">¡Sé el primero en ofrecer un servicio!</p>
