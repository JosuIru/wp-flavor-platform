...
<div class="flavor-frontend flavor-banco-tiempo-search">
    ...
    <div class="bg-gradient-to-r from-violet-500 to-purple-600 rounded-2xl p-8 mb-8 shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-4 text-center">🔍 Buscar servicios</h2>
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q" value="<?php echo esc_attr($query); ?>"
                       placeholder="¿Qué servicio necesitas? (ej: clases de inglés, reparaciones...)"
        ...
        <div class="flex flex-wrap justify-center gap-2 mt-4">
            <span class="text-violet-100 text-sm">Populares:</span>
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No encontramos servicios</h3>
        <p class="text-gray-500 mb-6">¿Por qué no ofreces tú ese servicio?</p>
