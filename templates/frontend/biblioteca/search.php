...
<div class="flavor-search biblioteca">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 py-12 px-4">
        <div class="container mx-auto max-w-4xl">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-6 text-center">Buscar Libros</h1>
            ...
            <form method="get" class="bg-white rounded-2xl p-4 shadow-xl">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-xs font-medium text-gray-500 mb-1">Titulo o autor</label>
                        <div class="relative">
    ...
    <div class="container mx-auto max-w-6xl px-4 py-8">
        ...
        <?php if (empty($resultados) && !empty($query)): ?>
            <div class="bg-gray-50 rounded-2xl p-12 text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No encontramos ese libro</h3>
                <p class="text-gray-500 mb-4">Prueba con otros terminos o navega por generos</p>
                <a href="?" class="text-indigo-600 font-medium hover:text-indigo-700">Ver todos los libros</a>
            </div>
        ...
        <?php else: ?>
            <!-- Libros destacados -->
            <h2 class="text-xl font-bold text-gray-900 mb-6">Novedades en la Biblioteca</h2>
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                <?php for ($i = 1; $i <= 12; $i++): ?>
                    <article class="group">
                        <div class="relative aspect-[2/3] rounded-xl overflow-hidden shadow-md mb-3">
                        ...
                        <p class="text-xs text-gray-500">Autor Ejemplo</p>
                    </article>
                <?php endfor; ?>
            </div>
        <?php endif; ?>
