...
<div class="flavor-archive bicicletas">
    ...
    <div class="bg-gradient-to-r from-lime-500 to-green-500 py-12 px-4">
        <div class="container mx-auto max-w-6xl">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-2"><?php echo esc_html__('Bicicletas Compartidas', 'flavor-chat-ia'); ?></h1>
            <p class="text-white/90 text-lg"><?php echo esc_html__('Muevete de forma sostenible por el barrio', 'flavor-chat-ia'); ?></p>
    ...
    <div class="container mx-auto max-w-6xl px-4 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden mb-8">
            <div class="h-96 bg-gray-200 flex items-center justify-center">
                <div class="text-center text-gray-500">
                    ...
                    <p><?php echo esc_html__('Mapa interactivo de estaciones', 'flavor-chat-ia'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-bold text-gray-900"><?php echo esc_html__('Estaciones Cercanas', 'flavor-chat-ia'); ?></h2>
            <select class="px-4 py-2 rounded-lg border border-gray-300 bg-white text-sm focus:ring-2 focus:ring-lime-500">
                <option><?php echo esc_html__('Mas cercanas', 'flavor-chat-ia'); ?></option>
                <option><?php echo esc_html__('Mas bicis disponibles', 'flavor-chat-ia'); ?></option>
                <option><?php echo esc_html__('Nombre A-Z', 'flavor-chat-ia'); ?></option>
            </select>
        </div>
        ...
        <?php if (empty($estaciones)): ?>
            <div class="bg-gray-50 rounded-2xl p-12 text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2"><?php echo esc_html__('No hay estaciones cercanas', 'flavor-chat-ia'); ?></h3>
                <p class="text-gray-500"><?php echo esc_html__('Activa tu ubicacion para ver las estaciones mas proximas', 'flavor-chat-ia'); ?></p>
            </div>
        <?php else: ?>
                        ...
                        <div class="p-5">
                            <div class="flex items-start justify-between mb-4">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo esc_html__('bicis', 'flavor-chat-ia'); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-2">
                                <a href="<?php echo esc_url($estacion['url'] ?? '#'); ?>"
                                   ...
                                   style="background: linear-gradient(135deg, #84cc16 0%, #65a30d 100%);">
                                    <?php echo esc_html__('Reservar Bici', 'flavor-chat-ia'); ?>
                                </a>
