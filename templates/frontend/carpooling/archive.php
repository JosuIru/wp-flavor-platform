...
<div class="flavor-frontend flavor-carpooling-archive">
    ...
    <div class="bg-gradient-to-r from-lime-500 to-green-600 text-white rounded-2xl p-8 mb-8 shadow-lg">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold mb-2">🚗 Carpooling</h1>
                <p class="text-lime-100">Comparte viajes, reduce costes y cuida el medio ambiente</p>
            </div>
            <div class="flex items-center gap-4">
                <span class="bg-white/20 backdrop-blur px-4 py-2 rounded-full text-sm">
                    <?php echo esc_html($total_viajes); ?> viajes disponibles
                </span>
    ...
    <div class="bg-lime-50 rounded-2xl p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-600">Encuentra viajes disponibles con tu mismo destino y horario</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-lime-500 text-white rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">📩</div>
                <h3 class="font-semibold text-gray-800 mb-1">Reserva</h3>
                <p class="text-sm text-gray-600">Solicita tu plaza y espera la confirmacion del conductor</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-lime-500 text-white rounded-full flex items-center justify-center mx-auto mb-3 text-2xl">🚗</div>
                <h3 class="font-semibold text-gray-800 mb-1">Viaja</h3>
                <p class="text-sm text-gray-600">Comparte el viaje, ahorra dinero y reduce tu huella de carbono</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-full text-center py-16 bg-gray-50 rounded-2xl">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No hay viajes disponibles</h3>
            <p class="text-gray-500 mb-6">¡Ofrece el primer viaje compartido!</p>
            ...
            <div class="p-5">
                ...
                <div class="flex flex-wrap gap-2 mb-3">
                    ...
                    <span class="bg-lime-100 text-lime-700 text-xs px-3 py-1 rounded-full flex items-center gap-1">
                        💺 <?php echo esc_html($viaje['plazas_libres'] ?? 0); ?> plazas
                    </span>
                </div>
                ...
                <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-gray-600"><?php echo esc_html($viaje['conductor_nombre'] ?? 'Conductor'); ?></span>
                    </div>
    ...
    <div class="flex justify-center mt-8">
        <nav class="flex items-center gap-2">
            ...
            <span class="px-4 py-2 text-gray-600">Pagina 1 de <?php echo ceil($total_viajes / 12); ?></span>
