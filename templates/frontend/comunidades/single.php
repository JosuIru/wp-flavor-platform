            ...
            <div class="flex items-start gap-6">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        ...
                        <span class="bg-white/20 text-white px-3 py-1 rounded-full text-sm"><?php echo esc_html__('✓ Verificada', 'flavor-chat-ia'); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="flex-shrink-0">
                    ...
                    <div class="flex gap-2">
                        <button class="bg-white/20 text-white px-4 py-2 rounded-xl font-medium hover:bg-white/30 transition-colors">
                            <?php echo esc_html__('✓ Miembro', 'flavor-chat-ia'); ?>
                        </button>
                        <?php if ($es_admin): ?>
                        <button class="bg-white text-rose-600 px-4 py-2 rounded-xl font-medium hover:bg-rose-50 transition-colors"
                            ...
                            <?php echo esc_html__('⚙️ Administrar', 'flavor-chat-ia'); ?>
                        </button>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex gap-4">
                    ...
                    <div class="flex-1">
                        <textarea placeholder="<?php echo esc_attr__('Comparte algo con la comunidad...', 'flavor-chat-ia'); ?>"
                        ...
                        <div class="flex items-center justify-between mt-3">
                            <div class="flex gap-2">
                                <button class="p-2 text-gray-500 hover:bg-gray-100 rounded-lg" title="<?php echo esc_attr__('Añadir imagen', 'flavor-chat-ia'); ?>">📷</button>
                                <button class="p-2 text-gray-500 hover:bg-gray-100 rounded-lg" title="<?php echo esc_attr__('Añadir archivo', 'flavor-chat-ia'); ?>">📎</button>
                                <button class="p-2 text-gray-500 hover:bg-gray-100 rounded-lg" title="<?php echo esc_attr__('Crear evento', 'flavor-chat-ia'); ?>">📅</button>
                                <button class="p-2 text-gray-500 hover:bg-gray-100 rounded-lg" title="<?php echo esc_attr__('Encuesta', 'flavor-chat-ia'); ?>">📊</button>
                            </div>
            ...
            <div id="tab-publicaciones" class="space-y-4">
                ...
                <div class="text-center py-12 bg-gray-50 rounded-2xl">
                    ...
                    <p class="text-gray-500"><?php echo esc_html__('No hay publicaciones todavía', 'flavor-chat-ia'); ?></p>
                </div>
                <?php else: ?>
            ...
            <div id="tab-eventos" class="space-y-4 hidden">
                ...
                <div class="text-center py-12 bg-gray-50 rounded-2xl">
                    <div class="text-4xl mb-3">📅</div>
                    <p class="text-gray-500"><?php echo esc_html__('No hay eventos programados', 'flavor-chat-ia'); ?></p>
                </div>
                <?php else: ?>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex gap-4">
                    ...
                    <button class="bg-rose-100 text-rose-600 px-4 py-2 rounded-xl font-medium hover:bg-rose-200 transition-colors self-center">
                        <?php echo esc_html__('Asistir', 'flavor-chat-ia'); ?>
                    </button>
                </div>
                <?php endforeach; ?>
                <?php endif; ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <dl class="space-y-3 text-sm">
                    ...
                    <div>
                        <dt class="text-gray-500"><?php echo esc_html__('Privacidad', 'flavor-chat-ia'); ?></dt>
                        <dd class="text-gray-800 font-medium"><?php echo esc_html($comunidad['privacidad'] ?? 'Pública'); ?></dd>
                    </div>
                    <?php if (!empty($comunidad['reglas'])): ?>
                    <div>
                        <dt class="text-gray-500 mb-2"><?php echo esc_html__('Reglas', 'flavor-chat-ia'); ?></dt>
            ...
            <!-- Administradores -->
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-800 mb-4"><?php echo esc_html__('👑 Administradores', 'flavor-chat-ia'); ?></h3>
                <div class="space-y-3">
                    <?php
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="font-semibold text-gray-800"><?php echo esc_html__('👥 Miembros', 'flavor-chat-ia'); ?></h3>
