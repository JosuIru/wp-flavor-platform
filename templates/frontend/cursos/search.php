...
<div class="flavor-search cursos">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-violet-600 py-12 px-4">
        <div class="container mx-auto max-w-4xl">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-6 text-center">Buscar Cursos</h1>
            ...
            <form method="get" class="bg-white rounded-2xl p-4 shadow-xl">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-xs font-medium text-gray-500 mb-1">Que quieres aprender?</label>
                        <div class="relative">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Cocina, idiomas, manualidades..."
    ...
    <div class="container mx-auto max-w-6xl px-4 py-8">
        ...
        <?php if (empty($resultados) && !empty($query)): ?>
            <div class="bg-gray-50 rounded-2xl p-12 text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-700 mb-2">No encontramos cursos</h3>
                <p class="text-gray-500 mb-4">Prueba con otros terminos o categorias</p>
                <a href="?" class="text-purple-600 font-medium hover:text-purple-700">Ver todos los cursos</a>
            </div>
                    ...
                    <article class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow overflow-hidden">
                        <div class="relative aspect-[16/9] overflow-hidden">
                            ...
                            <?php if (!empty($curso['gratuito'])): ?>
                                <span class="absolute top-3 right-3 px-2 py-1 rounded-full text-xs font-bold bg-green-500 text-white">Gratis</span>
                            <?php endif; ?>
                        </div>
                        <div class="p-5">
        ...
        <?php else: ?>
            <!-- Cursos destacados -->
            <h2 class="text-xl font-bold text-gray-900 mb-6">Proximos Cursos</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php for ($i = 1; $i <= 6; $i++): ?>
                    <article class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow overflow-hidden">
                        <div class="relative aspect-[16/9] overflow-hidden">
                        ...
                        <div class="p-5">
                            ...
                            <p class="text-sm text-gray-500 mb-3">15 Feb · 18:00</p>
                            <div class="flex items-center justify-between">
                                <span class="font-bold text-purple-600">25€</span>
                                <a href="#" class="text-purple-600 font-medium text-sm hover:text-purple-700">Ver curso →</a>
                            </div>
                        </div>
                    </article>
                <?php endfor; ?>
