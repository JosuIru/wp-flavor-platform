...
<div class="flavor-frontend flavor-dex-solana-filters">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="?" class="text-sm text-cyan-600 hover:text-cyan-700 font-medium">Limpiar</a>
            <?php endif; ?>
        </div>
        ...
        <form method="get" class="space-y-6">
            <!-- Tipo de token -->
            <div>
                <h4 class="text-sm font-semibold text-gray-900 mb-3">Tipo de token</h4>
                <div class="space-y-2">
                    <?php
            ...
            <!-- Rango de liquidez -->
            <div>
                <h4 class="text-sm font-semibold text-gray-900 mb-3">Liquidez (USD)</h4>
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="text-xs text-gray-500 mb-1 block">Minimo</label>
                    ...
                    <div>
                        <label class="text-xs text-gray-500 mb-1 block">Maximo</label>
                        <input type="number" name="liquidez_maxima" placeholder="Sin limite"
            ...
            <!-- Volumen 24h -->
            <div>
                <h4 class="text-sm font-semibold text-gray-900 mb-3">Volumen 24h (USD)</h4>
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label class="text-xs text-gray-500 mb-1 block">Minimo</label>
                    ...
                    <div>
                        <label class="text-xs text-gray-500 mb-1 block">Maximo</label>
                        <input type="number" name="volumen_maximo" placeholder="Sin limite"
            ...
            <div>
                ...
                <select name="ordenar_por"
                        class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500">
                    <option value="precio" <?php echo ($filtros_activos['ordenar_por'] ?? '') === 'precio' ? 'selected' : ''; ?>>
                        Precio
                    </option>
                    <option value="volumen" <?php echo ($filtros_activos['ordenar_por'] ?? '') === 'volumen' ? 'selected' : ''; ?>>
                        Volumen
                    </option>
                    <option value="liquidez" <?php echo ($filtros_activos['ordenar_por'] ?? '') === 'liquidez' ? 'selected' : ''; ?>>
                        Liquidez
                    </option>
                    <option value="nombre" <?php echo ($filtros_activos['ordenar_por'] ?? '') === 'nombre' ? 'selected' : ''; ?>>
                        Nombre
                    </option>
                </select>
            </div>
            ...
            <!-- Direccion de orden -->
            <div>
                <h4 class="text-sm font-semibold text-gray-900 mb-3">Direccion</h4>
                <div class="flex gap-2">
                    <?php $direccion_orden_actual = $filtros_activos['direccion_orden'] ?? 'desc'; ?>
                    <label class="flex-1 cursor-pointer">
                        <input type="radio" name="direccion_orden" value="asc" class="sr-only peer"
                    ...
                    <label class="flex-1 cursor-pointer">
                        <input type="radio" name="direccion_orden" value="desc" class="sr-only peer"
