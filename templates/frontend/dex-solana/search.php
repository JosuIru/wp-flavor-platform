...
<div class="flavor-frontend flavor-dex-solana-search">
    ...
    <div class="bg-gradient-to-r from-cyan-500 to-teal-600 rounded-2xl p-8 mb-8 shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-4 text-center">Buscar tokens</h2>
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q" value="<?php echo esc_attr($query); ?>"
                       placeholder="Buscar por nombre, simbolo o direccion del token..."
        ...
        <div class="flex flex-wrap justify-center gap-2 mt-4">
            <span class="text-cyan-100 text-sm">Populares:</span>
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No se encontraron tokens</h3>
        <p class="text-gray-500 mb-6">Intenta con otro nombre, simbolo o direccion de contrato</p>
        ...
        <article class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all overflow-hidden border border-gray-100 group">
            <div class="p-5">
                ...
                <div class="grid grid-cols-2 gap-3 pt-3 border-t border-gray-100">
                    <div>
                        <p class="text-xs text-gray-500">Volumen 24h</p>
