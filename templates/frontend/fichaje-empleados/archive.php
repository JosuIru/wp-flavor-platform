...
<div class="flavor-frontend flavor-fichaje-archive">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl p-8 mb-8 shadow-lg">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold mb-2"><?php echo esc_html__('Control de Fichajes', 'flavor-chat-ia'); ?></h1>
                <p class="text-blue-100"><?php echo esc_html__('Gestiona tu jornada laboral de forma sencilla', 'flavor-chat-ia'); ?></p>
            </div>
            <div class="flex items-center gap-4">
                ...
                <div class="bg-white/20 backdrop-blur px-5 py-3 rounded-xl text-center">
                    <p class="text-xs text-blue-100 mb-1"><?php echo esc_html__('Hora actual', 'flavor-chat-ia'); ?></p>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            ...
            <p class="text-sm text-gray-500"><?php echo esc_html__('Horas hoy', 'flavor-chat-ia'); ?></p>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="text-3xl mb-2">&#128197;</div>
            <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['horas_semana'] ?? '0h'); ?></p>
            <p class="text-sm text-gray-500"><?php echo esc_html__('Horas esta semana', 'flavor-chat-ia'); ?></p>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="text-3xl mb-2">&#128200;</div>
            <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['horas_mes'] ?? '0h'); ?></p>
            <p class="text-sm text-gray-500"><?php echo esc_html__('Horas este mes', 'flavor-chat-ia'); ?></p>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="text-3xl mb-2">&#128188;</div>
            <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['dias_trabajados'] ?? 0); ?></p>
            <p class="text-sm text-gray-500"><?php echo esc_html__('Dias trabajados', 'flavor-chat-ia'); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="bg-blue-50 rounded-2xl p-6 mb-8">
        <h2 class="text-xl font-bold text-gray-800 mb-4"><?php echo esc_html__('Acciones rapidas', 'flavor-chat-ia'); ?></h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="<?php echo esc_url(home_url('/fichaje/entrada/')); ?>"
               class="flex flex-col items-center gap-2 bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all group border border-gray-100">
                ...
                <span class="font-semibold text-gray-800 text-sm"><?php echo esc_html__('Fichar Entrada', 'flavor-chat-ia'); ?></span>
            </a>
            <a href="<?php echo esc_url(home_url('/fichaje/salida/')); ?>"
               class="flex flex-col items-center gap-2 bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all group border border-gray-100">
                ...
                <span class="font-semibold text-gray-800 text-sm"><?php echo esc_html__('Fichar Salida', 'flavor-chat-ia'); ?></span>
            </a>
            <a href="<?php echo esc_url(home_url('/fichaje/pausar/')); ?>"
               class="flex flex-col items-center gap-2 bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all group border border-gray-100">
                ...
                <span class="font-semibold text-gray-800 text-sm"><?php echo esc_html__('Pausar', 'flavor-chat-ia'); ?></span>
            </a>
            <a href="<?php echo esc_url(home_url('/fichaje/reanudar/')); ?>"
               class="flex flex-col items-center gap-2 bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all group border border-gray-100">
                ...
                <span class="font-semibold text-gray-800 text-sm"><?php echo esc_html__('Reanudar', 'flavor-chat-ia'); ?></span>
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold text-gray-800"><?php echo esc_html__('Registros de hoy', 'flavor-chat-ia'); ?></h2>
        ...
        <div class="text-center py-12 bg-gray-50 rounded-xl">
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-2"><?php echo esc_html__('Sin fichajes hoy', 'flavor-chat-ia'); ?></h3>
            <p class="text-gray-500 mb-4"><?php echo esc_html__('Comienza tu jornada fichando la entrada', 'flavor-chat-ia'); ?></p>
            <a href="<?php echo esc_url(home_url('/fichaje/entrada/')); ?>"
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-gray-100">
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-500"><?php echo esc_html__('Hora', 'flavor-chat-ia'); ?></th>
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-500"><?php echo esc_html__('Tipo', 'flavor-chat-ia'); ?></th>
                        <th class="text-left py-3 px-4 text-sm font-semibold text-gray-500"><?php echo esc_html__('Estado', 'flavor-chat-ia'); ?></th>
                    </tr>
                </thead>
                <tbody>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
        <h2 class="text-lg font-bold text-gray-800 mb-4"><?php echo esc_html__('Resumen semanal', 'flavor-chat-ia'); ?></h2>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 text-center">
        <h3 class="text-lg font-semibold text-gray-800 mb-2"><?php echo esc_html__('Algo no cuadra en tus fichajes?', 'flavor-chat-ia'); ?></h3>
        <p class="text-gray-600 mb-4"><?php echo esc_html__('Puedes solicitar una correccion si detectas algun error en tus registros', 'flavor-chat-ia'); ?></p>
