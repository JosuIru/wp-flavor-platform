...
<div class="flavor-frontend flavor-fichaje-search">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl p-8 mb-8 shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-4 text-center">Historial de Fichajes</h2>
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q" value="<?php echo esc_attr($query); ?>"
                       placeholder="Buscar por fecha, mes o rango (ej: enero 2024, 15/01/2024...)"
        ...
        <div class="flex flex-wrap justify-center gap-2 mt-4">
            <span class="text-blue-100 text-sm">Meses:</span>
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2">No se encontraron fichajes</h3>
        <p class="text-gray-500 mb-6">Prueba con otro rango de fechas o un mes diferente</p>
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-gray-50 border-b border-gray-100">
                        <th class="text-left py-4 px-5 text-sm font-semibold text-gray-500">Fecha</th>
                        <th class="text-left py-4 px-5 text-sm font-semibold text-gray-500">Entrada</th>
                        <th class="text-left py-4 px-5 text-sm font-semibold text-gray-500">Salida</th>
                        <th class="text-left py-4 px-5 text-sm font-semibold text-gray-500">Horas trabajadas</th>
                        <th class="text-left py-4 px-5 text-sm font-semibold text-gray-500">Estado</th>
                        <th class="text-right py-4 px-5 text-sm font-semibold text-gray-500">Acciones</th>
                    </tr>
                </thead>
                <tbody>
