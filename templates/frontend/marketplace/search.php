...
<div class="flavor-frontend flavor-marketplace-search">
        ...
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q" value="<?php echo esc_attr($query); ?>"
                       placeholder="<?php echo esc_attr__('¿Que producto estas buscando? (ej: bicicleta, muebles, movil...)', 'flavor-chat-ia'); ?>"
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <p class="text-gray-500 mb-6"><?php echo esc_html__('¿Tienes algo que vender? ¡Publica tu anuncio!', 'flavor-chat-ia'); ?></p>
