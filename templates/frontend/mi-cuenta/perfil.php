...
<div class="flavor-dashboard-perfil">
    ...
    <h2 class="flavor-dashboard-section-title"><?php esc_html_e('Mi Perfil', 'flavor-chat-ia'); ?></h2>
    ...
    <form id="flavor-form-perfil" class="flavor-dashboard-form" novalidate>
        ...
        <div class="flavor-dashboard-form-avatar">
            ...
            <p class="flavor-dashboard-avatar-nota">
                <?php esc_html_e('El avatar se gestiona a traves de Gravatar.', 'flavor-chat-ia'); ?>
                <a href="https://gravatar.com" target="_blank" rel="noopener noreferrer">
                    <?php esc_html_e('Cambiar avatar', 'flavor-chat-ia'); ?>
                </a>
            </p>
        </div>
        ...
        <div class="flavor-dashboard-form-grid">
            <div class="flavor-dashboard-form-group">
                <label for="flavor-perfil-nombre"><?php esc_html_e('Nombre', 'flavor-chat-ia'); ?></label>
                <input type="text"
            ...
            <div class="flavor-dashboard-form-group">
                <label for="flavor-perfil-apellido"><?php esc_html_e('Apellido', 'flavor-chat-ia'); ?></label>
                <input type="text"
                       id="flavor-perfil-apellido"
                       name="apellido"
                       value="<?php echo esc_attr($apellido); ?>"
                       placeholder="<?php esc_attr_e('Tu apellido', 'flavor-chat-ia'); ?>"
                       class="flavor-dashboard-input" />
            </div>

            <div class="flavor-dashboard-form-group">
                <label for="flavor-perfil-email"><?php esc_html_e('Email', 'flavor-chat-ia'); ?></label>
                <input type="email"
            ...
            <div class="flavor-dashboard-form-group">
                <label for="flavor-perfil-telefono"><?php esc_html_e('Telefono', 'flavor-chat-ia'); ?></label>
                <input type="tel"
    ...
    <h3 class="flavor-dashboard-section-subtitle"><?php esc_html_e('Cambiar contrasena', 'flavor-chat-ia'); ?></h3>
    ...
    <form id="flavor-form-password" class="flavor-dashboard-form" novalidate>
        <div class="flavor-dashboard-form-grid">
            <div class="flavor-dashboard-form-group flavor-dashboard-form-group--full">
                <label for="flavor-password-actual"><?php esc_html_e('Contrasena actual', 'flavor-chat-ia'); ?></label>
                <input type="password"
            ...
            <div class="flavor-dashboard-form-group">
                <label for="flavor-password-nueva"><?php esc_html_e('Nueva contrasena', 'flavor-chat-ia'); ?></label>
                <input type="password"
            ...
            <div class="flavor-dashboard-form-group">
                <label for="flavor-password-confirmar"><?php esc_html_e('Confirmar nueva contrasena', 'flavor-chat-ia'); ?></label>
                <input type="password"
        ...
        <div class="flavor-dashboard-form-actions">
            <button type="submit" class="flavor-dashboard-btn flavor-dashboard-btn--secondary" id="flavor-btn-cambiar-password">
                <?php esc_html_e('Cambiar contrasena', 'flavor-chat-ia'); ?>
            </button>
