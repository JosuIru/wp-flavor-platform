...
<div class="mi-red-container">
    ...
    <header class="mi-red-header-mobile">
        ...
        <div class="mi-red-header-mobile__right">
            <button class="mi-red-btn-icon" id="btn-buscar-mobile" aria-label="<?php esc_attr_e('Buscar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                <span>🔍</span>
            </button>
            <a href="<?php echo esc_url($base_url . 'notificaciones/'); ?>" class="mi-red-btn-icon mi-red-btn-icon--badge" aria-label="<?php esc_attr_e('Notificaciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                <span>🔔</span>
                <?php if ($notificaciones_no_leidas > 0) : ?>
                    <span class="mi-red-badge"><?php echo esc_html($notificaciones_no_leidas); ?></span>
                <?php endif; ?>
            </a>
            <a href="<?php echo esc_url($base_url . 'mensajes/'); ?>" class="mi-red-btn-icon mi-red-btn-icon--badge" aria-label="<?php esc_attr_e('Mensajes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
                <span>💬</span>
    ...
    <div class="mi-red-layout">
        ...
        <aside class="mi-red-sidebar mi-red-sidebar--left">
            ...
            <div class="mi-red-profile-card">
                ...
                <div class="mi-red-profile-card__info">
                    ...
                    <span class="mi-red-profile-card__link"><?php esc_html_e('Ver perfil', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                </div>
            </div>

            <!-- Navegación principal -->
            <nav class="mi-red-nav" aria-label="<?php esc_attr_e('Navegación principal', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            ...
            <div class="mi-red-filters">
                <h3 class="mi-red-filters__title"><?php esc_html_e('Filtrar por tipo', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></h3>
                <div class="mi-red-filters__list" id="filtros-tipo">
                    <button class="mi-red-filter-btn mi-red-filter-btn--active" data-tipo="todos">
                        ...
                        <span class="mi-red-filter-btn__text"><?php esc_html_e('Todos', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                    </button>
            ...
            <a href="<?php echo esc_url($base_url . 'publicar/'); ?>" class="mi-red-btn-publicar">
                ...
                <span class="mi-red-btn-publicar__text"><?php esc_html_e('Publicar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            </a>
        </aside>
        ...
        <main class="mi-red-main" id="contenido-principal">
            ...
            if (file_exists($template_path)) {
                ...
                esc_html_e('Vista no encontrada', FLAVOR_PLATFORM_TEXT_DOMAIN);
                echo '</div>';
            }
            ?>
        </main>
        ...
        <aside class="mi-red-sidebar mi-red-sidebar--right">
            ...
            <div class="mi-red-search-box">
                <form action="<?php echo esc_url($base_url . 'buscar/'); ?>" method="get" class="mi-red-search-form">
                    <input type="search"
                           ...
                           placeholder="<?php esc_attr_e('Buscar en Mi Red...', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>"
                           aria-label="<?php esc_attr_e('Buscar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
            ...
            <?php if (!empty($datos_vista['trending'])) : ?>
                <div class="mi-red-widget">
                    <h3 class="mi-red-widget__title">
                        ...
                        <?php esc_html_e('Tendencias', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </h3>
                        ...
                        <?php foreach ($datos_vista['trending'] as $hashtag) : ?>
                            <li class="mi-red-trending-item">
                                <a href="<?php echo esc_url($base_url . 'buscar/?q=' . urlencode('#' . $hashtag['hashtag'])); ?>" class="mi-red-trending-link">
                                    ...
                                    <span class="mi-red-trending-count"><?php echo esc_html(number_format_i18n($hashtag['total_usos'])); ?> <?php esc_html_e('publicaciones', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
            ...
            <?php if (!empty($datos_vista['sugerencias'])) : ?>
                <div class="mi-red-widget">
                    <h3 class="mi-red-widget__title">
                        <span class="mi-red-widget__icon">👥</span>
                        <?php esc_html_e('Personas que quizás conozcas', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>
                    </h3>
                        ...
                        <?php foreach ($datos_vista['sugerencias'] as $sugerencia) : ?>
                            <li class="mi-red-suggestion-item">
                                ...
                                <button class="mi-red-btn-follow"
                                        ...
                                        aria-label="<?php esc_attr_e('Seguir', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
    ...
    <nav class="mi-red-bottom-nav" aria-label="<?php esc_attr_e('Navegación móvil', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">
        <a href="<?php echo esc_url($base_url); ?>" class="mi-red-bottom-nav__item <?php echo $vista_actual === 'feed' ? 'mi-red-bottom-nav__item--active' : ''; ?>">
            ...
            <span class="mi-red-bottom-nav__text"><?php esc_html_e('Inicio', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </a>
        <a href="<?php echo esc_url($base_url . 'explorar/'); ?>" class="mi-red-bottom-nav__item <?php echo $vista_actual === 'explorar' ? 'mi-red-bottom-nav__item--active' : ''; ?>">
            <span class="mi-red-bottom-nav__icon">🔍</span>
            <span class="mi-red-bottom-nav__text"><?php esc_html_e('Explorar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </a>
        ...
        <a href="<?php echo esc_url($base_url . 'mensajes/'); ?>" class="mi-red-bottom-nav__item <?php echo $vista_actual === 'mensajes' ? 'mi-red-bottom-nav__item--active' : ''; ?>">
            <span class="mi-red-bottom-nav__icon">💬</span>
            <span class="mi-red-bottom-nav__text"><?php esc_html_e('Mensajes', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
            <?php if ($mensajes_no_leidos > 0) : ?>
        ...
        <a href="<?php echo esc_url($base_url . 'perfil/'); ?>" class="mi-red-bottom-nav__item <?php echo $vista_actual === 'perfil' ? 'mi-red-bottom-nav__item--active' : ''; ?>">
            <span class="mi-red-bottom-nav__icon">👤</span>
            <span class="mi-red-bottom-nav__text"><?php esc_html_e('Perfil', FLAVOR_PLATFORM_TEXT_DOMAIN); ?></span>
        </a>
    </nav>
        ...
        <div class="mi-red-modal__content">
            <form action="<?php echo esc_url($base_url . 'buscar/'); ?>" method="get" class="mi-red-search-form mi-red-search-form--modal">
                <input type="search"
                       ...
                       autofocus>
                <button type="button" class="mi-red-modal__close" aria-label="<?php esc_attr_e('Cerrar', FLAVOR_PLATFORM_TEXT_DOMAIN); ?>">✕</button>
            </form>
