...
<div class="mi-red-perfil">
        ...
        <div class="mi-red-perfil__info">
            ...
            <div class="mi-red-perfil__meta">
                ...
                <p class="mi-red-perfil__fecha">
                    <?php esc_html_e('Miembro desde', 'flavor-chat-ia'); ?>
                    <?php echo esc_html(date_i18n(get_option('date_format'), strtotime($perfil['fecha_registro'] ?? ''))); ?>
                </p>
            </div>
            <div class="mi-red-perfil__actions">
                <?php if ($es_propio) : ?>
                    <button class="mi-red-btn mi-red-btn--outline"><?php esc_html_e('Editar perfil', 'flavor-chat-ia'); ?></button>
                <?php else : ?>
                    ...
                    <button class="mi-red-btn mi-red-btn--outline"><?php esc_html_e('Mensaje', 'flavor-chat-ia'); ?></button>
                <?php endif; ?>
            </div>
        </div>
    </header>
    ...
    <div class="mi-red-perfil__stats">
        <div class="mi-red-stat-item">
            ...
            <span class="mi-red-stat-item__label"><?php esc_html_e('Publicaciones', 'flavor-chat-ia'); ?></span>
        </div>
        <div class="mi-red-stat-item">
            <span class="mi-red-stat-item__value"><?php echo esc_html(number_format_i18n($estadisticas['seguidores'] ?? 0)); ?></span>
            <span class="mi-red-stat-item__label"><?php esc_html_e('Seguidores', 'flavor-chat-ia'); ?></span>
        </div>
        <div class="mi-red-stat-item">
            <span class="mi-red-stat-item__value"><?php echo esc_html(number_format_i18n($estadisticas['siguiendo'] ?? 0)); ?></span>
            <span class="mi-red-stat-item__label"><?php esc_html_e('Siguiendo', 'flavor-chat-ia'); ?></span>
        </div>
        <div class="mi-red-stat-item">
            <span class="mi-red-stat-item__value"><?php echo esc_html(number_format_i18n($estadisticas['me_gusta_recibidos'] ?? 0)); ?></span>
            <span class="mi-red-stat-item__label"><?php esc_html_e('Me gusta', 'flavor-chat-ia'); ?></span>
        </div>
    </div>

    <!-- Publicaciones -->
    <div class="mi-red-perfil__content">
        <h2 class="mi-red-perfil__section-title"><?php esc_html_e('Publicaciones', 'flavor-chat-ia'); ?></h2>
        <?php if (empty($publicaciones)) : ?>
            <div class="mi-red-empty-state">
                <p><?php esc_html_e('No hay publicaciones todavía', 'flavor-chat-ia'); ?></p>
            </div>
        <?php else : ?>
