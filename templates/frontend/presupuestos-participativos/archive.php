...
<div class="flavor-frontend flavor-presupuestos-archive">
    ...
    <div class="bg-gradient-to-r from-amber-500 to-yellow-500 text-white rounded-2xl p-8 mb-8 shadow-lg">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h1 class="text-3xl font-bold mb-2">Presupuestos Participativos</h1>
                <p class="text-amber-100">Decide como se invierte el presupuesto de tu municipio</p>
            </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center text-yellow-600 font-bold">P</div>
                <div>
                    <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['proyectos_propuestos'] ?? 0); ?></p>
                    <p class="text-xs text-gray-500">Proyectos propuestos</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">Votos ciudadanos</p>
                </div>
            </div>
        </div>
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center text-green-600 font-bold">E</div>
                <div>
                    <p class="text-2xl font-bold text-gray-800"><?php echo esc_html($estadisticas['proyectos_ejecutados'] ?? 0); ?></p>
                    <p class="text-xs text-gray-500">Proyectos ejecutados</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="col-span-full text-center py-16 bg-gray-50 rounded-2xl">
            ...
            <h3 class="text-xl font-semibold text-gray-700 mb-2">No hay proyectos aun</h3>
            <p class="text-gray-500 mb-6">Propone un proyecto para tu municipio</p>
