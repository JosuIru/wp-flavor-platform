...
<div class="flavor-frontend flavor-publicidad-filters">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <form method="get" class="space-y-6">
            <!-- Tipo de campana -->
            <div>
                <h4 class="text-sm font-semibold text-gray-900 mb-3">Tipo de campana</h4>
                <div class="space-y-2">
                    <?php
                    $tipos_anuncio = [
                        'banner' => '🖼️ Banner',
            ...
            <div>
                ...
                <select name="ordenar" class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:ring-2 focus:ring-pink-500">
                    ...
                    <option value="impresiones" <?php echo ($filtros_activos['ordenar'] ?? '') === 'impresiones' ? 'selected' : ''; ?>>Mas impresiones</option>
                    <option value="clics" <?php echo ($filtros_activos['ordenar'] ?? '') === 'clics' ? 'selected' : ''; ?>>Mas clics</option>
                    <option value="presupuesto" <?php echo ($filtros_activos['ordenar'] ?? '') === 'presupuesto' ? 'selected' : ''; ?>>Mayor presupuesto</option>
                </select>
            </div>
