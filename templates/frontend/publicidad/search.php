...
<div class="flavor-frontend flavor-publicidad-search">
    ...
    <div class="bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl p-8 mb-8 shadow-lg">
        <h2 class="text-2xl font-bold text-white mb-4 text-center"><?php echo esc_html__('🔍 Buscar campanas', 'flavor-chat-ia'); ?></h2>
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q" value="<?php echo esc_attr($query); ?>"
                       placeholder="<?php echo esc_attr__('Busca por nombre de campana, anunciante o tipo...', 'flavor-chat-ia'); ?>"
        ...
        <div class="flex flex-wrap justify-center gap-2 mt-4">
            <span class="text-pink-100 text-sm"><?php echo esc_html__('Populares:', 'flavor-chat-ia'); ?></span>
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <h3 class="text-xl font-semibold text-gray-700 mb-2"><?php echo esc_html__('No encontramos campanas', 'flavor-chat-ia'); ?></h3>
        ...
        <button class="bg-pink-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-pink-600 transition-colors"
            ...
            <?php echo esc_html__('Crear Campana', 'flavor-chat-ia'); ?>
        </button>
    </div>
    <?php else: ?>
