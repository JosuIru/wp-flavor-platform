    ...
    <div class="bg-gradient-to-r from-red-600 to-rose-600 py-12 px-4">
        <div class="container mx-auto max-w-6xl">
            <nav class="flex items-center gap-2 text-sm text-white/80 mb-6">
                <a href="#" class="hover:text-white"><?php echo esc_html__('Radio', 'flavor-chat-ia'); ?></a>
                <span>/</span>
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <button class="px-6 py-3 rounded-xl bg-white text-red-600 font-semibold hover:bg-gray-100 transition-colors flex items-center gap-2">
                            ...
                            <?php echo esc_html__('Escuchar en directo', 'flavor-chat-ia'); ?>
                        </button>
    ...
    <div class="container mx-auto max-w-6xl px-4 py-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <h2 class="text-xl font-bold text-gray-900 mb-6"><?php echo esc_html__('Programas Anteriores', 'flavor-chat-ia'); ?></h2>

                <?php if (empty($episodios)): ?>
                    <div class="bg-gray-50 rounded-xl p-8 text-center">
                        <p class="text-gray-500"><?php echo esc_html__('No hay programas grabados disponibles', 'flavor-chat-ia'); ?></p>
                    </div>
                <?php else: ?>
                    <div class="space-y-4">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-md mb-6">
                    <h3 class="font-bold text-gray-900 mb-4"><?php echo esc_html__('Sobre el programa', 'flavor-chat-ia'); ?></h3>
                    <p class="text-gray-700 text-sm"><?php echo esc_html($descripcion); ?></p>
                </div>

                <!-- Locutor -->
                <div class="bg-white rounded-2xl p-6 shadow-md mb-6">
                    <h3 class="font-bold text-gray-900 mb-4"><?php echo esc_html__('Locutor', 'flavor-chat-ia'); ?></h3>
                    <div class="flex items-center gap-4">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-md">
                    <h3 class="font-bold text-gray-900 mb-4"><?php echo esc_html__('Escuchar en', 'flavor-chat-ia'); ?></h3>
                    <div class="space-y-2">
                        <a href="#" class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-red-50 transition-colors">
                            ...
                            <span class="font-medium text-gray-700"><?php echo esc_html__('Spotify', 'flavor-chat-ia'); ?></span>
                        </a>
                        <a href="#" class="flex items-center gap-3 p-3 rounded-xl bg-gray-50 hover:bg-red-50 transition-colors">
                            ...
                            <span class="font-medium text-gray-700"><?php echo esc_html__('Apple Podcasts', 'flavor-chat-ia'); ?></span>
                        </a>
                    </div>
                </div>
            </div>
