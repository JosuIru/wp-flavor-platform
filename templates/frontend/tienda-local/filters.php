...
<div class="flavor-frontend flavor-tienda-local-filters">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <form id="filtros-tienda" class="space-y-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Productor</label>
            ...
            <div>
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
                        ...
                        <span class="text-gray-700">🏷️ En oferta</span>
                    </label>
                    <label class="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-50 cursor-pointer">
            ...
            <div>
                ...
                <select name="ordenar" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                    ...
                    <option value="precio_asc" <?php echo ($filtros_activos['ordenar'] ?? '') === 'precio_asc' ? 'selected' : ''; ?>>
                        Precio: menor a mayor
                    </option>
                    <option value="precio_desc" <?php echo ($filtros_activos['ordenar'] ?? '') === 'precio_desc' ? 'selected' : ''; ?>>
                        Precio: mayor a menor
                    </option>
                    <option value="nombre" <?php echo ($filtros_activos['ordenar'] ?? '') === 'nombre' ? 'selected' : ''; ?>>
                        Nombre A-Z
                    </option>
                    <option value="popular" <?php echo ($filtros_activos['ordenar'] ?? '') === 'popular' ? 'selected' : ''; ?>>
                        Más vendidos
                    </option>
                </select>
            </div>
