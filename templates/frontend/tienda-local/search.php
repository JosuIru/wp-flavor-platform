...
<div class="flavor-frontend flavor-tienda-local-search">
        ...
        <form action="" method="get" class="max-w-2xl mx-auto">
            <div class="relative">
                <input type="text" name="q"
                       ...
                       placeholder="¿Qué producto buscas? (ej: tomates, miel, pan...)"
    ...
    <div class="text-center py-16 bg-gray-50 rounded-2xl">
        ...
        <p class="text-gray-500 mb-6">Prueba con otros términos de búsqueda</p>

        <?php if (!empty($sugerencias)): ?>
        <div class="space-y-2">
            <p class="text-sm text-gray-500">Quizás te interese:</p>
