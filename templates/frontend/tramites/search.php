...
$sugerencias_busqueda = $sugerencias_busqueda ?? ['empadronamiento', 'licencia obra', 'certificado', 'pago impuestos'];
?>
...
<div class="flavor-frontend flavor-tramites-search">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php foreach ($resultados as $resultado_tramite): ?>
            ...
            <div class="flex items-start gap-3 mb-3">
                ...
                <div>
                    <h3 class="font-semibold text-gray-800">
                        <a href="<?php echo esc_url($resultado_tramite['url'] ?? '#'); ?>" class="hover:text-orange-600 transition-colors">
                            <?php echo esc_html($resultado_tramite['titulo'] ?? ''); ?>
                        </a>
                    </h3>
                    <span class="text-xs text-gray-500"><?php echo esc_html($resultado_tramite['categoria'] ?? ''); ?></span>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo esc_html($resultado_tramite['descripcion'] ?? ''); ?></p>
