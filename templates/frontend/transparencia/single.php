...
<div class="flavor-frontend flavor-transparencia-single">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="hover:text-teal-600 transition-colors">Inicio</a>
        <span>&#8250;</span>
        <a href="<?php echo esc_url(home_url('/transparencia/')); ?>" class="hover:text-teal-600 transition-colors">Transparencia</a>
        <span>&#8250;</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-50 rounded-xl mb-6">
                    <div>
                        <p class="text-xs text-gray-500">Fecha publicacion</p>
            ...
            <div class="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-100 flex items-center justify-between">
                <div>
                    <h3 class="font-semibold text-gray-800">Descargar documento</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h2 class="text-lg font-semibold text-gray-800 mb-4">Documentos relacionados</h2>
                <div class="space-y-3">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-800 mb-4">Informacion del documento</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-800 mb-4">Mas en esta categoria</h3>
                ...
                <?php else: ?>
                <p class="text-sm text-gray-500">No hay mas documentos en esta categoria</p>
                <?php endif; ?>
            </div>

            <!-- CTA de descarga -->
            <div class="bg-gradient-to-br from-teal-500 to-cyan-500 rounded-2xl p-6 text-white">
                <h3 class="font-bold text-lg mb-2">Descarga directa</h3>
